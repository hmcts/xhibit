    ...
    BEGIN
        OPEN RESULTS_OUT FOR
            ...
            FROM XHB_HEARING_LIST HEARING_LIST,
                ...
                (SELECT * FROM XHB_CASE WHERE NVL(PUBLIC_DISPLAY_HIDE,'N') <> 'Y') CASE,
            ...
            AND DEFENDANT_ON_CASE.CASE_ID = CASE.CASE_ID
            ORDER BY
                DEFENDANT_SURNAME,
            ...
            FROM   XHB_COURT_SITE cs
                  ...
                  ,(SELECT d.defendant_id AS defendant_id
                    ...
                    FROM   XHB_HEARING_LIST hl
                          ...
                          ,XHB_HEARING h
                          ,(SELECT * FROM XHB_CASE WHERE NVL(PUBLIC_DISPLAY_HIDE,'N') <> 'Y') c
...
ORDER BY COURT_SITE_CODE,
    ...
    FUNCTION GET_GUID RETURN VARCHAR2 IS
      v_guid VARCHAR2(36);
      CURSOR C1 IS
      SELECT CAST (SYS_GUID() AS VARCHAR2(36))
        FROM DUAL;
    BEGIN
      OPEN C1;
      FETCH C1 INTO v_guid;
      CLOSE C1;
      RETURN v_guid;
    END GET_GUID;
