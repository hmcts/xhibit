...
DECLARE
	...
	v_secure_ctrm       XHB_CASE.SECURE_COURT%TYPE  := 'Y';   -- 'N' selects both options, 'Y' selects only secure court cases
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('--======================== Test 9 ' || v_message_filename || ' START ============================');
...
--    DBMS_OUTPUT.PUT_LINE('output message file in utl_file_hold directory = ' || v_message_filename || chr(10));
    ...
    DBMS_OUTPUT.PUT_LINE('         ------------------- Test 9 ' || v_message_filename || '  END --------------------------' || chr(10));
