...
begin
  ...
  dbms_output.put_line('XHB_CASES - Before Run - '||l_xhb_case_before||' records.');
  dbms_output.put_line('XHB_CASES - After  Run - '||i||' records.');
  l_diff_2 := l_xhb_case_before - i;
  dbms_output.put_line('XHB_CASES - Difference - '||l_diff_2||' records.');
  dbms_output.put_line('------------------------------------------------------------');
  ...
  dbms_output.put_line('XHB_XML_DOCUMENT - After Run - '||l_xhb_lists_before);
