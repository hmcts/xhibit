...
DECLARE
	...
	v_bc_status         VARCHAR2(2)                 := 'C';  -- Can be 'C', 'B', 'N/A', null                  
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('--======================== Test 4 ' || v_message_filename || ' START ============================');
...
--    DBMS_OUTPUT.PUT_LINE('output message file in utl_file_hold directory = ' || v_message_filename || chr(10));
    ...
    DBMS_OUTPUT.PUT_LINE('         ------------------- Test 4 ' || v_message_filename || '  END --------------------------' || chr(10));
