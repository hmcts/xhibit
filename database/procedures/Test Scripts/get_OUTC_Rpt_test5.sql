...
DECLARE
	...
	v_df_hearing_type   XHB_REF_HEARING_TYPE.HEARING_TYPE_CODE%TYPE := 'BOO';   -- Can be any of 125 3-letter codes, or null
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('--======================== Test 5 ' || v_message_filename || ' START ============================');
...
*/
    ...
    XHB_REPORT_PKG.get_outc_report( p_results_out          =>  v_resultset
...
--                            number                          
    ...
    IF v_row != 181 THEN 
        v_test_fail_msg := v_test_fail_msg || 'Rows retrieved: expected 181, got ' || v_row  || Chr(10); 
    END IF;
...
--    DBMS_OUTPUT.PUT_LINE('output message file in utl_file_hold directory = ' || v_message_filename || chr(10));
    ...
    DBMS_OUTPUT.PUT_LINE('         ------------------- Test 5 ' || v_message_filename || '  END --------------------------' || chr(10));
