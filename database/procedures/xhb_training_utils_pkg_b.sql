...
*/
      ...
      DELETE FROM XHB_DEF_ON_CASE_REF_SOL_FIRM docrsf
      WHERE  docrsf.DEFENDANT_ON_CASE_ID IN (SELECT dc.DEFENDANT_ON_CASE_ID
                                             FROM   XHB_DEFENDANT_ON_CASE DC,
                                                    XHB_CASE C,
						    XHB_COURT CT
                                             WHERE  DC.CASE_ID = C.CASE_ID
...
*/
      ...
      DELETE FROM XHB_CASE_REFRESH_RESYNCH
      WHERE  CASE_ID IN (SELECT CASE_ID
                         FROM   XHB_CASE
                         WHERE  COURT_ID = p_court_id);
...
*/
        ...
        SELECT training_utils_pkg.lookup_xhb_xml_document_id(XML_DOCUMENT_ID) AS XML_DOCUMENT_ID,
               ...
               LANGUAGE,
               COUNTRY,
               NULL AS MAJOR_SCHEMA_VERSION,
               NULL AS MINOR_SCHEMA_VERSION
