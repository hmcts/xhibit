...
/** 
 ...
 /*Global Variables*/
  ...
  FUNCTION GET_CROWN_COURT_RL(p_court_id XHB_COURT.COURT_ID%TYPE) RETURN XMLTYPE;
...
FUNCTION GET_DAILY_LIST(p_list_id XHB_LIST.LIST_ID%TYPE, v_unique_id VARCHAR, p_show_courtroom_list IN INTEGER) RETURN CLOB;
  ...
  FUNCTION get_interpreter_note(p_case_id XHB_CASE.CASE_ID%TYPE) RETURN VARCHAR2;
  FUNCTION get_default_note(p_case_id XHB_CASE.CASE_ID%TYPE) RETURN XMLTYPE;
  FUNCTION get_fixture_note(p_case_id XHB_CASE.CASE_ID%TYPE,p_list_start_date XHB_LIST.LIST_START_DATE%TYPE, p_list_end_date XHB_LIST.LIST_END_DATE%TYPE) RETURN XMLTYPE;
 ...
 FUNCTION get_charges_info (p_case_id IN xhb_case.case_id%TYPE) RETURN XMLType;
...
FUNCTION get_floating_cases(p_court_site_id XHB_COURT_SITE.COURT_SITE_ID%TYPE, p_list_id XHB_LIST.LIST_ID%TYPE,
 ...
 FUNCTION get_U_case_defendant(p_case_title IN XHB_CASE.CASE_TITLE%TYPE) RETURN XMLType;
 FUNCTION get_prosecutor_authority(p_prosecutor_name IN XHB_REF_PROSECUTOR_AGENCY.PROSECUTOR_NAME_3%TYPE) RETURN VARCHAR2;

FUNCTION validate_postcode(p_postcode XHB_ADDRESS.POSTCODE%TYPE) RETURN VARCHAR2;

FUNCTION get_required_judge (p_case_id IN xhb_case.case_id%TYPE) RETURN XMLType;
