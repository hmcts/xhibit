...
NOTIFY_HOME=/opt/customer/bea/user_projects/domains/XHIBIT_LIVE/common/publicDisplayNotifier/
LOGDIR=${NOTIFY_HOME}/logs
[ ! -d $LOGDIR ] && mkdir $LOGDIR

JAVA_HOME=/opt/customer/bea/java/jdk1.6.0_45/jre
JAVA_CMD=java
...
WL_URL="t3://x.y.250.138:7071"
#WL_URL="t3://x.y.199.97:7071"
