/* deleteAUD_CONFIGURED_PUBLIC_NOTICE.sql                                        */
...
DECLARE  
 ...
 BEGIN
  ...
  select count(*) into rowsbefore from AUD_CONFIGURED_PUBLIC_NOTICE;

  DBMS_OUTPUT.put_line ('Current date: '||to_char(sysdate,'YYYY-MM-DD HH:MM:SS'));

  execute immediate 'truncate table AUD_CONFIGURED_PUBLIC_NOTICE';

  select count(*) into rowsafter from AUD_CONFIGURED_PUBLIC_NOTICE;
