...
SPOKESDOWN=`cat $SPOKEFILE|sort|uniq|tr -s '\n' ','|awk '{print substr($0,1,length($0)-1) }'`

# Servers down is a combo of THICK_CLIENT_SECURE and PUBLICDISPLAYSTATUS and BROKERSTATUS 
SERVERSDOWN="$THICK_CLIENT_SECURE_APPEND $THICK_CLIENT_NON_SECURE_APPEND $SCJSE_APPEND $BROKER_DOWN $THIN_CLIENT_DOWN $PUBLIC_DISPAY_ERROR"
...
INTERFACESDOWN="$CJIP $SMS $LAA $DARTS"
