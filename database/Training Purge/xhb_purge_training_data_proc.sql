/*
 * Filename:    xhb_purge_training_data_proc.sql
 *
 ...
 */
  ...
  INSERT INTO XHB_TRAINING_COURT SELECT COURT_ID FROM XHB_COURT WHERE COURT_NAME = 'DOCKFORD TRAINING';

PROMPT 
PROMPT Creating Procedure xhb_purge_training_data_proc

CREATE OR REPLACE PROCEDURE xhb_purge_training_data_proc (myCOURT_ID IN NUMBER) IS
...
END xhb_purge_training_data_proc;
/
show errors
