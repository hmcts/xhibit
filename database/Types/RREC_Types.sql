...
CREATE OR REPLACE     type rrec_case_info     is object (section_num integer, court_site_name VARCHAR2(255 byte), case_type VARCHAR2(50 byte), case_number NUMBER(8,0), case_subhdg VARCHAR2(50), case_id  NUMBER(8,0));
/
show errors
