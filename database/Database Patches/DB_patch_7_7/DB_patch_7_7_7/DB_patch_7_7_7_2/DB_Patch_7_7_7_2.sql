 ...
 * ----         ---     ---------       -------
   ...
   18/05/2006   K Shah			Changes for release 7.7.6.3
   22/05/2006   K Shah			Release number changed to 7.7.7
   25/05/2006   I Lo                    Named primary key indexes
   05/06/2006   K Shah			Release number changed to 7.7.7.1
   06/06/2006   K Shah			Release number changed to 7.7.7.2
 *
 */ 
...
INSERT INTO MTBL_TIME_TRIGGER_STATUS ( MAPNAME, LASTRUNTIMEDATE, HOSTNAME, FREQUENCY, PROGRESS ) VALUES ( 'EmailFax_Poll.mmc',  TO_Date( '05/10/2006 12:27:05 PM', 'MM/DD/YYYY HH:MI:SS AM'), 'MCMAIL2', 3, 'C'); 
COMMIT;
