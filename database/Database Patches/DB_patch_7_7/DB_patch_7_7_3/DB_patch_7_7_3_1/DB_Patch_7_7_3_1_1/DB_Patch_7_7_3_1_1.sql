/*
 * Filename:    DB_Patch_7_7_3_1_1.sql
 *
 ...
 * ----         ---     ---------       -------
 * 20/02/2006	K Shah			Database changes made to comprise release 7.7.3.1.1
 *
 */ 

set echo on
spool DB_Patch_7_7_3_1_1.log
...
INSERT INTO XHB_VERSION ( SCHEMA_NAME, SCHEMA_VERSION, LAST_UPDATE_DATE, UPDATED_BY, DISPLAY_NAME, DISPLAY_SEQ ) 
VALUES ( 'MERCATOR', '7.7.3.1.1', sysdate, 'RELEASE', 'Mercator', 4); 
