...
CREATE TABLE TEMP_AUD_CREST_IMPORT TABLESPACE AUDITD AS SELECT * FROM AUD_CREST_IMPORT;
...
INSERT INTO AUD_CREST_IMPORT (SELECT CREST_IMPORT_ID,
                                     STATUS,
                                     COURT_ID,
                                     IMPORT_TYPE,
                                     SYSDATE,
                                     ...
                                     SYS_CONTEXT('USERENV', 'SESSION_USER'),
                                     1,
                                     INSERT_EVENT FROM TEMP_AUD_CREST_IMPORT);

DROP TABLE TEMP_AUD_CREST_IMPORT;

CREATE TABLE TEMP_AUD_DEFENDANT_ON_CASE TABLESPACE AUDITD AS SELECT * FROM AUD_DEFENDANT_ON_CASE;
...
INSERT INTO AUD_DEFENDANT_ON_CASE (SELECT DEFENDANT_ON_CASE_ID,
                                          NO_OF_TICS,
                                          ...
                                          PNC_ID,
                                          NULL,
                                          INSERT_EVENT FROM TEMP_AUD_DEFENDANT_ON_CASE);

DROP TABLE TEMP_AUD_DEFENDANT_ON_CASE;
