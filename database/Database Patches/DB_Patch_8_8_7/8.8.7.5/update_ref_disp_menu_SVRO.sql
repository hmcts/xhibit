...
SELECT
  ...
  xrdl.FORMAT,
  CASE 
    WHEN xrdl.DIL_SEQ_NO = 65 THEN 'On the day it is made.'
    WHEN xrdl.DIL_SEQ_NO = 70 THEN 'Not until the defendant is released from custody.'
    WHEN xrdl.DIL_SEQ_NO = 75 THEN 'Not until the defendant ceases to be subject to a custodial sentence.'
