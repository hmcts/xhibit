...
FROM XHB_COURT XC, 
      (SELECT xrdm.PARENT,
              'SVRO' DISPOSAL_CODE,
              'Serious Violence Reduction Order' TITLE,
              NVL(MAX(xrdm.SEQ_NO),0)+1 NEXT_SEQ_NO 
         FROM XHB_REF_DISPOSAL_MENU xrdm 
        WHERE xrdm.PARENT = 2663 -- 'MMORE'
...
FROM XHB_REF_DISPOSAL_MENU xrdm, 
     (SELECT 10 DIL_SEQ_NO,
      ...
      SELECT 20 DIL_SEQ_NO,
             ...
             NULL PROMPT,
             'N' INPUT_FLAG,
             'Serious violence reduction order for a period of:',
             NULL CONC_FLAG,
             'N' MANDATORY,
             'N' MULTIPLE_CHOICE,
             NULL DBDESTIN,
      ...
      SELECT 60 DIL_SEQ_NO,
        ...
        FROM DUAL
	   UNION
	  SELECT 65 DIL_SEQ_NO,
             NULL MCGROUP1,
             NULL PROMPT,
             'N' INPUT_FLAG,
             'On the day it is made' DATA,
             NULL CONC_FLAG,
             'N' MANDATORY,
             'Y' MULTIPLE_CHOICE,
             NULL DBDESTIN,
	  ...
	  SELECT 70 DIL_SEQ_NO,
             ...
             NULL PROMPT,
             'N' INPUT_FLAG,
             'Not until the defendant is released from custody' DATA,
             NULL CONC_FLAG,
             'N' MANDATORY,
             'Y' MULTIPLE_CHOICE,
             NULL DBDESTIN,
        ...
        FROM DUAL
        UNION
	   SELECT 75 DIL_SEQ_NO,
             NULL MCGROUP1,
             NULL PROMPT,
             'N' INPUT_FLAG,
             'Not until the defendant ceases to be subject to a custodial sentence' DATA,
             NULL CONC_FLAG,
             'N' MANDATORY,
             'Y' MULTIPLE_CHOICE,
             NULL DBDESTIN,
	   ...
	   SELECT 90 DIL_SEQ_NO,
        ...
        FROM DUAL
	   UNION
	  SELECT 95 DIL_SEQ_NO,
             NULL MCGROUP1,
             NULL PROMPT,
             'N' INPUT_FLAG,
             'on conviction. A new order made at the point of sentencing.' DATA,
             NULL CONC_FLAG,
             'N' MANDATORY,
             'Y' MULTIPLE_CHOICE,
             NULL DBDESTIN,
	  ...
	  SELECT 100 DIL_SEQ_NO,
             ...
             NULL PROMPT,
             'N' INPUT_FLAG,
             'on an appeal from the magistrates'' court.' DATA,
             NULL CONC_FLAG,
             'N' MANDATORY,
             'Y' MULTIPLE_CHOICE,
             NULL DBDESTIN,
        ...
        FROM DUAL
        UNION
	   SELECT 105 DIL_SEQ_NO,
             NULL MCGROUP1,
             NULL PROMPT,
             'N' INPUT_FLAG,
             'on an application to vary, renew or discharge the order.' DATA,
             NULL CONC_FLAG,
             'N' MANDATORY,
             'Y' MULTIPLE_CHOICE,
             NULL DBDESTIN,
