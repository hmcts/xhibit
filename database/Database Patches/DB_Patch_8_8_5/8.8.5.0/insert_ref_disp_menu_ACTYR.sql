...
NULL DISP_TITLE2,
NULL DISP_TITLE1,
NULL D20_OTHER_SENTENCE,
xrdm.TITLE
FROM XHB_REF_DISPOSAL_MENU xrdm
WHERE xrdm.DISPOSAL_CODE = 'ACTYR'
...
FROM XHB_REF_DISPOSAL_MENU xrdm, 
     (SELECT 10 DIL_SEQ_NO,
	  ...
	  SELECT 80 DIL_SEQ_NO,
             ...
             NULL PROMPT,
             'N' INPUT_FLAG,
             'Carry out the following activities:' DATA,
             'N' CONC_FLAG,
             'N' MANDATORY,
             'N' MULTIPLE_CHOICE,
             NULL DBDESTIN,
	  ...
	  SELECT 160 DIL_SEQ_NO,
             ...
             NULL PROMPT,
             'N' INPUT_FLAG,
             'Electronic Compliance Monitoring Requirement (ECMR)? (Y/N)' DATA,
             'N' CONC_FLAG,
             'N' MANDATORY,
             'N' MULTIPLE_CHOICE,
             NULL DBDESTIN,
