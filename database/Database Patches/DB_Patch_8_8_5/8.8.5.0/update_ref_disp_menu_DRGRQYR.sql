...
SELECT
  ...
  xrdl.FORMAT,
  CASE 
    WHEN xrdl.DIL_SEQ_NO = 600 THEN 'Electronic Compliance Monitoring Requirement (ECMR)? (Y/N)'
    WHEN xrdl.DIL_SEQ_NO = 820 THEN 'Electronic Compliance Monitoring Requirement (ECMR)? (Y/N)'
