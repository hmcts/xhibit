...
SELECT
  ...
  xrdl.FORMAT,
  CASE WHEN 
    xrdl.DIL_SEQ_NO = 40 THEN 'Restraining Order Sentencing Act 2020 s.360'
...
-- Updating the Disposal Title on Record Sheet
update xhb_ref_disposal 
set disposal_title = 'Restraining Order Sentencing Act 2020 s.360',
    disp_title1 = 'Restraining Order Sentencing Act 2020 s.360'
where disposal_code = 'RESOR' 
and disposal_title != 'Restraining Order Sentencing Act 2020 s.360'
and disp_title1 != 'Restraining Order Sentencing Act 2020 s.360';

-- Updating the Disposal Title on Disposal Screen
update xhb_ref_disposal_menu
set title = 'Restraining Order Sentencing Act 2020 s.360'
where disposal_code = 'RESOR'
and title != 'Restraining Order Sentencing Act 2020 s.360';

-- Updating Title on Disposal Menu
update xhb_ref_disposal_type
set title = 'Restraining Order Sentencing Act 2020 s.360',
    disp_title1 = 'Restraining Order Sentencing Act 2020 s.360'
where disposal_code = 'RESOR'
and title != 'Restraining Order Sentencing Act 2020 s.360'
