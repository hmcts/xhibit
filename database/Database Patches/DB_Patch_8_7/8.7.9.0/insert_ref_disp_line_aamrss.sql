create or replace PROCEDURE insert_ref_disp_line_aamrss(p_court_id IN xhb_court.court_id%TYPE) AS
...
/**
 ...
 AND rdl.disposal_code IN ('AAMRSS')
...
;
 ...
 END insert_ref_disp_line_aamrss;
/