...
/** 
  ...
  **/
  ...
  x_no_file    EXCEPTION;
   ...
   CURSOR get_xml_c IS
       SELECT XMLAGG(XMLELEMENT("DailyList"
                                ,XMLATTRIBUTES('http://www.courtservice.gov.uk/schemas/courtservice' AS "xmlns:cs"
                                , 'http://www.govtalk.gov.uk/people/AddressAndPersonalDetails' AS "xmlns:p1"
                                , 'http://www.govtalk.gov.uk/people/AddressAndPersonalDetails' AS "xmlns"
                                , 'http://www.govtalk.gov.uk/people/bs7666' AS "xmlns:p2"
...
;
  ...
  **/
  ...
  FUNCTION GET_WARNED_LIST(p_list_id XHB_LIST.LIST_ID%TYPE, v_unique_id VARCHAR, p_show_public_view INTEGER,
                                                     ...
                                                     ,XMLELEMENT("cs:Cases"
                                                        ,XMLELEMENT("cs:Case",
                                                                          ...
                                                                          ,(SELECT XMLAgg( XMLELEMENT("cs:Defendants", 
                                                                                              get_defendant(xdoc.DEFENDANT_ON_CASE_ID, p_show_public_view, 0)))
                                                          ...
                                                          , XMLELEMENT("cs:Cases"
                                                            ,XMLELEMENT("cs:Case",
                                                                 ...
                                                                 , XMLFOREST(XMLFOREST(xrht.hearing_type_desc AS "cs:HearingDescription"
                                                                  ...
                                                                  ,(SELECT XMLAgg( XMLELEMENT("cs:Defendants", 
                                                                                              get_defendant(xdocol.DEFENDANT_ON_CASE_ID, p_show_public_view, 0)))
...
FUNCTION get_floating_cases(p_court_site_id XHB_COURT_SITE.COURT_SITE_ID%TYPE, p_list_id XHB_LIST.LIST_ID%TYPE,
 ...
 BEGIN
 SELECT(XMLFOREST(
         xrpa.PROSECUTOR_NAME_3 AS "ProsecutingReference"
        ,XMLFOREST( XMLFOREST(xrpa.CPS_CODE AS "cs:OrganisationCode"
...
--                        )--CommittingCourt
      ...
      AND  ((xc.CASE_TYPE = 'A' AND  NVL(xcpa.PROSECUTOR_TYPE, 'R') = 'R')
        OR   (xc.CASE_TYPE <> 'A'))
      AND  xcpa.ref_prosecutor_agency_id = xrpa.ref_prosecutor_agency_id (+)
