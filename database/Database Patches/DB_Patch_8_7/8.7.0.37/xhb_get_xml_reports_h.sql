...
FUNCTION GET_DAILY_PRISON_LIST(p_list_id XHB_LIST.LIST_ID%TYPE, v_unique_id VARCHAR) RETURN CLOB;
 ...
 FUNCTION GetRlData 
  ...
  FUNCTION get_highlight_note(p_case_id XHB_CASE.CASE_ID%TYPE, p_include_standard_notes INTEGER,  p_include_priority_notes INTEGER,  p_include_restricted_notes INTEGER) RETURN VARCHAR2;
