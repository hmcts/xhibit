   ...
   --Determine the List Type
        ...
        IF(v_list_type = 'Daily') THEN
          --If List is Daily List
           ...
           STORE_LIST(v_return_xml, 'Daily Prison', v_list_row, v_document_type, l_validation_id , v_unique_id , v_list_court);
      ...
      STORE_LIST(v_return_xml, v_list_type, v_list_row, v_document_type, l_validation_id , v_unique_id , v_list_court);
  ...
  INSERT INTO XHB_CLOB(clob_id, clob_data)
        ...
        INSERT INTO XHB_XML_DOCUMENT ( date_created,
                              ...
                              VALUES (TRUNC(SYSDATE),
                                       p_list_type ||' List ' || DECODE(p_list_row.DRAFT_OR_FINAL, 'D', 'DRAFT v', 'F', 'FINAL v') || p_list_row.LIST_NUMBER || ' ' || p_list_row.LIST_START_DATE,
                                       G_NEW_DOCUMENT,
      ...
      INSERT INTO XHB_VALIDATION_CJI (VALIDATION_ID, 
                              ...
                              VALUES (p_validation_id,
                                      ...
                                      p_list_type ||' List, ' || p_list_court.COURT_NAME || ' on ' || p_list_row.LIST_START_DATE || ' ' || DECODE(p_list_row.DRAFT_OR_FINAL, 'D', 'DRAFT v', 'F', 'FINAL v') || p_list_row.LIST_NUMBER);
