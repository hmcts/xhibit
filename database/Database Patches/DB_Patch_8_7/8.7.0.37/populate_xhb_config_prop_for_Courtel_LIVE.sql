...
Insert into XHB_CONFIG_PROP (CONFIG_PROP_ID,PROPERTY_NAME,PROPERTY_VALUE) values ((select max(config_prop_id)+1 from xhb_config_prop),'COURTEL_FILE_PATH','/opt/moj/bea/user_projects/domains/XHIBIT_LIVE/courtel');
Insert into XHB_CONFIG_PROP (CONFIG_PROP_ID,PROPERTY_NAME,PROPERTY_VALUE) values ((select max(config_prop_id)+1 from xhb_config_prop),'COURTEL_KEY_MANAGER_JKS','/opt/moj/bea/user_projects/domains/XHIBIT_LIVE/common/security/courtel.jks');
Insert into XHB_CONFIG_PROP (CONFIG_PROP_ID,PROPERTY_NAME,PROPERTY_VALUE) values ((select max(config_prop_id)+1 from xhb_config_prop),'COURTEL_TRUST_MANAGER_JKS','/opt/moj/bea/user_projects/domains/XHIBIT_LIVE/common/security/courteltrust');
