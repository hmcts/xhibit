...
/** 
 ...
 PROCEDURE GetReportRequest (p_report       IN  VARCHAR2
  ...
  FUNCTION GET_FIRM_LIST_DATA(p_list_id XHB_LIST.LIST_ID%TYPE) 
  RETURN CLOB;
  ...
  FUNCTION GET_FIRM_COURT_LISTS(p_list_id XHB_LIST.LIST_ID%TYPE, p_court_id XHB_COURT.COURT_ID%TYPE)
  RETURN XMLTYPE;
  FUNCTION GET_COURT_HOUSE(p_court_house_id XHB_COURT_SITE.COURT_SITE_ID%TYPE) RETURN XMLTYPE;
  FUNCTION GET_RESERVED_HEARINGS_ON_LIST(p_list_id XHB_LIST.LIST_ID%TYPE) 
  RETURN XMLTYPE;
