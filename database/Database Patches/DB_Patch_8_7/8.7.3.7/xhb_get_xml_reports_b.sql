   ...
   BEGIN
                       SELECT '<?xml version="1.0" encoding="UTF-8"?>' ||
                              XMLELEMENT("cs:WarnedList"
                                  ...
                                  , GET_LIST_HEADER(xl.LIST_ID) --ListHeader
                                  , case when p_publish = 1 then GET_CROWN_COURT_RL(xl.COURT_ID)
                                    else  XMLELEMENT("cs:CrownCourt", XMLConcat (XMLELEMENT( "cs:CourtHouseType", 'Crown Court')
                                                                     ,XMLELEMENT("cs:CourtHouseCode", xcrt.CREST_COURT_ID)
