  ...
  PROCEDURE PUBLISH_LIST(p_list_id XHB_LIST.LIST_ID%TYPE) IS
   ...
   --Determine the List Type
        ...
        IF(v_list_type = 'Daily') THEN
          ...
          INSERT INTO MTBL_MERC_DL_STORAGE(NAME, MSGTYPE, MSGTIME, MSGDATE, MESSAGE) 
          VALUES ('Daily List XML Extract Delivery', 'Daily_List_XML_Upload', to_char(sysdate, 'HH:MI:SS'), sysdate,  v_merc_xml);
        ELSE
          v_return_xml:= XHB_GET_XML_REPORTS.GetDLData(p_list_id);
        END IF;
