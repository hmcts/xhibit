create or replace TRIGGER "XHIBIT".XHB_REF_CHAMBER_BIR_TR
  BEFORE INSERT
  ON XHB_REF_CHAMBER
  FOR EACH ROW
...
BEGIN
  ...
  IF :NEW.CREST_CHAMBER_ID IS NULL THEN
    SELECT XHB_REF_CHAMBER_CREST_SEQ.NEXTVAL
    INTO   :NEW.CREST_CHAMBER_ID
    FROM DUAL;
  END IF;
END;
/