   ...
   BEGIN
        OPEN results_out FOR
            SELECT
                  ...
                  CASE WHEN xrsc.DE_CODE LIKE 'NOT BEFORE%' THEN xcol.TIME_LISTED ELSE null END NOT_BEFORE_TIME,
                  ...
                  COURTHOUSE.COURT_ID REF_COURT_ID, COURTHOUSE.COURT_TYPE, COURTHOUSE.CREST_COURT_ID CREST_CODE, COURTHOUSE.SHORT_NAME COURT_SHORT_NAME, COURTHOUSE.DISPLAY_NAME COURT_FULL_NAME,
          ...
          SELECT
                ...
                null SITTING_ID, null SITTING_SEQUENCE_NO, convert_to_boolean(xcol.FLOATER_CASE) IS_FLOATING, null SITTING_NOTE, null as SITTING_TIME,
                ...
                xcol.CASE_ON_LIST_ID SCHEDULED_HEARING_ID, xcol.SEQ_NO SEQUENCE_NO,  
                CASE WHEN xrsc.DE_CODE = 'NOT BEFORE' THEN xcol.TIME_LISTED ELSE null END NOT_BEFORE_TIME,
                ...
                0 HEARING_PROGRESS, xcol.SITTING_ON_LIST_ID SITTING_ID, xcol.CASE_ON_LIST_ID HEARING_ID, null MOVED_FROM, xcol.VERSION AS SCHEDULED_HEARING_VERSION, null LINKED_SH_ID,  null END_TIME,
                 CASE WHEN xrsc.DE_CODE = 'SITTING AT ' THEN xcol.TIME_LISTED END START_TIME,
                 xcol.TIME_LISTED DATE_OF_HEARING, 'Y' IS_CASE_ACTIVE,
                REF_HEARING_TYPE.REF_HEARING_TYPE_ID, REF_HEARING_TYPE.HEARING_TYPE_CODE, REF_HEARING_TYPE.HEARING_TYPE_DESC, REF_HEARING_TYPE.CATEGORY, REF_HEARING_TYPE.SEQ_NO, REF_HEARING_TYPE.LIST_SEQUENCE, REF_HEARING_TYPE.VERSION AS REF_HEARING_TYPE_VERSION, REF_HEARING_TYPE.COURT_ID, REF_HEARING_TYPE.OBS_IND AS REF_HEARING_TYPE_OBS_IND,
                xc.CASE_ID, xc.CASE_NUMBER, xc.CASE_TYPE, xc.MAG_CONVICTION_DATE, xc.CASE_SUB_TYPE, xc.CASE_TITLE, xc.CASE_DESCRIPTION, xc.LINKED_CASE_ID, xc.BAIL_MAG_CODE, xc.REF_COURT_ID, xc.COURT_ID, xc.CHARGE_IMPORT_INDICATOR, xc.SEVERED_IND, xc.INDICT_RESP, xc.DATE_IND_REC, xc.PROS_AGENCY_REFERENCE, xc.VERSION AS CASE_VERSION, xc.CASE_CLASS, xc.JUDGE_REASON_FOR_APPEAL, xc.RESULTS_VERIFIED, xc.LENGTH_TAPE, xc.NO_PAGE_PROS_EVIDENCE, xc.NO_PROS_WITNESS, xc.EST_PDH_TRIAL_LENGTH, xc.INDICTMENT_INFO_1, xc.INDICTMENT_INFO_2, xc.INDICTMENT_INFO_3, xc.INDICTMENT_INFO_4, xc.INDICTMENT_INFO_5, xc.INDICTMENT_INFO_6, xc.POLICE_OFFICER_ATTENDING, xc.CPS_CASE_WORKER, xc.EXPORT_CHARGES, xc.IND_CHANGE_STATUS, xc.RECEIPT_TYPE,
                COURTHOUSE.COURT_ID REF_COURT_ID, COURTHOUSE.COURT_TYPE, COURTHOUSE.CREST_COURT_ID CREST_CODE, COURTHOUSE.SHORT_NAME COURT_SHORT_NAME, COURTHOUSE.DISPLAY_NAME COURT_FULL_NAME,
