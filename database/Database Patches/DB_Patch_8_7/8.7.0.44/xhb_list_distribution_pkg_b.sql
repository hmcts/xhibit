create or replace PACKAGE BODY xhb_list_distribution_pkg AS
    ...
    BEGIN   
        ...
        IF(v_list_type = 'Daily') THEN
          ...
          v_document_title:= v_list_name || ' ' || v_list_version;
          STORE_XML_DOCUMENT(v_return_xml, v_document_title, sysdate, v_document_type_code, v_list_court.COURT_ID);
          ...
          v_document_name := v_document_type_code || ' ' || v_list_start_date || ' ' || v_list_version;
          v_document_description := v_list_name || ', ' || INITCAP(v_list_court.COURT_NAME) || ' on ' || v_list_start_date || ' '  || v_list_version;
          STORE_XML_DOCUMENT(v_return_xml, v_document_title, v_list_row.LIST_START_DATE, v_document_type_code, v_list_court.COURT_ID, true);
