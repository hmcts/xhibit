             ...
             -- AND   xhc1.ref_court_id = xcrt.ref_court_id
              ...
              AND EXISTS ( -- This will remove disposal code 0 and Not Required disposal type values removed
                ...
                where  D.REF_DISPOSAL_type_ID=RDT.REF_DISPOSAL_TYPE_ID and
                       ...
                       d.defendant_on_case_id = xdoc.defendant_on_case_id and
                       RDT.DISPOSAL_CODE NOT IN ('DISQVC','NRADD','DISTEST','DISPCCA','DDPAS','TDISQ','DISREM','DISQAO') 
                ...
                where  D.REF_DISPOSAL_type_ID=RDT.REF_DISPOSAL_TYPE_ID and
                       RDT.DISPOSAL_CODE = xdc.crest_disposal_code and
                       RDT.DISPOSAL_CODE NOT IN ('DISQVC','NRADD','DISTEST','DISPCCA','DDPAS','TDISQ','DISREM','DISQAO') AND
                       xdc.disposal_type NOT IN('NR','DD') AND
