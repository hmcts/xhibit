...
/**
  ...
  **/
  ...
  BEGIN
    SELECT XMLAgg(
                  XMLELEMENT("ScheduledHearing",xcol.SEQ_NO || '|' || CASE WHEN(xrsc.DE_CODE IS NOT NULL) THEN ESCAPE_BROKER_RELEASE_CHARS(xrsc.DE_CODE) ||  TO_CHAR(xcol.TIME_LISTED, 'HH24:MI am') END ||  '|' ||  TO_CHAR(xcol.TIME_LISTED, 'YYYY-MM-DDHH24:MI') || '|' || TO_CHAR(NVL(xcol.TIME_LISTED, xsol.TIME_LISTED), 'HH24:MI am') || '|'
