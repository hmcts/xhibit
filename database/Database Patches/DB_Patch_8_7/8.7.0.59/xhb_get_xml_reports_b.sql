                   ...
                   XMLELEMENT("cs:PersonalDetails",
                     ...
                     , XMLELEMENT("cs:Counsel"
                      , (SELECT XMLAgg(XMLELEMENT("cs:Solicitor"
                        ...
                        ,XMLFOREST((CASE WHEN include_charge_log = 1 THEN get_charge_logs(xdoc.DEFENDANT_ON_CASE_ID) ELSE get_charges(xdoc.DEFENDANT_ON_CASE_ID) END )"cs:Charges")  --Charges
