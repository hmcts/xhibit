...
FUNCTION GET_CASE_STATUS(p_case_id IN xhb_case.case_id%TYPE) RETURN VARCHAR2;
...
FUNCTION GET_EARLIEST_LISTING_DATE(p_case_id IN xhb_case.CASE_ID%TYPE,p_def_case_id IN xhb_defendant_on_case.DEFENDANT_ON_CASE_ID%TYPE) RETURN DATE;					
