...
BEGIN
  SELECT  WM_CONCAT(NVL(xhb_disp_line.DATA, NVL(ref_data_view.DATA, '')))
  INTO v_disposal_lines
  FROM   
        (SELECT   x_disp.DISPOSAL2_ID, xrd_line.REF_DISPOSAL_LINE_ID,   xrd_line.DATA,  
        xrd_line.PROMPT, xrd_line.FORM_PRINT, xrd_line.LINE_INSERT, xrd_line.DIL_SEQ_NO, xrd_line.DBDESTIN    FROM   
