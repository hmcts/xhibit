...
EXCEPTION WHEN NO_DATA_FOUND THEN
          ...
          DBMS_OUTPUT.PUT_LINE('#                                                                                          #');
          DBMS_OUTPUT.PUT_LINE(to_char(sysdate,'DD/MM/YYYY-HH24:MI:SS')||':> Please retry running C2X_RUN_DM_ETL_2 script with a Valid CREST COURT ID!');
          DBMS_OUTPUT.PUT_LINE('#                                                                                          #');
          DBMS_OUTPUT.PUT_LINE('############################################################################################');
END;
/
...
set termout on
spool C2X_DM_ETL_2_err_log_&sysdt_var\.log append
...
/******************** run post DM Procedure XHB_DM_UPD_DUMMY_SITTINGS *****************/
...
select '########################################################################################' from dual;
select '                                                                                        ' from dual;
select to_char(sysdate,'DD/MM/YYYY-HH24:MI:SS')||':>Running Post DM procedure XHB_DM_UPD_DUMMY_SITTINGS script ...' from dual;
select '                                                                                        ' from dual;
select '########################################################################################' from dual;
select '                                                                                        ' from dual;
select '----------------------------------------------------------------------------------------' from dual;
...
@execute_xhb_dm_upd_dummy_sittings.sql &xhibit_court_id 
...
select '----------------------------------------------------------------------------------------' from dual;
select '                                                                                        ' from dual;
select to_char(sysdate,'DD/MM/YYYY-HH24:MI:SS')||':> execute_xhb_dm_upd_dummy_sittings.sql NOW complete.' from dual;
select '                                                                                        ' from dual;
select '########################################################################################' from dual;
select '                                                                                        ' from dual;
...
/***************  END :  PROCEDURE xhibit.upd_xhb_dm_upd_dummy_sittings ***********/
...
select '----------------------------------------------------------------------------------------' from dual;
select '                                                                                        ' from dual;
select to_char(sysdate,'DD/MM/YYYY-HH24:MI:SS')||':>Now Calling script etl_data_migration_report.sql to generate DM report AND DM Summary CSV...' from dual;
select '                                                                                        ' from dual;
...
select '----------------------------------------------------------------------------------------' from dual;
select '                                                                                        ' from dual;
select to_char(sysdate,'DD/MM/YYYY-HH24:MI:SS')||':> etl_data_migration_report.sql NOW complete, running SUMMARY now...please check report ....' from dual;
select '                                                                                        ' from dual;
select '########################################################################################' from dual;
select '                                                                                        ' from dual;
...
@etl_dm_summary_report_csv.sql &court_id  &xhibit_court_id 
...
select '----------------------------------------------------------------------------------------' from dual;
select '                                                                                        ' from dual;
select to_char(sysdate,'DD/MM/YYYY-HH24:MI:SS')||':> etl_dm_summary_report_csv.sql NOW complete, please check report ....' from dual;
select '                                                                                        ' from dual;
select '########################################################################################' from dual;
select '                                                                                        ' from dual;
spool off
