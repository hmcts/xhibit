/** 
  ...
  * 20/12/2018    J Riley         1.1         CTX-3420 Change SP name called to XHB_POPULATE_REF_CALENDAR_ALL, start year to 2020
  *
  **/
  BEGIN
   DBMS_SCHEDULER.CREATE_JOB (job_name        => 'PopulateRefCalendar'
                             ,job_type        => 'stored_procedure'
                             ,job_action      => 'XHIBIT.XHB_POPULATE_REF_CALENDAR_ALL'
