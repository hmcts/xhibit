create or replace PACKAGE BODY xhb_list_distribution_pkg AS
    ...
    BEGIN   
        ...
        IF(v_list_type = 'Daily') THEN
          ...
          STORE_VALIDATION_DOCUMENT(v_return_xml, v_document_name, v_document_description, v_document_type_code, l_validation_id, v_unique_id, v_list_court.CREST_COURT_ID);
    ...
    PROCEDURE STORE_VALIDATION_DOCUMENT(p_return_xml CLOB, p_document_name VARCHAR2, p_document_description VARCHAR2, p_document_type_code VARCHAR2,
                                        p_validation_id XHB_VALIDATION.VALIDATION_ID%TYPE, p_unique_id VARCHAR, p_crest_court_id XHB_COURT.CREST_COURT_ID%TYPE) as
