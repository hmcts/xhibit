   ...
   SELECT XMLELEMENT("cs:CaseArrivedFrom"
                     , XMLELEMENT("cs:OriginatingCourt"
                          ...
                          ,XMLELEMENT("cs:CourtHouseCode" ,XMLATTRIBUTES(NVL(xmcrt.COURT_SHORT_NAME, '---') AS "CourtHouseShortName"), LPAD(xmcrt.CREST_CODE, 4, 0))--CourtHouseCode
                           ...
                           ,XMLELEMENT("cs:CourtHouseAddress", XMLFOREST(NVL(xaddm.ADDRESS_1, '-') AS "apd:Line"
                                                                        ,NVL(xaddm.ADDRESS_2, '-') AS "apd:Line"
                                                                        ,NVL(xaddm.ADDRESS_3, '-') AS "apd:Line"
                                                                        ,NVL(xaddm.ADDRESS_4, '-') AS "apd:Line"
  ...
  */
  ...
  BEGIN
   SELECT XMLELEMENT("cs:CrownCourt", XMLConcat (XMLELEMENT( "cs:CourtHouseType", 'Crown Court')
                                                                     ...
                                                                     , XMLELEMENT("cs:CourtHouseAddress", XMLFOREST(NVL(xadc.ADDRESS_1, '-') AS "apd:Line"
                                                                                                                ,NVL(xadc.ADDRESS_2, '-') AS "apd:Line"
                                                                                                                ,NVL(xadc.ADDRESS_3, '-') AS "apd:Line"
                                                                                                                ,NVL(xadc.ADDRESS_4, '-') AS "apd:Line"
  ...
  SELECT XMLELEMENT("cs:Defendant",
                   XMLELEMENT("cs:PersonalDetails",
                             XMLFOREST(XMLFOREST(CASE WHEN (p_show_public_view = 1 AND xdoc.IS_MASKED = 'Y') OR (p_show_defendant_name = 0) THEN ' ' ELSE INITCAP(xd.FIRST_NAME) END AS "apd:CitizenNameForename"
                                     ...
                                     , XMLFOREST(NVL(xa.ADDRESS_1, '-') AS "apd:Line"
                                                                                       ,NVL(xa.ADDRESS_2, '-') AS "apd:Line"
                                                                                       ,NVL(xa.ADDRESS_3, '-') AS "apd:Line"
                                                                                       ,NVL(xa.ADDRESS_4, '-') AS "apd:Line"
                      ...
                      , (SELECT XMLAgg(XMLELEMENT("cs:Solicitor"
                                     , XMLELEMENT("cs:Party"
                                       , XMLELEMENT("cs:Organisation"
                                         ...
                                         , XMLELEMENT("cs:OrganisationAddress",XMLFOREST(NVL(solicitor_address.ADDRESS_1, '-') AS "apd:Line"
                                                                                       ,NVL(solicitor_address.ADDRESS_2, '-') AS "apd:Line"
                                                                                       ,NVL(solicitor_address.ADDRESS_3, '-') AS "apd:Line"
                                                                                       ,NVL(solicitor_address.ADDRESS_4, '-') AS "apd:Line"
