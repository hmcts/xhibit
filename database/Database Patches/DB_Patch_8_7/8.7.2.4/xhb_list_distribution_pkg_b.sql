CREATE OR REPLACE PACKAGE BODY xhb_list_distribution_pkg AS
    ...
    BEGIN   
        ...
        IF(v_list_type = 'Daily') THEN
          ...
          STORE_XML_DOCUMENT(v_return_xml, v_document_title, v_list_row.LIST_START_DATE, v_document_type_code, v_list_court.COURT_ID);
          ...
          STORE_XML_DOCUMENT(v_return_xml, v_document_title, sysdate, v_document_type_code, v_list_court.COURT_ID, true);
    ...
    --
    PROCEDURE STORE_XML_DOCUMENT(p_return_xml CLOB, p_doc_title VARCHAR2, p_doc_date DATE, p_document_type_code VARCHAR2, p_court_id XHB_COURT.COURT_ID%TYPE, p_store_control boolean default false) as
          l_clob_id XHB_CLOB.clob_id%TYPE;
		  l_xml_document_id XHB_XML_DOCUMENT.xml_document_id%type;
    BEGIN
