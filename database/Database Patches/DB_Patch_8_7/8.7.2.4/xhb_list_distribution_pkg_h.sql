create or replace PACKAGE xhb_list_distribution_pkg AS
    ...
    PROCEDURE STORE_XML_DOCUMENT(p_return_xml CLOB, p_doc_title VARCHAR2, p_doc_date DATE, p_document_type_code VARCHAR2, p_court_id XHB_COURT.COURT_ID%TYPE, p_store_control boolean default false);
