 ...
 * ----         ---     ---------       -------
 * 16/05/05	SS			Database changes to incorperate release 7.5
 * 01/06/05	SS			Database changes to rename column xhb_order_disposal
 *					_xref.CO_REF_DISPOSAL_TYPE_ID to xhb_order_disposal_
 *					xref.ORDER_TYPE_ID
 * 06/06/05	SS			Ammended to included insert of 6 rows into MTBL_TIME
 *					_TRIGGER
 * 06/06/05	SS			Amended xhb_court.PROBATION_OFFICE_NAME to varchar2(
 *					50)
 */ 
