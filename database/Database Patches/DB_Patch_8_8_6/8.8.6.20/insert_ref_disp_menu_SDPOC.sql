...
FROM XHB_COURT XC, 
      (SELECT xrdm.PARENT,
              'SDPOC' DISPOSAL_CODE,
              'Serious Disruption Prevention Order made on conviction (s20 POA 2023)' TITLE,
...
xrdm.TITLE
FROM XHB_REF_DISPOSAL_MENU xrdm
WHERE xrdm.DISPOSAL_CODE = 'SDPOC'
...
FROM XHB_REF_DISPOSAL_MENU xrdm, 
     (SELECT 10 DIL_SEQ_NO,
      ...
      SELECT 21 DIL_SEQ_NO,
             ...
             NULL PROMPT,
             'N' INPUT_FLAG,
             '(under section 20 of Public Order Act 2023) for a period of:',
             NULL CONC_FLAG,
             'N' MANDATORY,
             'N' MULTIPLE_CHOICE,
             NULL DBDESTIN,
