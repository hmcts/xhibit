...
FROM XHB_REF_DISPOSAL_MENU xrdm, 
     (SELECT 10 DIL_SEQ_NO,
      ...
      SELECT 20 DIL_SEQ_NO,
             ...
             NULL PROMPT,
             'N' INPUT_FLAG,
             'Recognizance forfeited. Surety ordered to pay:' DATA,
             NULL CONC_FLAG,
             'N' MANDATORY,
             'N' MULTIPLE_CHOICE,
             NULL DBDESTIN,
