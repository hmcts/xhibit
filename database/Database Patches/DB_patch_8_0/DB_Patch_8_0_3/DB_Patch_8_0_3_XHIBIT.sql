/*
 * Filename:    DB_Patch_8_0_3_XHIBIT.sql
 *
 ...
 * ----         ---     ---------       -------
   20/06/2006   K SHAH			database changes made to comprise 
                     			release 8.0.2
   27/06/2006   K SHAH			database changes made to comprise 
                     			release 8.0.3
 *
 */ 
set echo on
...
VALUES ( 'JAVACLIENT', '8.0.3', sysdate, 'RELEASE', 'Java Client Application', 1); 

INSERT INTO XHB_VERSION ( SCHEMA_NAME, SCHEMA_VERSION, LAST_UPDATE_DATE, UPDATED_BY, DISPLAY_NAME, DISPLAY_SEQ ) 
VALUES ( 'JAVASERVER', '8.0.3', sysdate, 'RELEASE', 'Java Server Component', 2); 

INSERT INTO XHB_VERSION ( SCHEMA_NAME, SCHEMA_VERSION, LAST_UPDATE_DATE, UPDATED_BY, DISPLAY_NAME, DISPLAY_SEQ ) 
VALUES ( 'XHIBIT', '8.0.3', sysdate , 'RELEASE', 'Database', 3); 

INSERT INTO XHB_VERSION ( SCHEMA_NAME, SCHEMA_VERSION, LAST_UPDATE_DATE, UPDATED_BY, DISPLAY_NAME, DISPLAY_SEQ ) 
VALUES ( 'MERCATOR', '8.0.3', sysdate, 'RELEASE', 'Mercator', 4); 
