/*
 * Filename:    DB_Patch_8_0_4_XHIBIT.sql
 *
 ...
 * ----         ---     ---------       -------
   13/10/2006   K SHAH			database changes made to comprise 
                     			release 8.0.4 - changes include those for
 					releases 8.0.3 + 8.0.3.2
 *
 */ 
set echo on
set term off
column filename new_value spool_filename
  select 'DBPATCH_8_0_4_XHIBIT_'||
...
VALUES ( 'JAVACLIENT', '8.0.4', sysdate, 'RELEASE', 'Java Client Application', 1); 

INSERT INTO XHB_VERSION ( SCHEMA_NAME, SCHEMA_VERSION, LAST_UPDATE_DATE, UPDATED_BY, DISPLAY_NAME, DISPLAY_SEQ ) 
VALUES ( 'JAVASERVER', '8.0.4', sysdate, 'RELEASE', 'Java Server Component', 2); 

INSERT INTO XHB_VERSION ( SCHEMA_NAME, SCHEMA_VERSION, LAST_UPDATE_DATE, UPDATED_BY, DISPLAY_NAME, DISPLAY_SEQ ) 
VALUES ( 'XHIBIT', '8.0.4', sysdate , 'RELEASE', 'Database', 3); 

INSERT INTO XHB_VERSION ( SCHEMA_NAME, SCHEMA_VERSION, LAST_UPDATE_DATE, UPDATED_BY, DISPLAY_NAME, DISPLAY_SEQ ) 
VALUES ( 'MERCATOR', '8.0.4', sysdate, 'RELEASE', 'Mercator', 4); 
