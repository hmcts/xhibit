/*
 * Filename:    DB_Patch_8_0_4_CJIT.sql
 *
 ...
 * ----         ---     ---------       -------
   13/10/2006   K SHAH			database changes made to comprise 
                     			release 8.0.4 - combines 8.0.3 and
					8.0.3.2 releases
 */ 
set echo on
set term off
column filename new_value spool_filename
  select 'DBPATCH_8_0_4_CJIT_'||
...
VALUES ('CJSE','8_0_4',sysdate,'CJIT','CJSE Database Schema 8_0_4',1);
