 ...
 * ----         ---     ---------       -------
 * 27/04/05	SS			Update to the xhb_post_merc_ref package
 *
 */ 
...
VALUES ( 'XHIBIT', '7.4.4.9', sysdate , 'RELEASE', 'Database', 3); 

INSERT INTO XHB_VERSION ( SCHEMA_NAME, SCHEMA_VERSION, LAST_UPDATE_DATE, UPDATED_BY, DISPLAY_NAME, DISPLAY_SEQ ) 
VALUES ( 'MERCATOR', '7.4.4.9', sysdate, 'RELEASE', 'Mercator', 4); 
