/*
 * Filename:    Xhibit_DB_Patch_8_8_1_3.sql (Functional 2021 release)
 *
 *
 ...
 * DATE         WHO             COMMENT
 * ----         ---             -------
 * 19/08/2021	S.Atwell		xlc3-75, xlc3-78
 */

set echo on
set term off
column filename new_value spool_filename
  select 'Xhibit_DB_Patch_8_8_1_3_'||
...
INSERT INTO XHB_VERSION ( SCHEMA_NAME, SCHEMA_VERSION, LAST_UPDATE_DATE, UPDATED_BY, DISPLAY_NAME, DISPLAY_SEQ ) 
VALUES ( 'XHIBIT', '8.8.1.3', sysdate , 'RELEASE', 'Database', 3);
