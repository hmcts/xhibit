...
SET TITLE = 'Detention in a Y.O.I.- Extended (under s265 of Sentencing Act 2020)'
WHERE disposal_code = 'YOIE'
AND TITLE != 'Detention in a Y.O.I.- Extended (under s265 of Sentencing Act 2020)';
...
xrdt.DISP_TITLE2,
xrdt.DISP_TITLE1,
'Detention in a Y.O.I.- Extended (under s265 of Sentencing Act 2020)' TITLE
FROM XHB_REF_DISPOSAL_TYPE xrdt
WHERE xrdt.DISPOSAL_CODE = 'YOIE'
...
FROM XHB_REF_DISPOSAL_TYPE xrdt, 
     (SELECT 20 DIL_SEQ_NO,
      ...
      SELECT 31 DIL_SEQ_NO,
             NULL PROMPT,
             'N' INPUT_FLAG,
             'detention under section 265 Sentencing Act 2020',
             NULL CONC_FLAG,
             'N' MANDATORY,
             'N' MULTIPLE_CHOICE,
             NULL DBDESTIN,
