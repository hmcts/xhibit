CREATE OR REPLACE PACKAGE BODY XHIBIT.xhb_housekeeping_pkg AS
...
* 1.6	   18/05/2012 S Atwell	Added several extra deletes for defects 6723 and 6724 identified as part of
*				enabling HK functionality.
************************************************************************************/
...
--
  ...
  BEGIN
    ...
    -- 2.1 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE xhb_court_log_entry WHERE defendant_on_offence_id IN
		 (SELECT defendant_on_offence_id FROM xhb_defendant_on_offence WHERE offence_id IN
			(SELECT offence_id FROM xhb_offence WHERE charge_id IN
				(SELECT charge_id
                                      FROM   xhb_charge
                                      WHERE  case_id = :1
                                      )))';
    ...
    -- 2.2 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE xhb_disposal_reference WHERE disposal_id IN
		 (SELECT disposal_id FROM xhb_disposal WHERE defendant_on_offence_id IN
			 (SELECT defendant_on_offence_id FROM xhb_defendant_on_offence WHERE offence_id IN
				(SELECT offence_id FROM xhb_offence WHERE charge_id IN
					(SELECT charge_id
                        	              FROM   xhb_charge
    ...
    -- 2.3 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE xhb_disposal WHERE defendant_on_offence_id IN
		(SELECT defendant_on_offence_id FROM xhb_defendant_on_offence WHERE offence_id IN
			(SELECT offence_id FROM xhb_offence WHERE charge_id IN
				(SELECT charge_id
                       	              FROM   xhb_charge
    ...
    l_delete := REPLACE (l_delete,'xhb','aud');
    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    l_error_point := 'DELETE CHARGE 3.3';

    -- 2.4 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE xhb_disposal_line WHERE disposal2_id IN
		 (SELECT disposal2_id FROM xhb_disposal2 WHERE defendant_on_offence_id IN
			 (SELECT defendant_on_offence_id FROM xhb_defendant_on_offence WHERE offence_id IN
				(SELECT offence_id FROM xhb_offence WHERE charge_id IN
					(SELECT charge_id
                        	              FROM   xhb_charge
    ...
    l_delete := REPLACE (l_delete,'xhb','aud');
    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    l_error_point := 'DELETE CHARGE 3.4';

    -- 2.5 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE xhb_disposal2 WHERE defendant_on_offence_id IN
		 (SELECT defendant_on_offence_id FROM xhb_defendant_on_offence WHERE offence_id IN
			(SELECT offence_id FROM xhb_offence WHERE charge_id IN
				(SELECT charge_id
                       	              FROM   xhb_charge
    ...
    l_delete := REPLACE (l_delete,'xhb','aud');
    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    l_error_point := 'DELETE CHARGE 3.5';

    -- 2.6 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE xhb_plea WHERE defendant_on_offence_id IN
		 (SELECT defendant_on_offence_id FROM xhb_defendant_on_offence WHERE offence_id IN
			(SELECT offence_id FROM xhb_offence WHERE charge_id IN
				(SELECT charge_id
                       	              FROM   xhb_charge
    ...
    l_delete := REPLACE (l_delete,'xhb','aud');
    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    l_error_point := 'DELETE CHARGE 3.6';

    -- 2.7 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE xhb_defendant_on_offence WHERE offence_id IN
		 (SELECT offence_id FROM xhb_offence WHERE charge_id IN
			(SELECT charge_id
               	              FROM   xhb_charge
                      	      WHERE  case_id = :1
    ...
    l_delete := REPLACE (l_delete,'xhb','aud');
    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    l_error_point := 'DELETE CHARGE 3.7';
...
--
  ...
  BEGIN
   ...
   l_delete := 'DELETE xhb_verdict
    ...
    -- 19 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE xhb_def_hearing_record
                 WHERE  defendant_on_case_id IN (SELECT defendant_on_case_id
                                                 FROM   xhb_defendant_on_case
                                                 WHERE  case_id = :1
                                                )';
    ...
    l_delete := REPLACE (l_delete,'xhb','aud');
    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    l_error_point := 'DELETE DEFENDANT 25e';

    -- 19.1 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE xhb_sched_hearing_defendant
                 WHERE  defendant_on_case_id IN (SELECT defendant_on_case_id
                                                 FROM   xhb_defendant_on_case
                                                 WHERE  case_id = :1
                                                )';
    ...
    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    log_delete (p_table_name      => 'XHB_SCHED_HEARING_DEDENDANT' );
    l_delete := REPLACE (l_delete,'xhb','aud');
    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    l_error_point := 'DELETE DEFENDANT 25f';
...
--
  ...
  BEGIN
    ...
    -- 9.1 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE xhb_direction_attend WHERE directions_for_case_id IN
		 (SELECT directions_for_case_id FROM xhb_directions_for_case WHERE case_id = :1)';

    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    log_delete (p_table_name      => 'XHB_DIRECTION_ATTEND' );
    l_delete := REPLACE (l_delete,'xhb','aud');
    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    l_error_point := 'DELETE CASE 12.1 ';
    ...
    -- 14.1 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE xhb_exporta WHERE hearing_id IN
		 (SELECT hearing_id FROM xhb_hearing WHERE case_id in
			(SELECT case_id FROM xhb_case WHERE case_id = :1))';

    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    log_delete (p_table_name      => 'XHB_EXPORTA' );
    l_delete := REPLACE (l_delete,'xhb','aud');
    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    l_error_point := 'DELETE CASE 17.1 ';

    -- 14.2 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE xhb_sh_judge WHERE sh_attendee_id IN
		 (SELECT sh_attendee_id FROM xhb_sched_hearing_attendee WHERE scheduled_hearing_id IN
			(SELECT scheduled_hearing_id FROM XHB_SCHEDULED_HEARING
			 WHERE hearing_id IN
				 (SELECT hearing_id FROM xhb_hearing WHERE case_id in
					(SELECT case_id FROM xhb_case WHERE case_id = :1))))';
    ...
    l_delete := REPLACE (l_delete,'xhb','aud');
    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    l_error_point := 'DELETE CASE 17.2 ';

    -- 14.3 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE xhb_sched_hearing_attendee WHERE scheduled_hearing_id IN
		 (SELECT scheduled_hearing_id FROM XHB_SCHEDULED_HEARING
		  WHERE hearing_id IN
			 (SELECT hearing_id FROM xhb_hearing WHERE case_id in
				(SELECT case_id FROM xhb_case WHERE case_id = :1)))';
    ...
    l_delete := REPLACE (l_delete,'xhb','aud');
    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    l_error_point := 'DELETE CASE 17.3 ';

    -- 14.4 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE xhb_sh_leg_rep WHERE scheduled_hearing_id IN
		 (SELECT scheduled_hearing_id FROM XHB_SCHEDULED_HEARING
		  WHERE hearing_id IN
			 (SELECT hearing_id FROM xhb_hearing WHERE case_id in
				(SELECT case_id FROM xhb_case WHERE case_id = :1)))';
    ...
    l_delete := REPLACE (l_delete,'xhb','aud');
    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    l_error_point := 'DELETE CASE 17.4 ';

    -- 14.5 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE XHB_SCHEDULED_HEARING
		  WHERE hearing_id IN
			 (SELECT hearing_id FROM xhb_hearing WHERE case_id in
				(SELECT case_id FROM xhb_case WHERE case_id = :1))';
    ...
    l_delete := REPLACE (l_delete,'xhb','aud');
    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    l_error_point := 'DELETE CASE 17.5 ';

    -- 14.6 - Modified for defects 6723/6724 XHIBIT release 8.5.1 Summer 2012
    l_delete := 'DELETE xhb_hearing WHERE case_id in
			(SELECT case_id FROM xhb_case WHERE case_id = :1)';
    ...
    l_delete := REPLACE (l_delete,'xhb','aud');
    EXECUTE IMMEDIATE l_delete USING l_case_history.case_id;
    l_error_point := 'DELETE CASE 17.6 ';
