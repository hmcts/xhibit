/*
 * Filename:    DB_Patch_6.1.2_Prod.sql
 *
...
ALTER TABLE XHB_HEARING
      DROP CONSTRAINT HEARING_LAST_CALC_DURATION_CHK;
...
UPDATE XHB_VERSION SET schema_version = '6.1.2', last_update_date = SYSDATE, updated_by = 'RELEASE' WHERE SCHEMA_NAME = 'XHIBIT';
UPDATE XHB_VERSION SET schema_version = '6.1.2', last_update_date = SYSDATE, updated_by = 'RELEASE' WHERE SCHEMA_NAME = 'JAVA';
UPDATE XHB_VERSION SET schema_version = '6.1.2', last_update_date = SYSDATE, updated_by = 'RELEASE' WHERE SCHEMA_NAME = 'MERCATOR';
