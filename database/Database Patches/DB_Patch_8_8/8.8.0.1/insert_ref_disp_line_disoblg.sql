create or replace PROCEDURE insert_ref_disp_line_disoblg(p_court_id IN xhb_court.court_id%TYPE) AS
...
/**
 ...
 AND rdl.disposal_code IN ('DISOBLG')
...
;
   ...
   LOOP
    ...
    FOR codes_r IN codes_c (courts_r.court_id)
     LOOP
	  ...
	  IF codes_r.dil_seq_no = 120 THEN v_120_code := codes_r.dil_seq_no; END IF;
	  IF codes_r.dil_seq_no = 140 THEN v_140_code := codes_r.dil_seq_no; END IF;
	  IF codes_r.dil_seq_no = 160 THEN v_160_code := codes_r.dil_seq_no; END IF;
	  IF codes_r.dil_seq_no = 180 THEN v_180_code := codes_r.dil_seq_no; END IF;
	  IF codes_r.dil_seq_no = 200 THEN v_200_code := codes_r.dil_seq_no; END IF;
	  IF codes_r.dil_seq_no = 220 THEN v_220_code := codes_r.dil_seq_no; END IF;
	  IF codes_r.dil_seq_no = 240 THEN v_240_code := codes_r.dil_seq_no; END IF;
	  IF codes_r.dil_seq_no = 260 THEN v_260_code := codes_r.dil_seq_no; END IF;
	  IF codes_r.dil_seq_no = 280 THEN v_280_code := codes_r.dil_seq_no; END IF;
	  IF codes_r.dil_seq_no = 300 THEN v_300_code := codes_r.dil_seq_no; END IF;
	  IF codes_r.dil_seq_no = 320 THEN v_320_code := codes_r.dil_seq_no; END IF;
	  IF codes_r.dil_seq_no = 340 THEN v_340_code := codes_r.dil_seq_no; END IF;
	  IF codes_r.dil_seq_no = 360 THEN v_360_code := codes_r.dil_seq_no; END IF;
	  IF codes_r.dil_seq_no = 380 THEN v_380_code := codes_r.dil_seq_no; END IF;
	  IF codes_r.dil_seq_no = 400 THEN v_400_code := codes_r.dil_seq_no; END IF;
	  IF codes_r.dil_seq_no = 420 THEN v_420_code := codes_r.dil_seq_no; END IF;
     END LOOP; --codes_r
 ...
 END insert_ref_disp_line_disoblg;
/