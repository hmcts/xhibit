create or replace PROCEDURE insert_ref_disp_line_disdisc(p_court_id IN xhb_court.court_id%TYPE) AS
...
/**
 ...
 AND rdl.disposal_code IN ('DISDISC')
...
;
 ...
 END insert_ref_disp_line_disdisc;
/