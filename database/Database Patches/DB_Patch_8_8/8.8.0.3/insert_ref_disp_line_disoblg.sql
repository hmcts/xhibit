create or replace PROCEDURE insert_ref_disp_line_disoblg(
...
AS
  ...
  **/
  ...
  v_130_code xhb_ref_disposal_line.dil_seq_no%TYPE DEFAULT NULL;
  v_140_code xhb_ref_disposal_line.dil_seq_no%TYPE DEFAULT NULL;
  v_150_code xhb_ref_disposal_line.dil_seq_no%TYPE DEFAULT NULL;
  ...
  IS
    ...
    AND rdl.dil_seq_no       IN (20,40,60,80,100,120,130,140,150,160,180,200,220,240,260,280,300,320,340,360,380,400,420)
...
BEGIN
  ...
  IF p_court_id IS NULL THEN
    ...
    LOOP
      ...
      LOOP
        --If the code exists for courts_r.court_id then set the value so that they are not null in the INSERT section so wont go in again
        ...
        END IF;
        IF codes_r.dil_seq_no = 130 THEN
          v_130_code         := codes_r.dil_seq_no;
        END IF;
        IF codes_r.dil_seq_no = 140 THEN
          v_140_code         := codes_r.dil_seq_no;
        END IF;
        IF codes_r.dil_seq_no = 150 THEN
          v_150_code         := codes_r.dil_seq_no;
        END IF;
