/*
 * Filename:    DB_Patch_7_6_XHIBIT.sql
 *
 ...
 * 26/10/05	CR	Version 2	Added changes up for XHB_CASE_REFRESH_RESYNCH and trigger. 
 * 28/10/05	CR	Version 3	Added reference to duplicate data cleansing script requirement. 
 */ 
...
PROMPT ************************************************************************
PROMPT ****	If you are running this script on a database created from  **** 
PROMPT ****	Production data, please ensure you have run the duplicate  ****	
PROMPT ****	defendant data cleansing script. If not, the create index  ****
PROMPT ****	statement below will fail. Run the data cleansing script   ****
PROMPT ****	then re-run just the create index statement if needed.     ****
PROMPT ************************************************************************
