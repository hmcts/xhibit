/*
 * Filename:    Xhibit_DB_Patch_8_2_8.sql
 *
 *
 ...
 * ----         ---     ---------       -------
 *  21/01/2009	M HEWITT		Changes for DB release 8.2.8
 *
 */ 
...
alter table XHB_OFFENCE modify FORCE_LOCATION_CODE VARCHAR2(4);
alter table AUD_OFFENCE modify FORCE_LOCATION_CODE VARCHAR2(4);
...
VALUES ( 'JAVACLIENT', '8.2.17', sysdate, 'RELEASE', 'Java Client Application', 1); 

INSERT INTO XHB_VERSION ( SCHEMA_NAME, SCHEMA_VERSION, LAST_UPDATE_DATE, UPDATED_BY, DISPLAY_NAME, DISPLAY_SEQ ) 
VALUES ( 'JAVASERVER', '8.2.17', sysdate, 'RELEASE', 'Java Server Component', 2); 

INSERT INTO XHB_VERSION ( SCHEMA_NAME, SCHEMA_VERSION, LAST_UPDATE_DATE, UPDATED_BY, DISPLAY_NAME, DISPLAY_SEQ ) 
VALUES ( 'XHIBIT', '8.2.8', sysdate , 'RELEASE', 'Database', 3); 
