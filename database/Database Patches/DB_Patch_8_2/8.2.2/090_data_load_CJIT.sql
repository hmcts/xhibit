...
--GN - This script is already run at 8.2 running this again will update the table with wrong data
...
update cji_document_type
set    schema_name = substr(schema_name,1,instr(schema_name,'v5-0')-1)||'v5-0.xsd'
