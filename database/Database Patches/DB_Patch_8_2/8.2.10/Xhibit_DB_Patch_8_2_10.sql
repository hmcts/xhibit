/*
 * Filename:    Xhibit_DB_Patch_8_2_10.sql
 *
 *
 ...
 * ----         ---     ---------       -------
 *  03/03/2009	M HEWITT		Changes for DB release 8.2.10
 *
 */ 
...
column filename new_value spool_filename
  select 'Xhibit_DB_Patch_8_2_10_'||
...
VALUES ( 'JAVACLIENT', '8.2.19', sysdate, 'RELEASE', 'Java Client Application', 1); 

INSERT INTO XHB_VERSION ( SCHEMA_NAME, SCHEMA_VERSION, LAST_UPDATE_DATE, UPDATED_BY, DISPLAY_NAME, DISPLAY_SEQ ) 
VALUES ( 'JAVASERVER', '8.2.19', sysdate, 'RELEASE', 'Java Server Component', 2); 

INSERT INTO XHB_VERSION ( SCHEMA_NAME, SCHEMA_VERSION, LAST_UPDATE_DATE, UPDATED_BY, DISPLAY_NAME, DISPLAY_SEQ ) 
VALUES ( 'XHIBIT', '8.2.10', sysdate , 'RELEASE', 'Database', 3); 
