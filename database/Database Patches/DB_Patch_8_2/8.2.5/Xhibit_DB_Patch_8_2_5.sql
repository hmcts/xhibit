/*
 * Filename:    Xhibit_DB_Patch_8_2_5.sql
 *
 *
 ...
 * ----         ---     ---------       -------
 *  15/12/2008	M HEWITT		Changes for DB release 8.2.5
...
VALUES ( 'JAVACLIENT', '8.2.14', sysdate, 'RELEASE', 'Java Client Application', 1); 

INSERT INTO XHB_VERSION ( SCHEMA_NAME, SCHEMA_VERSION, LAST_UPDATE_DATE, UPDATED_BY, DISPLAY_NAME, DISPLAY_SEQ ) 
VALUES ( 'JAVASERVER', '8.2.14', sysdate, 'RELEASE', 'Java Server Component', 2); 

INSERT INTO XHB_VERSION ( SCHEMA_NAME, SCHEMA_VERSION, LAST_UPDATE_DATE, UPDATED_BY, DISPLAY_NAME, DISPLAY_SEQ ) 
VALUES ( 'XHIBIT', '8.2.5', sysdate , 'RELEASE', 'Database', 3); 
