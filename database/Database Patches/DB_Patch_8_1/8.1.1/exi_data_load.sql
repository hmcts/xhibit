...
/*  Wiki No 2 Changes for 8.1.1 */

UPDATE EXI_PROPERTY SET DECODE_PROPERTY=3 WHERE property_code = 'BULK COUNT';

COMMIT;


/*  Wiki No 4 Changes for 8.1.1 */

UPDATE EXI_JMS_PROPERTY SET value = 'Production' WHERE name='XHBRequestingSystemEnvironment';
UPDATE EXI_JMS_PROPERTY SET value = 'Production' WHERE name='XHBOriginatingSystemEnvironment';
