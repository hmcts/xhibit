...
prompt
prompt This report shows daily counts of tracking status codes between 2 dates
prompt Note:
...
ttitle center 'Status Counts'          skip 2 -
left 'Start Date: ' &p_start_date      skip 1 -
left '  End Date: ' &p_end_date        skip 2;

exec gdg_application_support_pkg.get_status_counts(:results_out, '&p_start_date', '&p_end_date');
