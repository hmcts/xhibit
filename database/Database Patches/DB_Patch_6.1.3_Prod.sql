/*
 * Filename:    DB_Patch_6.1.3_Prod.sql
 *
...
UPDATE XHB_VERSION SET schema_version = '6.1.3', last_update_date = SYSDATE, updated_by = 'RELEASE' WHERE SCHEMA_NAME = 'JAVA';
UPDATE XHB_VERSION SET schema_version = '6.1.3', last_update_date = SYSDATE, updated_by = 'RELEASE' WHERE SCHEMA_NAME = 'MERCATOR';
