...
// * @author pznwc5
// */
//public class TestPublicNoticeHelper extends TransactionTestCase
//{
//    private CourtLogSubscriptionValue subVal;
//
//    public TestPublicNoticeHelper(String name) throws Exception
//    {
//        super(name, true);
//    }
//
...
//
//        XhbCourtLogEntryBasicValue newVal = XhbCourtLogEntryBeanHelper2.create(basicVal);
