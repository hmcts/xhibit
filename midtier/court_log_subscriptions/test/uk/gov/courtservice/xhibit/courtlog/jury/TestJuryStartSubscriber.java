...
//
///**
// * <p>Title: TestJuryStartSubscriber</p>
// * <p>Description: </p>
...
// */
//public class TestJuryStartSubscriber extends TransactionTestCase
//{
...
//            "</event>";
//    private String logEntryJuryRetire01_02 =
//            "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
//            "<event xmlns:xsi=''http://www.w3.org/2001/XMLSchema-instance'' xsi:noNamespaceSchemaLocation=''" +
//            JURY_RETIRES_EVENT + ".xsd''>" +
//            "<free_text>Freetext for JuryRetire caseID:1, sequence number:2</freetext>" +
...
//            "<free_text>Freetext for JuryReturn caseID:1, sequence number:1. Jury out for 5 hours 30 minutes</freetext>" +
//            "<type>" + JURY_RETURNS_EVENT + "</type>" +
//            "<E20913_Jury_Returns_Options><E20913_JTO_Type>E20913_Other</E20913_JTO_Type></E20913_Jury_Returns_Options>" +
//            "<E20913_Jury_Out_Time_Hours>5</E20913_Jury_Out_Time_Hours>" +
//            "<E20913_Jury_Out_Time_Minutes>30</E20913_Jury_Out_Time_Minutes>" +
//            "</event>";
//    private String logEntryJuryReturn02_01 =
//            "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
//            "<event xmlns:xsi=''http://www.w3.org/2001/XMLSchema-instance'' xsi:noNamespaceSchemaLocation=''" +
//            JURY_RETURNS_EVENT + ".xsd''>" +
//            "<free_text>Freetext for JuryReturn caseID:2, sequence number:1. Jury out for 3 hours 20 minutes</freetext>" +
//            "<type>" + JURY_RETURNS_EVENT + "</type>" +
//            "<E20913_Jury_Returns_Options><E20913_JTO_Type>E20913_Other</E20913_JTO_Type></E20913_Jury_Returns_Options>" +
//            "<E20913_Jury_Out_Time_Hours>3</E20913_Jury_Out_Time_Hours>" +
//            "<E20913_Jury_Out_Time_Minutes>20</E20913_Jury_Out_Time_Minutes>" +
//            "</event>";
//    private String logEntryJuryReturn03_01 =
//            "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
//            "<event xmlns:xsi=''http://www.w3.org/2001/XMLSchema-instance'' xsi:noNamespaceSchemaLocation=''" +
//            JURY_RETURNS_EVENT + ".xsd''>" +
//            "<free_text>Freetext for JuryReturn caseID:2, sequence number:1. Jury out for 1 hours 12 minutes</freetext>" +
//            "<type>" + JURY_RETURNS_EVENT + "</type>" +
//            "<E20913_Jury_Returns_Options><E20913_JTO_Type>E20913_Other</E20913_JTO_Type></E20913_Jury_Returns_Options>" +
//            "<E20913_Jury_Out_Time_Hours>1</E20913_Jury_Out_Time_Hours>" +
//            "<E20913_Jury_Out_Time_Minutes>12</E20913_Jury_Out_Time_Minutes>" +
//            "</event>";
//
//    public TestJuryStartSubscriber( String name )
...
//                           "(SELECT event_desc_id FROM XHB_COURT_LOG_EVENT_DESC WHERE " +
//                           "event_type = '" + JURY_RETIRES_EVENT +"'), " +
//                           "'" + logEntryJuryRetire01_02 + "')" );
//        stmt.executeQuery( "INSERT INTO XHB_COURT_LOG_ENTRY " +
//                           "(CASE_ID, DATE_TIME, EVENT_DESC_ID, LOG_ENTRY_XML) " +
//                           "VALUES (" + CASE_ID_1 + ", to_date('01-MAY-2004 1530','DD-MON-YYYY HH24MI'), " +
//                           "(SELECT event_desc_id FROM XHB_COURT_LOG_EVENT_DESC WHERE " +
...
//        stmt.executeQuery( "INSERT INTO XHB_COURT_LOG_ENTRY " +
//                           "(CASE_ID, DATE_TIME, EVENT_DESC_ID, LOG_ENTRY_XML) " +
//                           "VALUES (" + CASE_ID_2 + ", to_date('01-MAY-2004 1730','DD-MON-YYYY HH24MI'), " +
//                           "(SELECT event_desc_id FROM XHB_COURT_LOG_EVENT_DESC WHERE " +
//                           "event_type = '" + JURY_RETURNS_EVENT +"'), " +
...
//        stmt.executeQuery( "INSERT INTO XHB_COURT_LOG_ENTRY " +
//                           "(CASE_ID, DATE_TIME, EVENT_DESC_ID, LOG_ENTRY_XML) " +
//                           "VALUES (" + CASE_ID_3 + ", to_date('01-MAY-2004 1200','DD-MON-YYYY HH24MI'), " +
//                           "(SELECT event_desc_id FROM XHB_COURT_LOG_EVENT_DESC WHERE " +
//                           "event_type = '" + JURY_RETIRES_EVENT +"'), " +
//                           "'" + logEntryJuryRetire03_01 + "')" );
//        stmt.executeQuery( "INSERT INTO XHB_COURT_LOG_ENTRY " +
//                           "(CASE_ID, DATE_TIME, EVENT_DESC_ID, LOG_ENTRY_XML) " +
//                           "VALUES (" + CASE_ID_3 + ", to_date('01-MAY-2004 1730','DD-MON-YYYY HH24MI'), " +
//                           "(SELECT event_desc_id FROM XHB_COURT_LOG_EVENT_DESC WHERE " +
//                           "event_type = '" + JURY_RETURNS_EVENT +"'), " +
//                           "'" + logEntryJuryReturn03_01 + "')" );
//    }
//
//    /**
//     * Test the postCreate processing when there is a prior jury returns event.
//     */
...
//
//        assertTrue( "Jury Out Time Hours prior to test should be 5!",    hours   == 5 );
//        assertTrue( "Jury Out Time Minutes prior to test should be 30!", minutes == 30 );
//
...
//        minutes = Integer.parseInt( getValueFromXml( cle.getLogEntryXml( ), "E20913_Jury_Out_Time_Minutes" ) );
//
//        assertTrue( "Jury Out Time Hours after to test should be 3!",    hours   == 3 );
...
//        minutes = Integer.parseInt( getValueFromXml( cle.getLogEntryXml( ), "E20913_Jury_Out_Time_Minutes" ) );
//
//        assertTrue( "Jury Out Time Hours prior to test should be 3!",    hours   == 3 );
...
//        minutes = Integer.parseInt( getValueFromXml( cle.getLogEntryXml( ), "E20913_Jury_Out_Time_Minutes" ) );
//
//        assertTrue( "Jury Out Time Hours after to test should be 5!",    hours   == 5 );
//        assertTrue( "Jury Out Time Minutes after to test should be 30!", minutes == 30 );
//
...
//        assertTrue( "Jury Out Time Minutes prior to test should be 12!", minutes == 12 );
//
//        CourtLogCRUDValue crudValue = buildCRUDValue(
//            CASE_ID_3,
//            JURY_RETIRES_EVENT,
