...
/**
 * <p>
 * Title: TrialWitnessReadCjseEventLevelPopulator
 * </p>
 * <p>
 ...
 * 
 * @author Sarah Tong
 * @version $Id: TrialWitnessReadCjseEventLevelPopulator.java,v 1.1 2004/04/20
 *          14:40:56 pznwc5 Exp $
 * @see DefendantCjseEventLevelPopulator
 * @see CaseCjseEventLevelPopulator
 */

public class TrialWitnessReadCjseEventLevelPopulator implements CjseEventLevelPopulator {
    private static final Logger log = CSServices.getLogger(TrialWitnessReadCjseEventLevelPopulator.class);

    // The key to the XPath in the properties file for the element which
    // determines
    // which event level to use
    private static final String TWR_LEVEL_DIFFERENTIATOR_XPATH_KEY = "twrLevelDifferentiator";

    private static final String DEFENDANT_LEVEL_VALUE = "twrDefendantLevel";
     ...
     */
    public TrialWitnessReadCjseEventLevelPopulator() {
        messageElementProperties = CSServices.getConfigServices().getProperties("cjse.event");
        xpath = messageElementProperties.getProperty(TWR_LEVEL_DIFFERENTIATOR_XPATH_KEY);
    }
