...
/**
 * <p>
 * Title: AppealWitnessSwornCjseEventLevelPopulator
 * </p>
 * <p>
 ...
 * 
 * @author Sarah Tong
 * @version $Id: AppealWitnessSwornCjseEventLevelPopulator.java,v 1.1 2004/04/20
 *          14:40:54 pznwc5 Exp $
 * @see DefendantCjseEventLevelPopulator
 * @see CaseCjseEventLevelPopulator
 */

public class AppealWitnessSwornCjseEventLevelPopulator implements CjseEventLevelPopulator {
    private static final Logger log = CSServices.getLogger(AppealWitnessSwornCjseEventLevelPopulator.class);

    // The key to the XPath in the properties file for the element which
    // determines
    // which event level to use
    private static final String AWS_LEVEL_DIFFERENTIATOR_XPATH_KEY = "awsLevelDifferentiator";

    private static final String DEFENDANT_LEVEL_VALUE = "awsDefendantLevel";
     ...
     */
    public AppealWitnessSwornCjseEventLevelPopulator() {
        messageElementProperties = CSServices.getConfigServices().getProperties("cjse.event");
        xpath = messageElementProperties.getProperty(AWS_LEVEL_DIFFERENTIATOR_XPATH_KEY);
    }
