...
/**
 * <p>
 * Title: PleaCjseEventLevelPopulator
 * </p>
 * <p>
 * Description: Delegates to the DefendantCjseEventLevelPopulator or
 * CrnCjseEventLevelPopulator depending on the sub event type. This is a
 * 'special case' class where an xhibit event maps to many cjse events with
 * different levels. Currently 4 of these special case populators have been
 * identified (AppealWitnesSworn, AppealWitnesSworn and LongAdjourn as well as
 * this) - if further special case events are identified we should look at
 * incorporating this behaviour into the framework.
 * </p>
 * <p>
 ...
 * 
 * @author Sarah Tong
 * @version $Id: PleaCjseEventLevelPopulator.java,v 1.1 2004/04/20 14:40:56
 *          pznwc5 Exp $
 * @see DefendantCjseEventLevelPopulator
 * @see CrnCjseEventLevelPopulator
 */

public class PleaCjseEventLevelPopulator implements CjseEventLevelPopulator {
    private static final Logger log = CSServices.getLogger(PleaCjseEventLevelPopulator.class);

    // The key to the XPath in the properties file for the element which
    // determines
    // which event level to use
    private static final String TWS_LEVEL_DIFFERENTIATOR_XPATH_KEY = "pleaLevelDifferentiator";

    private static final String DEFENDANT_LEVEL_VALUE_1 = "pleaDefendantLevel1";

    private static final String DEFENDANT_LEVEL_VALUE_2 = "pleaDefendantLevel2";
     ...
     */
    public PleaCjseEventLevelPopulator() {
    ...
    public EventLevelAndIdentifier populate(EventParameters eventParameters, XhbCase theCase,
        ...
        if (differentiatorValue.equals(messageElementProperties.getProperty(DEFENDANT_LEVEL_VALUE_1))
                || differentiatorValue.equals(messageElementProperties.getProperty(DEFENDANT_LEVEL_VALUE_2))) {
