...
import uk.gov.courtservice.xhibit.courtlog.cjse.CjseClHelper;
...
public class CjseEventMapperHandlerFactory {
    /**
     ...
     */
    public static final String PROPERTIES_FILE_NAME = "cjse.event.mapping";
     ...
     * 
     * @see CjseClHelper.CONFIG_FILE_KEY
     */
    public static final String EVENT_LEVEL_KEY_PREFIX = "define.mapping.";

    // The currently defined event mapper handlers.
    private HashMap _cjseEventMapperHandlers = new HashMap();

    // The singleton instance that will be used.
    private static CjseEventMapperHandlerFactory _instance = new CjseEventMapperHandlerFactory();

    /**
     * Get an instance of the CjseEventMapperHandlerFactory.
     * 
     * @return an instance of the CjseEventMapperHandlerFactory.
     */
    public static CjseEventMapperHandlerFactory getInstance() {
        return _instance;
    }
     ...
     * the defined CjseEventMapperHandler.
     */
    private CjseEventMapperHandlerFactory() {
