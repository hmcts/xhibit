...
/**
 * <p>
 * Title: Switching ContentHandler for CJSE event population configuration
 * </p>
 * <p>
 * Description:
 * </p>
 ...
 * @version 1.0
 */
public class CjseSwitchHandler extends DefaultHandler {
     ...
     *            event id
     */
    public CjseSwitchHandler(HashMap eventPopulators) {
    ...
    private void initialisePopulator(String level, String type, String xhibitEventId, String doNotSendToCjse)
        ...
        _currentCjsePopulator.setLevelPopulator(CjseEventLevelPopulatorFactory.getInstance()
                .getCjseEventLevelPopulator(level));

        // Set up the event mapper handler.
        _currentEventMapperHandler = CjseEventMapperHandlerFactory.getInstance().getCjseEventMapperHandler(type);
