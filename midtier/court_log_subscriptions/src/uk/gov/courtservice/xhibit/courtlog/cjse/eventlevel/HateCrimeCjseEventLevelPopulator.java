 ...
 *              defendant/appellant and hate crime reasons assigned to them. 
 * @author davieskl
 * @version 1.0
 */
public class HateCrimeCjseEventLevelPopulator implements CjseEventLevelPopulator{

    private static final Logger log = CSServices.getLogger(HateCrimeCjseEventLevelPopulator.class);
    ...
    public EventLevelAndIdentifier populate(EventParameters eventParameters, XhbCase theCase, CourtLogSubscriptionValue eventInfo) {
        ...
        HateCrimePopulatorHelper hateCrimeHelper = new HateCrimePopulatorHelper();
        
        //eventParameters.setHateCrimeReasons(hateCrimeHelper.getHateCrimeReasons(hateSentencing));
