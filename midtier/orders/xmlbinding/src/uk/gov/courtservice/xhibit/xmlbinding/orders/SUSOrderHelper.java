 ...
 * the SuspendedSentenceOrderStructure
 * </p>
 * <p/> Description:
 * </p>
 * <p/> Populates the SuspendedSentenceOrderStructure for 'new Suspended Sentence order'.
 * </p>
 * <p>
...
//
public class SUSOrderHelper {
    // set up logger
    private static final Logger log = CSServices.getLogger(SUSOrderHelper.class);

    /**
     * Utility method to populate an SuspendedSentenceOrderStructure from the rest
     * of the Xhibit entities.
     * 
     * @param ssos
     *            The SuspendedSentenceOrderStructure to be populated (pass by
     *            reference).
     * @param docEntity
    ...
    public static void populateSuspendedSentenceOrder(SuspendedSentenceOrderStructure ssos, DefendantOnCase docEntity)
            throws OrderXMLException {
        populateCaseDetails(ssos, docEntity);
    }

    /**
     * Populate the Suspended Sentence order structure with all relevant case details
     * 
     * @param ssos
     *            the Suspended Sentence order structure
     * @param docEntity
     ...
     * @throws OrderXMLException
     */
    private static void populateCaseDetails(SuspendedSentenceOrderStructure ssos, DefendantOnCase docEntity)
            throws OrderXMLException {
        populateWarningType(ssos, docEntity);
    }

    private static void populateWarningType(SuspendedSentenceOrderStructure soss, DefendantOnCase docEntity) {
        ...
        if (defDOB != null) {
            ...
            soss.setWarningDetentionType((age >= 21) ? DetentionTypeType.IMPRISONMENT : DetentionTypeType.DETENTION);
        } else {
