...
//import uk.gov.courtservice.xhibit.xmlbinding.orders.CPRXmlHelper;
...
///**
// * <p>
// * Title: Test case for testing CPRXmlHelper
// * </p>
// * <p>
// * Description: This test case uses the XmlHelperFactory and XmlHelpers to
// * generate and validate prepopulated XML for a CPR order.
// * </p>
...
// * @version 1.0
// */
//public class TestCPRXmlHelper extends TransactionTestCase
//{
//    private XmlHelperFactory factory;
//    private Schema schema;
//    private static Logger log = CSServices.getLogger(TestXMLHelpers.class);
//    private CPRXmlHelper CPRHelper;
//    private String CPROrder;
//    private String CPRXml;
...
//     */
//    public TestCPRXmlHelper(String s) throws NamingException
//    {
//        super(s, true);
//    }
//
...
//
//        this.CPRXml = factory.getDataXmlForOrder(new Integer(1), "CMPRO");
//        this.CPRHelper = new CPRXmlHelper("CMPRO");
//        //populate with data and get order
//        this.CPROrder = CPRHelper.getOrderXML(new Integer(1));
//        this.dom = new DomConvertor(CPROrder);
//    }
//
//    /**
//     * Tear down objects.
...
//    {
//        Assert.assertNotNull("Could not obtain an empty schema.", this.CPRXml);
//
//        Assert.assertTrue("Empty schema is not valid.", CPRXml.length() > 0);
//
//        Assert.assertNotNull("Could not obtain a imprisonment helper.", CPRHelper);
//
//        Assert.assertNotNull("Could not obtain a populated imprisonment order.", CPROrder);
//
//    }
//
//    /**
...
//
//		Object o = dom.getValue("ord:Order/ord:OrderData/ord:CPROrder/ord:OrderHeader/ord:CourtHouse/ord:CourtHouseType");
...
//
//		try{
//			format.parse(dom.getValue("ord:Order/ord:OrderData/ord:CPROrder/ord:OrderHeader/ord:OrderDate").toString());
...
//    {
//        String typeElement = dom.getValue("ord:Order/ord:OrderData/ord:CPROrder/ord:OrderHeader/ord:OrderType").toString();
//        Assert.assertNotNull("Order type was not set", typeElement);
//
//        //Order Type code for a CPR Order is "CMPRO"
//        Assert.assertEquals("OrderType is not set to the correct " +
//                            "code for CPR Order", typeElement, "CMPRO");
//    }
//}
//