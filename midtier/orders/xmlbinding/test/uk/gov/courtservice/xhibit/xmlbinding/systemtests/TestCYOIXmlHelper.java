...
////import uk.gov.courtservice.xhibit.xmlbinding.orders.CYOIXmlHelper;
...
/////**
//// * <p>
//// * Title: Test case for testing CYOIXmlHelper
//// * </p>
//// * <p>
//// * Description: This test case uses the XmlHelperFactory and XmlHelpers to
//// * generate and validate prepopulated XML for a CYOI order.
//// * </p>
...
//// * @version 1.0
//// */
////public class TestCYOIXmlHelper extends TransactionTestCase
////{
////    private XmlHelperFactory factory;
////    private Schema schema;
////    private static Logger log = CSServices.getLogger(TestXMLHelpers.class);
////    private CYOIXmlHelper CYOIHelper;
////    private String CYOIOrder;
////    private String CYOIXml;
...
////     */
////    public TestCYOIXmlHelper(String s) throws NamingException
////    {
////        super(s, true);
////    }
////
...
////
////        this.CYOIXml = factory.getDataXmlForOrder(new Integer(1), "COMY");
////        this.CYOIHelper = new CYOIXmlHelper("COMY");
////
////        //populate with data and get order
////        this.CYOIOrder = CYOIHelper.getOrderXML(new Integer(1));
////        this.dom = new DomConvertor(CYOIOrder);
////    }
////
////    /**
////     * Tear down objects.
...
////    {
////        Assert.assertNotNull("Could not obtain an empty schema.", this.CYOIXml);
////
////        Assert.assertTrue("Empty schema is not valid.", CYOIXml.length() > 0);
////
////        Assert.assertNotNull("Could not obtain a imprisonment helper.", CYOIHelper);
////
////        Assert.assertNotNull("Could not obtain a populated imprisonment order.", CYOIOrder);
////
////    }
////
////     /**
...
////
////        Object o = dom.getValue("ord:Order/ord:OrderData/ord:YOIOrder/ord:OrderHeader/ord:CourtHouse/ord:CourtHouseType");
...
////
////        try{
////            format.parse(dom.getValue("ord:Order/ord:OrderData/ord:YOIOrder/ord:OrderHeader/ord:OrderDate").toString());
...
////    {
////        String typeElement = dom.getValue("ord:Order/ord:OrderData/ord:YOIOrder/ord:OrderHeader/ord:OrderType").toString();
////        Assert.assertNotNull("Order type was not set", typeElement);
////
////        //Order Type code for a CYOI Order is "COMY"
////        Assert.assertEquals("OrderType was not set to the correct " +
////                            "code for CYOI Order", "COMY", typeElement);
////    }
////
////}
////