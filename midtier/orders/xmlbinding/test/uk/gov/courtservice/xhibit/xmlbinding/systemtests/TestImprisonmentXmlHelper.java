...
//import uk.gov.courtservice.xhibit.xmlbinding.orders.ImprisonmentXmlHelper;
...
///**
// * <p>
// * Title: Test case for testing ImprisonmentXmlHelper
// * </p>
// * <p>
// * Description: This test case uses the XmlHelperFactory and XmlHelpers to
// * generate and validate prepopulated XML for an Imprisonment Order.
// * </p>
...
// * @version 1.0
// */
//public class TestImprisonmentXmlHelper extends TransactionTestCase
//{
//    private XmlHelperFactory factory;
//    private Schema schema;
//    private static Logger log = CSServices.getLogger(TestXMLHelpers.class);
//    private ImprisonmentXmlHelper imprisonmentHelper;
//    private DomConvertor dom;
//    private String imprisonmentOrder;
//    private String imprisonmentXml;
...
//     */
//    public TestImprisonmentXmlHelper(String s) throws NamingException
//    {
//        super(s, true);
//    }
//
...
//     * from produced Imprisonment Order.
//     */
...
//        this.imprisonmentXml = factory.getDataXmlForOrder(new Integer(1), "IMPO");
//        this.imprisonmentHelper = new ImprisonmentXmlHelper("IMPO");
//
//        //populate with data and get order
//        this.imprisonmentOrder = imprisonmentHelper.getOrderXML(new Integer(1));
//        this.dom = new DomConvertor(imprisonmentOrder);
//    }
//
//    /**
//     * Tear down objects.
...
//    {
//        Assert.assertNotNull("Could not obtain an empty schema.", this.imprisonmentXml);
//
//        Assert.assertTrue("Empty schema is not valid.", imprisonmentXml.length() > 0);
//
//        Assert.assertNotNull("Could not obtain a imprisonment helper.", imprisonmentHelper);
//
//        Assert.assertNotNull("Could not obtain a populated imprisonment order.", imprisonmentOrder);
//
//    }
//
//    /**
...
//
//		Object o = dom.getValue("ord:Order/ord:OrderData/ord:ImprisonmentOrder/ord:OrderHeader/ord:CourtHouse/ord:CourtHouseType");
...
//
//		try{
//			format.parse(dom.getValue("ord:Order/ord:OrderData/ord:ImprisonmentOrder/ord:OrderHeader/ord:OrderDate").toString());
...
//    {
//        String typeElement = dom.getValue("ord:Order/ord:OrderData/ord:ImprisonmentOrder/ord:OrderHeader/ord:OrderType").toString();
//        Assert.assertNotNull("Order type was not set", typeElement);
//
//        //Order Type code for a Imprisonment Order is "IMPO"
//        Assert.assertEquals("OrderType is not set to the correct " +
//                            "code for Imprisonment Order", typeElement, "IMPO");
//    }
//
//}
//