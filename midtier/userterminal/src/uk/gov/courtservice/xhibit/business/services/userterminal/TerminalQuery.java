 ...
 * 
 * @author unascribed
 * @version $Id: TerminalQuery.java,v 1.5 2011/01/24 14:59:30 simmonsi Exp $
 */

public class TerminalQuery extends QueryOperation {

    private static final Logger log = CSServices.getLogger(TerminalQuery.class);
    ...
    public TerminalQuery(String courtId) {
