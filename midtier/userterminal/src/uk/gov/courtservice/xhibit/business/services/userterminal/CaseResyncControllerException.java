...
public class CaseResyncControllerException extends CSBusinessException {
	
	static final long serialVersionUID = 7279397478262257159L;
     ...
     */
    public CaseResyncControllerException(String errorKey, String logMessage, Throwable cause) {
     ...
     *            original exception caught
     */
    public CaseResyncControllerException(String errorKey, Object[] parameters, String logMessage,
            Throwable cause) {
     ...
     */
    public CaseResyncControllerException(String errorKey, String logMessage) {
