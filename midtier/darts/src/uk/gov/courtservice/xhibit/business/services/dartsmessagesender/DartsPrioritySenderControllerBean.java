 ...
 * 
 * @ejb.bean name="DartsPrioritySender" description="Darts Priority Sender bean" type="Stateless"
 *           view-type="remote" jndi-name="DartsPrioritySenderSessionHome"
 *           local-jndi-name="DartsPrioritySenderSessionLocalHome"
 * @ejb.interface extends="uk.gov.courtservice.framework.scheduler.RemoteTask,javax.ejb.EJBObject"
 * 
 */
public class DartsPrioritySenderControllerBean extends DartsSenderControllerBean implements SessionBean {

    private static final long serialVersionUID = 2L;
    private static final Logger log = CSServices.getLogger(DartsPrioritySenderControllerBean.class);
