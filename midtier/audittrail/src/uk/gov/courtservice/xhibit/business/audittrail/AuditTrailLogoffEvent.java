...
/**
 * <p>
 * Title: AuditTrailLogoffEvent
 * </p>
 * <p>
 * Description: This is the AuditTrailEvent which is used for a "Logoff" event
 * </p>
 * <p>
...
public class AuditTrailLogoffEvent extends AuditTrailEventImpl {
     ...
     * @param evtData
     */
    public AuditTrailLogoffEvent(Object evtData){
        super(AuditTrailEvent.USER_LOGOFF,evtData);
    ...
    public void setUpEventData(){
        ...
        setCaseId(null);
        setEventSpecificData(EventDataHelper.getString(EventDataHelper.SESSION_ID, value.getId().toString(), true));
    }
}
