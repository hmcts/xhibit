...
//
///**
// * <p>Title: Test for the PublicDisplayListener component.</p>
// * <p>Description: </p>
// * <p>
// * This unit test checks that the <code>PublicDisplayListener</code> message driven
// * bean successfully posts a <code>CaseStatusEvent</code> to the PublicDisplay topic
// * for a given input message on the old PublicDisplayNotification topic.
// * </p>
...
// * @version 1.0
// */
//public class TestPublicDisplayListener extends TestCase
//{
//    private static final String INPUT_TOPIC_NAME = "PublicDisplayNotification";
//
...
//     */
//    public TestPublicDisplayListener(String s)
//    {
//        super(s);
//    }
//
...
//
//    /**
//     * Check that a message incoming on the PublicDisplayNotification topic
//     * is successfully turned into a message containing a <code>CaseStatusEvent</code>
...
//                    getMessageValue());
//            inputTopicPublisher.publish(inputMessage,
...
//            assertTrue(
//                    "The message does not contain an instance of CaseStatusEvent.",
//                    outputObjectMessage.getObject() instanceof CaseStatusEvent);
//        }
//        finally
//        {
