 ...
 */
public class AllCaseStatusUnassignedCasesQuery extends PublicDisplayQuery {
    /** The stored procedure to execute */
    private static final String SQL_PROCEDURE = "{ call XHB_PUBLIC_DISPLAY_PKG.GET_ALL_CASE_STATUS_U(?,?,?,?) }";

    /**
     * Constructor compiles the query
     */
    public AllCaseStatusUnassignedCasesQuery() {
        super(SQL_PROCEDURE);
