...
//
///**
// * <p>Title: HearingScheduleControllerBeanHRExportTest</p>
...
// * @version 1.0
// */
//public class HearingScheduleControllerBeanHRExportTest extends TransactionTestCase
//{
//
//    private static Logger log  = CSServices.getLogger(HearingScheduleControllerBeanHRExportTest.class);
//
//
...
//
//    /**
//     * HearingScheduleControllerBeanHRExportTest
//     * @param s
//     */
//    public HearingScheduleControllerBeanHRExportTest(String s) throws NamingException
//    {
//        super(s, true);
//    }
//
...
//            log.debug("=============before ====hearingScheduleController "
//                      + hearingScheduleController.toString());
//            hearingScheduleController.exportHearingRecord(test1, courtClerk);
//            log.debug("==============after===hearingScheduleController "
//                      + hearingScheduleController.toString());
//            assertTrue(true);
...
//            hearingScheduleController.exportHearingRecord(test2, courtClerk);
//            assertTrue(true);
...
//            hearingScheduleController.exportHearingRecord(test3, courtClerk);
//            assertTrue(false);
...
//            hearingScheduleController.exportHearingRecord(test4, courtClerk);
//            assertTrue(false);
...
//            hearingScheduleController.exportHearingRecord(test5, courtClerk);
//            assertTrue(true);
...
//            hearingScheduleController.exportHearingRecord(test6, courtClerk);
//            assertTrue(false);
