...
//import uk.gov.courtservice.xhibit.business.entities.shstaff.ShStaffHome;
//
///**
...
// */
//
//public class ShStaffTest extends TestCase
//{
//
//    private Logger log =  CSServices.getLogger(ShStaffTest.class);
...
//	try
//	{
//	    ShStaffHome home = lookupHome();
//	    log.debug("testFindByPrimaryKey() - Got RefDisposalHome");
//	    ShStaff local = home.findByPrimaryKey(new Integer(1));
//	    log.debug("staffName : " + local.getStaffName());
//	    assertEquals(1, local.getShStaffId().intValue());
//	}
//	catch(Exception e)
//	{
...
//
//
//    private ShStaffHome lookupHome() throws Exception
//    {
//	Context ctx = CSServices.getServiceLocator().getInitialContext();
//	Object home = (ShStaffHome) ctx.lookup("ShStaffHome");
//	return (ShStaffHome) PortableRemoteObject.narrow(home, ShStaffHome.class);
//    }
//}