...
//import uk.gov.courtservice.xhibit.business.entities.shjustice.ShJusticeHome;
//
///**
// * <p>Title: JusticeTest</p>
// * <p>Description: </p>
...
// */
//
//public class ShJusticeTest extends TestCase
//{
//
//    private Logger log =  CSServices.getLogger(ShJusticeTest.class);
...
//
//    public static String refjusSQL = "INSERT INTO XHB_REF_JUSTICE (REF_JUSTICE_ID, LAST_UPDATE_DATE, CREATION_DATE, CREATED_BY, LAST_UPDATED_BY, VERSION) VALUES (1, TO_Date( '11/15/2002 03:38:02 PM', 'MM/DD/YYYY HH:MI:SS AM'),  TO_Date( '11/15/2002 03:38:02 PM', 'MM/DD/YYYY HH:MI:SS AM'),'fez', 'fez', 1)";
//
//    public static String shJusSQl = "INSERT INTO XHB_SH_JUSTICE (SH_JUSTICE_ID, JUSTICE_NAME, VERSION, LAST_UPDATED_BY, CREATED_BY, CREATION_DATE, LAST_UPDATE_DATE) VALUES (1, 'fez', 1, 'pete', 'pete', TO_Date( '11/15/2002 03:38:02 PM', 'MM/DD/YYYY HH:MI:SS AM'),  TO_Date( '11/15/2002 03:38:02 PM', 'MM/DD/YYYY HH:MI:SS AM'))";
//
//    public ShJusticeTest(String s)
//    {
//	super(s);
//    }
//
...
//	TestUtils.execSql(refjusSQL);
//	TestUtils.execSql(shJusSQl);
//
//
//
//    }
...
//	try
//	{
//	    ShJusticeHome home = lookupHome();
//	    log.debug("testFindByPrimaryKey() - Got RefDisposalHome");
//	    ShJustice local = home.findByPrimaryKey(new Integer(1));
//	    log.debug("justiceName : " + local.getJusticeName());
//	    assertEquals(1, local.getShJusticeId().intValue());
//	}
//	catch(Exception e)
//	{
...
//
//
//    private ShJusticeHome lookupHome() throws Exception
//    {
//	Context ctx = CSServices.getServiceLocator().getInitialContext();
//	Object home = (ShJusticeHome) ctx.lookup("ShJusticeHome");
//	return (ShJusticeHome) PortableRemoteObject.narrow(home, ShJusticeHome.class);
//    }
//}