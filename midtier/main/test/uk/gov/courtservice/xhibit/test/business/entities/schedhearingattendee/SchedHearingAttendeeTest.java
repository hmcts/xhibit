...
//
///**
// * <p>Title: ScheduledHearingAttendeeTest</p>
// * <p>Description: </p>
...
//	    log.debug("testFindByPrimaryKey() - Got attendee");
//	    SchedHearingAttendee local = home.findByPrimaryKey(new Integer(1));
//	    log.debug("type : " + local.getAttendeeType());
//	    assertEquals(1, local.getShAttendeeId().intValue());
//
//	    log.debug("Tetsing scheduled hearing CMR");
//	    ScheduledHearing hearing = local.getScheduledHearing();
//	    assertEquals(1, hearing.getHearingId().intValue());
//
///*	    log.debug("Tetsing staff CMR");
//	    ShStaff staff = local.getShStaff();
//	    this.assertEquals(1, staff.getShStaffId().intValue());
//
//	    log.debug("Testing Justice cmr");
//	    ShJustice justice = local.getShJustice();
//	    this.assertEquals(1, justice.getShJusticeId().intValue());
//
//	    log.debug("Testing legRep Cmr");
//	    ShLegRep legRep = local.getShLegRep();
//	    this.assertEquals(1, legRep.getRefLegalRepId().intValue());*/
//
//
//	}
//	catch(Exception e)
