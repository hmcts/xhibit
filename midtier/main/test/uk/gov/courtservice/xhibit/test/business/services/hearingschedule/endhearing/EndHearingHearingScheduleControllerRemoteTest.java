...
///**
// *
// * <p>Title: EndHearingHearingScheduleControllerRemoteTest</p>
// * <p>Description: Remote test for end hearing
// *
...
// * @version 1.0
// */
//public class EndHearingHearingScheduleControllerRemoteTest extends TestCase {
//
...
//
//  private static Logger log  = CSServices.getLogger(EndHearingHearingScheduleControllerRemoteTest.class);
//
...
// /**
//  * EndHearingHearingScheduleControllerRemoteTest
//  * @param s
//  */
//  public EndHearingHearingScheduleControllerRemoteTest(String s) {
//    super(s);
//  }
//
//  /**
...
//    }
//
//    schedHearingIDEndSingleHearing = new Integer(900);//1
//    schedHearingIDEndLinkedHearings = new Integer(902);//3
//    newDuration = new Long(123);
//
...
//
//    try {
//      log.debug("hearingScheduleController.toString() : " + controller.toString());
...
//
//      controller.amendHearingDuration(schedHearingIDEndSingleHearing, newDuration);
...
//      booleanRet2 = controller.isHearingEnded(schedHearingIDEndSingleHearing);
//      log.debug("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
...
////      controller.endSingleHearing(schedHearingIDEndSingleHearing);
//      booleanRet1 = controller.isHearingEnded(schedHearingIDEndSingleHearing);
//      log.debug("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
...
//
//    try {
//      controller.reCalculateHearingDuration(schedHearingIDEndSingleHearing,
//                                            dummyDefOnCaseID);
//      testAssert = new Boolean(true);
//    }
//    catch(Exception e) {
