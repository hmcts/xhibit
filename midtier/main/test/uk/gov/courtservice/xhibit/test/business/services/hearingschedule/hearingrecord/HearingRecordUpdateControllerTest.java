...
//
///**
// * <p>Title: HearingRecordUpdateControllerTest</p>
// * <p>Description: Test the update of the HearingRecord via the local and
// * the remote interface - Controller.</p>
// * <p>Copyright: Copyright (c) 2003</p>
// * <p>Company: Electronic Data Systems</p>
// * @author Marie Holmberg
// * @version 1.0
// */
//public class HearingRecordUpdateControllerTest extends TransactionTestCase
//{
//  private static Logger log  = CSServices.getLogger(HearingRecordUpdateControllerTest.class);
//
//  private HearingScheduleController remoteController =
//        (HearingScheduleController)CSServices.getEJBServices().createLocalSession(
//      HearingScheduleControllerHome.class);
//
//  private HearingScheduleControllerLocal localController =
//          (HearingScheduleControllerLocal)CSServices.getEJBServices().
//                       createRemoteSession(HearingScheduleControllerLocalHome.class);
//
...
//
//  /**
//   * HearingRecordUpdateControllerTest
//   * @param s
//   */
//  public HearingRecordUpdateControllerTest(String s) throws NamingException
//  {
//    super(s, true);
//  }
//
...
//
//  /**
//   * testUpdateHearingRecordLocalController
//   */
////  public void testUpdateHearingRecordLocalController()
////  {
////    log.debug(">>>>>>>>>>>> testUpdateHearingRecordLocalController Starts <<<<<<<<<<<<<");
////    try
////    {
////      localController.updateHearingRecord(updateValue);
////
...
////    finally
////    {
////      log.debug(">>>>>>>>>>>> testUpdateHearingRecordLocalController Ends <<<<<<<<<<<<<,");
////    }
////  }
//
//  /**
//   * testUpdateHearingRecordRemoteController
//   */
//  public void testUpdateHearingRecordRemoteController()
//  {
//    log.debug(">>>>>>>>>>>> testUpdateHearingRecordRemoteController Starts <<<<<<<<<<<<<");
//    try
//    {
//      remoteController.updateHearingRecord(updateValue);
//
//      //if get this far the update was successful else exception thrown and the
//      //test will be a failure.
//      assertTrue(true);
...
//    finally
//    {
//      log.debug(">>>>>>>>>>>> testUpdateHearingRecordRemoteController Ends <<<<<<<<<<<<<,");
//    }
//  }
//}