...
//import uk.gov.courtservice.xhibit.business.entities.defhearingrecord.DefHearingRecordHome;
...
// */
//
//public class DefHearingRecordTest extends TestCase
//{
//
//    private Logger log =  CSServices.getLogger(DefHearingRecordTest.class);
...
//
//    public static String defHearingRecSQL = "INSERT INTO XHB_DEF_HEARING_RECORD (HEARING_RECORD_ID, DEFENDANT_ON_CASE_ID, HEARING_ID, VERSION, LAST_UPDATED_BY, CREATED_BY, CREATION_DATE, LAST_UPDATE_DATE) VALUES (1, 1, 1, 1, 'fez', 'fez', TO_Date( '11/15/2002 03:38:02 PM', 'MM/DD/YYYY HH:MI:SS AM'),  TO_Date( '11/15/2002 03:38:02 PM', 'MM/DD/YYYY HH:MI:SS AM'))";
//
//    public DefHearingRecordTest(String s)
//    {
//	super(s);
//    }
//
...
//
//	log.debug("Insert defhearing record");
...
//	TestUtils.execSql(defHearingRecSQL);
//
//
//
//    }
...
//	try
//	{
//	    DefHearingRecordHome home = lookupHome();
//	    log.debug("testFindByPrimaryKey() - Got RefDisposalHome.");
//	    DefHearingRecord local = home.findByPrimaryKey(new Integer(1));
//	    log.debug("hearingID : " + local.getHearingId());
//	    assertEquals(1, local.getDefendantOnCaseId().intValue());
//
//	    log.debug("testing CMR");
//	    Hearing hear = local.getHearing();
//	    assertEquals(1, hear.getCaseId().intValue());
//	}
//	catch(Exception e)
//	{
...
//    }
//
//	public void testFindByDefendantOnCaseIDAndHearingID() {
//		try {
//			DefHearingRecordHome home = lookupHome();
//			log.debug("testDefendantOnCaseIDAndHearingID() - Got DefHearingRecordHome");
//			DefHearingRecord local =
//                    home.findByDefendantOnCaseIDAndHearingID(new Integer(1), new Integer(1));
//			log.debug("hearingRecordID : " + local.getHearingRecordId());
//			assertEquals(1, local.getHearingRecordId().intValue());
//		}
//		catch(Exception e) {
...
//	}
//
//    private DefHearingRecordHome lookupHome() throws Exception
//    {
//	Context ctx = CSServices.getServiceLocator().getInitialContext();
//	Object home = (DefHearingRecordHome) ctx.lookup("DefHearingRecordHome");
//	return (DefHearingRecordHome) PortableRemoteObject.narrow(home, DefHearingRecordHome.class);
//    }
//}