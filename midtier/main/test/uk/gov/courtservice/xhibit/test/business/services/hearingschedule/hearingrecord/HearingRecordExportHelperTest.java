...
//import uk.gov.courtservice.xhibit.business.services.hearingschedule.hearingrecord.HearingRecordExportHelper;
//
///**
// * <p>Title: HearingRecordExportHelperTest</p>
...
// * @version 1.0
// */
//public class HearingRecordExportHelperTest extends TransactionTestCase {
//
//  private static Logger log  = CSServices.getLogger(HearingRecordExportHelperTest.class);
//
...
// private String removeAllExportAs = "delete from xhb_exporta where hearing_id >= "+insertSingleHearingInt.intValue()+" and hearing_id < "+removeHrgs.intValue()+" or " +
//                             "linked_hearing_id = 999";
//
// private String removeHearings = "delete from xhb_hearing where hearing_id >= "+insertSingleHearingInt.intValue()+" and hearing_id < "+removeHrgs.intValue();
//
...
//
//  /**
//   * HearingRecordExportHelperTest
//   * @param s
//   */
//  public HearingRecordExportHelperTest(String s) throws NamingException
//  {
//    super(s, true);
//  }
//
...
//
//    HearingRecordExportHelper hearingrecordexporthelper = new HearingRecordExportHelper();
//    try
//    {
...
//      hearingrecordexporthelper.epxortHearingRecord(test1, courtClerk);
...
//      hearingrecordexporthelper.epxortHearingRecord(test2, courtClerk);
//      this.assertTrue(true);
...
//      Collection test3 = new ArrayList();
//      test3.add(singleHearingNotEndedInt);
//      hearingrecordexporthelper.epxortHearingRecord(test3, courtClerk);
...
//      Collection test4 = new ArrayList();
//      test4.add(insertHearingAlreadyExportedInt);
//      hearingrecordexporthelper.epxortHearingRecord(test4, courtClerk);
//      this.assertTrue(false);
...
//      Collection test5 = new ArrayList();
//      test5.add(insertHearingExportFailedInt);
//      hearingrecordexporthelper.epxortHearingRecord(test5, courtClerk);
//      this.assertTrue(true);
...
//      Collection test6 = new ArrayList();
//      test6.add(insertHearingExportInProgressInt);
//      hearingrecordexporthelper.epxortHearingRecord(test6, courtClerk);
//      this.assertTrue(false);
