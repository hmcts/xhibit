...
public class DisposalCountRowProcessor extends AbstractRowProcessor {

    private static final String DISPOSAL_ID = "DISPOSAL2_ID";

    private Vector disposalResult = new Vector();

    private static final Logger log = CSServices.getLogger(DisposalCountRowProcessor.class);
     ...
     * @param courtId
     */
    public DisposalCountRowProcessor() {
    }
