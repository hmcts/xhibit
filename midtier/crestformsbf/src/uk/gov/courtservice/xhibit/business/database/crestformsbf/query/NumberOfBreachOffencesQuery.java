...
/**
 * <p>
 * Title: NumberOfBreachOffencesQuery
 * </p>
 * <p>
 * Description:
 * </p>
...
public class NumberOfBreachOffencesQuery extends QueryOperation {

    // The file that contains the SQL for this query, currently uses two
    // parameters.
    private static final String SQL_FILE = "config/database/query/crestformsbf/NumberOfBreachOffences.sql";
     ...
     */
    public NumberOfBreachOffencesQuery() {
     ...
     */
    public int getNumberOfBreachOffences(Integer caseId, Integer defendantId) {
