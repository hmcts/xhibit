...
/**
 * <p>
 * Title: NumberOfCommittalForSentenceOffencesQuery
 * </p>
 * <p>
 * Description:
 * </p>
...
public class NumberOfCommittalForSentenceOffencesQuery extends QueryOperation {

    // The file that contains the SQL for this query, currently uses two
    // parameters.
    private static final String SQL_FILE = "config/database/query/crestformsbf/NumberOfCommittalForSentenceOffences.sql";
     ...
     */
    public NumberOfCommittalForSentenceOffencesQuery() {
     ...
     */
    public int getNumberOfCommittalForSentenceOffences(Integer caseId, Integer defendantId) {
