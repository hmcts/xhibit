...
public class NumberOfIndictmentCountsQuery extends QueryOperation {

    // The file that contains the SQL for this query, currently uses two
    // parameters.
    private static final String SQL_FILE = "config/database/query/crestformsbf/NumberOfIndictmentCounts.sql";
     ...
     */
    public NumberOfIndictmentCountsQuery() {
     ...
     */
    public int getNumberOfIndictmentCounts(Integer caseId, Integer defendantId) {
