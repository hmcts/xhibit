...
import uk.gov.courtservice.xhibit.business.database.crestformsbf.processor.DefendantOnCaseIdProcessor;

/**
 * <p>
 * Title: DefendantOnCaseIdQuery
 * </p>
 * <p>
 * Description:
 * </p>
...
public class DefendantOnCaseIdQuery extends QueryOperation {

    // The file that contains the SQL for this query, currently uses two
    // parameters.
    private static final String SQL_FILE = "config/database/query/crestformsbf/DefendantOnCaseId.sql";
     ...
     */
    public Integer getDefendantOnCaseId(Integer caseId, Integer defendantId) {
        ...
        // Row processor
        DefendantOnCaseIdProcessor rowProcessor = new DefendantOnCaseIdProcessor();
        ...
        // Return the schedule
        return rowProcessor.getDefendantOnCaseId();
