...
/**
 * <p>
 * Title: NumberOfIndictmentCountsQuery
 * </p>
 * <p>
 * Description:
 * </p>
...
public class NumberOfCriminalAppealOffencesQuery extends QueryOperation {

    // The file that contains the SQL for this query, currently uses two
    // parameters.
    private static final String SQL_FILE = "config/database/query/crestformsbf/NumberOfCriminalAppealOffences.sql";
     ...
     */
    public NumberOfCriminalAppealOffencesQuery() {
     ...
     */
    public int getNumberOfCriminalAppealOffences(Integer caseId, Integer defendantId) {
