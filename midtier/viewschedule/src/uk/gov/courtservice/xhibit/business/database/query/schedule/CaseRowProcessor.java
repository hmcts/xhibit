...
/**
 * <p>
 * Title: CaseRowRrocessor
 * </p>
 * <p>
 * Description: Creates CaseBasicValue from a database row
 * </p>
 * <p>
...
class CaseRowProcessor extends ReflectionRowProcessor {

    // The file that contains the binding for this object
    private static final String BINDING_FILE = "database/binding/schedule/Case.properties";
     ...
     * @return
     */
    CaseBasicValue getCase() {
        return (CaseBasicValue) getObject();
    }
