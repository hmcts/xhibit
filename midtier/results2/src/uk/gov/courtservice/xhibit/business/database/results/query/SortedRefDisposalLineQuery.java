 ...
 * @version 1.0
 */
public class SortedRefDisposalLineQuery extends QueryOperation {

    // The file that contains the SQL for this query, uses case id.
    private static final String SQL_FILE = "config/database/query/results/SortedRefDisposalLine.sql";
     ...
     */
    public SortedRefDisposalLineQuery() {
     ...
     * ref_disposal_line_id for the specified menu group
     * 
     * @return the list of disposals
     */
    public List getSortedLineList(Integer courtId, String menuGroup) {
        if (courtId == null) {
