...
/**
 * <p>
 * Title: Message Driven Bean that takes events from the ScjseOutboundDeadLetterQueue
 * </p>
 * <p>
 * Description: Logs to file the message that failed from the ScjseOutboundQueue
 * </p>
 * <p>
 ...
 * @weblogic.message-driven destination-jndi-name="scjsegateway/jms/ScjseOutboundDeadLetterQueue"
 *
 * @author GJS
 * @version $Id: OutMessQDLFileMessageBean.java,v 1.3 2007/01/24 12:25:20 qz4rwx Exp $
 */
public class OutMessQDLFileMessageBean extends AbstractDeadLetterToFileMDB implements MessageDrivenBean, MessageListener {
    private static final long serialVersionUID = 1L;

    @Override
    public String getTransactionName() {
        return "ScjseOutboundQueue";
    }
