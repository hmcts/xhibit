...
public class ClientContentHandler extends DefaultHandler
{
        private static final Logger log = CSServices.getLogger(ClientContentHandler.class);


        public ClientContentHandler()
        {
        }
