...
public class XCheckBox extends JCheckBox {
    ...
    /**
     * Construct a new unselected checkbox
     */
    public XCheckBox() {
        this(false);
    }
     ...
     */
    public XCheckBox(boolean selected) {
        this(null, selected);
    }
    
    /**
     * Construct a new checkbox with the given title, selected if specified
     */
    public XCheckBox(String title, boolean selected) {
