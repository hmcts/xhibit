...
/**
 * <p>Title: XHIBIT2</p>
 * <p>Description: SortButtonRenderer</p>
...
public class SortButtonRenderer extends JButton implements TableCellRenderer {
    ...
    static {
        try {
            internalDebug = XHIBITConstant.isInternalDebug("SortButtonRenderer");
        } catch (Exception e) {
            XHIBITConstant.debug("Exception during static initialisation of SortButtonRenderer");
        }
    }
