...
public class DailyListAction extends XAction {

    public DailyListAction() {
        populateFromBundle("DailyList");
    }
    ...
    public void xActionPerformed(ActionEvent e) throws CSRecoverableException {
        ...
        model.setListType(XHIBITConstant.getResource(XhibitBundles.ManageLists, "dailyList"));
