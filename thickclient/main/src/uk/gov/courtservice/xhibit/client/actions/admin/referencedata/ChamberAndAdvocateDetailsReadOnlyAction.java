...
public class ChamberAndAdvocateDetailsReadOnlyAction extends XAction {
	...
	public ChamberAndAdvocateDetailsReadOnlyAction() {
		populateFromBundle("ChamberAndAdvocateDetailsReadOnly");
	}

	public void xActionPerformed(ActionEvent e) throws CSRecoverableException {
		XhibitApplicationController xac = (XhibitApplicationController) getController();
		xac.close();
		chamberAndAdvocateDetailsDialog = new ChamberAndAdvocateDetailsDialog(xac, new ChamberAndAdvocateDetailsModel(true));
