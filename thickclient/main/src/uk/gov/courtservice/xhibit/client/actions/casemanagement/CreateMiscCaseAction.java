...
public class CreateMiscCaseAction extends XAction {

	private static final long serialVersionUID = 1L;
	private final Logger log = CSServices.getLogger(getClass());
	private ManageCase miscCase;

	public CreateMiscCaseAction() {
		populateFromBundle("CreateMiscCase");
	}
	...
	public void xActionPerformed(ActionEvent e) throws CSRecoverableException {
		...
		((XhibitApplicationControllerImpl) xac).setNewTitle("Create Miscellaneous Appeal Case");
		miscCase = new ManageCase(xac, CaseType.MISC);
	}
