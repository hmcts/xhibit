...
public class WarnedListAction extends XAction {

    public WarnedListAction() {
        populateFromBundle("WarnedList");
    }
    ...
    public void xActionPerformed(ActionEvent e) throws CSRecoverableException {
        ...
        model.setListType(XHIBITConstant.getResource(XhibitBundles.ManageLists, "warnedList"));
