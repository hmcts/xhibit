...
public class RunningListAction extends XAction {

    public RunningListAction() {
        populateFromBundle("RunningList");
    }
    ...
    public void xActionPerformed(ActionEvent e) throws CSRecoverableException {
        ...
        model.setListType(XHIBITConstant.getResource(XhibitBundles.ManageLists, "runningList"));
