 ...
 * @version 1.0
 */
public class MediumEventMTDialog extends XDialog {
    public MediumEventMTDialog(Frame frame, MediumEventMTModel model) throws CSRecoverableException {
        super(frame, "", true);
        ...
        addBodyPanel(new MediumEventMTPanel(this, model));
        pack();
        setResizable(false);
    }
}
