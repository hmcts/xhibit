...
public class EditAdvocateWizardFindInstructedAdvocatePanel extends XPanel {
    ...
    public EditAdvocateWizardFindInstructedAdvocatePanel(
    ...
    protected boolean isMandatoryFieldsCompleted() {
        return 
            model.getSubstitutedInstructedAdvocateTableRowModel() != null
            && model.getSubstitutedInstructedAdvocateTableRowModel().getLegalRepId() != null;
    }
    ...
    private void moveScreenToModel() throws CSRecoverableException {
        ...
        model.setSubstitutedInstructedAdvocateTableRowModel(item);
    }
    ...
    public void stepInitialise() throws CSRecoverableException {
        XHIBITConstant.debug("[EditAdvocateWizardFindInstructedAdvocatePanel] stepInitialise");
    ...
    public void stepDeactivate() throws CSRecoverableException {
        XHIBITConstant.debug("[EditAdvocateWizardFindInstructedAdvocatePanel] stepDeactivate");
    }
    ...
    public void stepValidate() throws CSRecoverableException, CSValidationException {
        XHIBITConstant.debug("[EditAdvocateWizardFindInstructedAdvocatePanel] stepValidate");
        // Nothing to validate
        moveScreenToModel();
    }
    ...
    public void stepUpdateViewState() throws CSRecoverableException {
        XHIBITConstant.debug("[EditAdvocateWizardFindInstructedAdvocatePanel] stepUpdateViewState");
    ...
    public void stepDeinitialise(boolean update) throws CSRecoverableException {
        XHIBITConstant.debug("[EditAdvocateWizardFindInstructedAdvocatePanel] stepDeinitialise");
    ...
    public void stepActivate() throws CSRecoverableException {
        XHIBITConstant.debug("[EditAdvocateWizardFindInstructedAdvocatePanel] stepActivate");
        stepUpdateViewState();
    }
}