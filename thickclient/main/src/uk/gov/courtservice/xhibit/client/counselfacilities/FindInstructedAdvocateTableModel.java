...
public class FindInstructedAdvocateTableModel extends XHIBITTableModel {

    private static final long serialVersionUID = 1L;

    public static final int POST_NUMBER = 0;
    
    public static final int FULL_NAME_COLUMN = 1;

    public static final int CHAMBERS_NAME_COLUMN = 2;

    public static final int CHAMBERS_ADDRESS_COLUMN = 3;

    private void setup(Collection data) {
        String[] columnNames = new String[] { 
                XHIBITConstant.getResource(XhibitBundles.CounselFacilities, "postNumber"),
    ...
    public FindInstructedAdvocateTableModel() {
        super();
        Collection noDataYet = new Vector();
        setup(noDataYet);
    }

    public FindInstructedAdvocateTableModel(Collection param) {
        super();
        setup(param);
    }
    ...
    public Object getValueAt(int r, int c) {
        ...
        switch (c) {
        case POST_NUMBER:
            cellValue = myVO.getCrestPostNumber().toString();
            break;
