 ...
 * 
 * @author Cag Onganer
 * @version $Id: UncodedCountDialog.java,v 1.3 2006/06/05 12:31:29 bzjrnl Exp $
 * 
 */
public class UncodedCountDialog extends UncodedOffenceDialog {
     ...
     *            parameter for <init>
     */
    public UncodedCountDialog(Frame frame, String title, boolean modal, UncodedOffenceController uoc,
