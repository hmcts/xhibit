 ...
 * @version 1.0
 */
public class ApplicationToSeverAction extends XAction {
    private static final String eventCode = "20922";

    private static final String schema = "E20922_Charges_Put_Options";

    public ApplicationToSeverAction() {
        populateFromBundle("ApplicationToSever");
    }
