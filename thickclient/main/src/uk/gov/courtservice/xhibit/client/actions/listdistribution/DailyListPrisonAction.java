...
public class DailyListPrisonAction extends XAction {

    public DailyListPrisonAction() {
        populateFromBundle("DailyListPrison");
    }
    ...
    public void xActionPerformed(ActionEvent e) throws CSRecoverableException {
        ...
        model.setListType(XHIBITConstant.getResource(XhibitBundles.ManageLists, "dailyListPrison"));
