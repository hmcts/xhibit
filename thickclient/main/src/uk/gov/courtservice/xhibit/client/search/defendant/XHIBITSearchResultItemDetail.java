...
public class XHIBITSearchResultItemDetail extends uk.gov.courtservice.xhibit.client.util.XHIBITSearchResultItemDetail {
    ...
    private static final Logger log = CSServices.getLogger(XHIBITSearchResultItemDetail.class);
    ...
    public String getTitle() {
        return ResourceBundleHelper.getResource(xs.rsc, "defendant.step3.title");
    }

    public String getDescription() {
        return ResourceBundleHelper.getResource(xs.rsc, "defendant.step3.description");
    }
    ...
    public void setValueObjectDisplay() {
        ...
        addXHIBITValueObjectAttribute("surName", ResourceBundleHelper.getResource(super.xs.rsc, "defandant.lastName"));
