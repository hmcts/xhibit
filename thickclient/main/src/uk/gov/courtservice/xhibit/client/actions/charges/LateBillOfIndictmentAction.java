 ...
 * @version 1.0
 */
public class LateBillOfIndictmentAction extends XAction {
    private static final String eventCode = "20924";

    private static final String schema = "E20924_Charges_Put_Options";

    public LateBillOfIndictmentAction() {
        populateFromBundle("LateBillOfIndictment");
    }
