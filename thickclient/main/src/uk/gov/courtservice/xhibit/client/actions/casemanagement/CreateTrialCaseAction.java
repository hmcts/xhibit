...
public class CreateTrialCaseAction extends XAction {
	...
	public void xActionPerformed(ActionEvent e) throws CSRecoverableException {
		...
		((XhibitApplicationControllerImpl) xac).setNewTitle("Create Trial Case");
		trialCase = new ManageCase(xac, CaseType.TRIAL);
	}
