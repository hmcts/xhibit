...
/**
 * Model class for data required for a court site in the outline control.
 * 
 * @author uphillj
 *
 */
public class CourtSiteTreeNodeModel extends AbstractTreeNodeModel {
	...
	public String getDisplayName() {
		return courtSiteBasicValue.getCourtSiteName();
	}
