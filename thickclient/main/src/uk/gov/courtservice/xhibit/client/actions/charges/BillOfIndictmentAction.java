 ...
 * @version 1.0
 */
public class BillOfIndictmentAction extends XAction {
    private static final String eventCode = "20925";

    private static final String schema = "E20925_Charges_Put_Options";

    public BillOfIndictmentAction() {
        populateFromBundle("BillOfIndictment");
    }
