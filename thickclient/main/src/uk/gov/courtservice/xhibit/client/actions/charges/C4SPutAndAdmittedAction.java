 ...
 * @version 1.0
 */
public class C4SPutAndAdmittedAction extends XAction {
    private static final String eventCode = "20928";

    public C4SPutAndAdmittedAction() {
        populateFromBundle("C4SPutAndAdmitted");
    }
    ...
    public void xActionPerformed(ActionEvent e) throws CSRecoverableException {
        ...
        String panelText = XHIBITConstant.getResource(resources, "C4SPutAndAdmitted.panelText");
