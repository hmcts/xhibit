 ...
 * @version 1.0
 */
public class SOProsecutionNoEvidenceAction extends XAction {
    private static final String eventCode = "20927";

    public SOProsecutionNoEvidenceAction() {
        populateFromBundle("SOProsecutionNoEvidence");
    }
    ...
    public void xActionPerformed(ActionEvent e) throws CSRecoverableException {
        ...
        String panelText = XHIBITConstant.getResource(resources, "SOProsecutionNoEvidence.panelText");
