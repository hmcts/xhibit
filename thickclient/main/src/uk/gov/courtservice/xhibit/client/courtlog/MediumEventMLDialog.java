 ...
 * @version 1.0
 */
public class MediumEventMLDialog extends XDialog {
    public MediumEventMLDialog(Frame frame, MediumEventMLModel model) throws CSRecoverableException {
        super(frame, "", true);
        ...
        addBodyPanel(new MediumEventMLPanel(this, model));
        pack();
        setResizable(false);
    }
}
