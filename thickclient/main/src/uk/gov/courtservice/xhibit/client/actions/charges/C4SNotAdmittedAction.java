 ...
 * @version 1.0
 */
public class C4SNotAdmittedAction extends XAction {
    private static final String eventCode = "20929";

    public C4SNotAdmittedAction() {
        populateFromBundle("C4SNotAdmitted");
    }
    ...
    public void xActionPerformed(ActionEvent e) throws CSRecoverableException {
        ...
        String panelText = XHIBITConstant.getResource(resources, "C4SNotAdmitted.panelText");
