...
public class EndBWCourtLogDialog  extends XDialog{

	 public EndBWCourtLogDialog(Frame frame, EndBWMediumEventMLModel model) throws CSRecoverableException {
	        ...
	        addBodyPanel(new EndBWCourtLogPanel(this, model));
	        pack();        
