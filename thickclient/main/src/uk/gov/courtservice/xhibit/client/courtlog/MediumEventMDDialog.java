 ...
 * @version 1.0
 */
public class MediumEventMDDialog extends XDialog {
    public MediumEventMDDialog(Frame frame, MediumEventMDModel model) throws CSRecoverableException {
        super(frame, "", true);
        ...
        addBodyPanel(new MediumEventMDPanel(this, model));
        pack();
        setResizable(false);
    }
}
