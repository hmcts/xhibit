...
public class WarnedListLetterAction extends XAction {

    public WarnedListLetterAction() {
        populateFromBundle("WarnedListLetter");
    }
    ...
    public void xActionPerformed(ActionEvent e) throws CSRecoverableException {
        ...
        model.setListType(XHIBITConstant.getResource(XhibitBundles.ManageLists, "warnedListLetter"));
