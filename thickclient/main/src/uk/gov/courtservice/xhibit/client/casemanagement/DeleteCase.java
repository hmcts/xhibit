...
public class DeleteCase {
	...
	public DeleteCase(XhibitApplicationController xac) throws CSRecoverableException {
		log.debug("DeleteCase:");
		setCaseId(0);
		...
		caseSearchModel.setDeleteCase(true);
	...
	public DeleteCase(XhibitApplicationController xac, boolean overload) throws CSRecoverableException {
		setCaseId(0);
