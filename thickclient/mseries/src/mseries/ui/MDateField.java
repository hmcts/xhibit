 ...
 * allow date within the range to be selected. Dates outside of the range may be
 * entered by typing directly into the field.
 * 
 * @author Martin Newstead
 */
public class MDateField extends JTextField {
     ...
     * less flexibility is needed then this would be done differently
     */
    ...
    // {
    // /* The date entry field, this variable and the frame need to be final
    // because main()
    // * is static and they are used in the inner class that is the action
    // listener for
    // * the button
    // */
    ...
    // /* Correct format for locale en_GB ! Setting the maximum and minimum
    // is
    ...
    //
    // /* Get the position of the text field and use this for the position
    // of the popup,
    // * the MDateSelector uses these coordinates relative to the component
    // passed as
    // * the parent (endDate)
    // */
...
//
// Revision 1.2 2006/05/31 14:26:08 bzjrnl
// Change: TI901
