 ...
 */
public class FloatEditor extends DefaultSpinnerEditor {
    ...
    /**
     * Constructor used to set a custom format. The notation used is based on
     * that of PIC(9) fields in Cobol. It uses two symbols to describe how a
     * character is represented. The total maximum width of the display in
     * characters is the number of characters in the format including the dot.
     * The format expressed here is used to set the number of digits before and
     * after the decimal point, a locale sensitive NumberFormat object is used
     * to place commas, dots in the appropriate places.
     * 
     * <PRE>
     * 
     * z - a zero value in this position is supressed 9 - a place holder to
     * determine the size of the field
     * 
     * For Examples with a value of 123.4 you would see
     * 
     * zz9.99 - 123.40 zzz9.99 - 123.40 zzz9.9 - 123.4 9999.99 - 0123.40
     * 
     * </PRE>
     * 
     * Of course a NumberFormat object can be set using the setFormatter method
     */
    public FloatEditor(String pattern) {
        init(pattern);
    }
    ...
    public Object getValue() {
        ...
        float x = ((Float) retVal).floatValue();
        return new Float(x);
    }
     ...
     * 
     * @return the textfield configured to allow floats to be entered & spun
     */
    ...
    public void setValue(Object value) {
        ...
        if (value instanceof java.lang.Float) {
            x = (Float) value;
            display.setText(nf.format(x.floatValue()));
        }
        setting = false;
    }
