...
public class IconPanel extends JPanel {
    ...
    /**
     * Fill the panel with a single scaled copy of the image (only avaliable if
     * the icon is an ImageIcon)
     */
     ...
     * 
     * @param icon
     *            the icon for the panel background
     */
     ...
     *            the icon for the panel background
     * @param placement
     *            the position of the image in the panel
     */
