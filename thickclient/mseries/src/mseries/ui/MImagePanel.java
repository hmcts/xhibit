...
public class MImagePanel extends javax.swing.JPanel {
     ...
     * 
     * public static void main(String[] argv) { MImagePanel panel = new
     * MImagePanel(new FlowLayout()); panel.setImageFile(argv[0]); panel.add(new
     * javax.swing.JButton("OK")); panel.add(new javax.swing.JButton("OK"));
     * panel.add(new javax.swing.JButton("OK")); panel.add(new
