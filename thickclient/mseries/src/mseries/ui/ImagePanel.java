...
/**
 * An Image panel that provides a component showing an image on its background.
 * It allows an image to be placed on the IconPanel
 * 
 */
public class ImagePanel extends IconPanel {
     ...
     * 
     * @param imageURL
     *            the URL of the image to be used in the background
     */
