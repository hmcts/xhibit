 ...
 * independantly. In other words the step is variable .The value is always a
 * Date but the step changes usually by the editor according to where the user
 * places the cursor.
 */
public class MDateSpinnerModel extends DefaultSpinnerModel {
    ...
    /**
     * Advance and return the next value in the sequence according to the step
     * value and maximum
     * 
    ...
    private Object changeValue(int step, int dir) {
        ...
        case DateFormat.AM_PM_FIELD:
            ...
            cal.set(Calendar.HOUR, cal.get(Calendar.HOUR) + mult);
        ...
        case DateFormat.DAY_OF_YEAR_FIELD:
            cal.set(Calendar.DAY_OF_YEAR, cal.get(Calendar.DAY_OF_YEAR) + dir);
            break;
        ...
        case DateFormat.HOUR_OF_DAY1_FIELD:
            ...
            cal.set(Calendar.HOUR, cal.get(Calendar.HOUR) + dir);
            break;

        case DateFormat.MILLISECOND_FIELD:
            cal.set(Calendar.MILLISECOND, cal.get(Calendar.MILLISECOND) + dir);
            break;

        case DateFormat.MINUTE_FIELD:
            cal.set(Calendar.MINUTE, cal.get(Calendar.MINUTE) + dir);

            break;

        case DateFormat.MONTH_FIELD:
            cal.set(Calendar.MONTH, cal.get(Calendar.MONTH) + dir);
        ...
        case DateFormat.SECOND_FIELD:
            cal.set(Calendar.SECOND, cal.get(Calendar.SECOND) + dir);

            break;

        case DateFormat.WEEK_OF_MONTH_FIELD:
            cal.set(Calendar.WEEK_OF_MONTH, cal.get(Calendar.WEEK_OF_MONTH) + dir);
        ...
        case DateFormat.YEAR_FIELD:
            cal.set(Calendar.YEAR, cal.get(Calendar.YEAR) + dir);
...
// Revision 1.3  2006/06/05 12:31:53  bzjrnl
// Change: TI901
...
//
// Revision 1.1 2004/04/02 15:44:06 sz0t7n
