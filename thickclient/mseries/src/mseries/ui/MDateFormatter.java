...
public class MDateFormatter implements MDateFormat {
    ...
    /**
     * Returns the date formatted for display in the form of a String. The
     * format is defined in the constructor of the class.
     */
    ...
    /**
     * Applies the formatters to parse the input string and attempts to
     * translate it into a valid date. Valid dates with the last two digits less
