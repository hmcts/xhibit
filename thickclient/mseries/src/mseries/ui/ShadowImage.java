...
public class ShadowImage implements Icon {
    ...
    /*
     * Paints the texture on the texture area, repeating (tiling) as often as it
     * needs to fill the area.
     */
...
/**
 * One instance of the texture image. Each image is 64x64. Different colours and
 * different orientation make a different image. This class is capable of
 * drawing the ArmatureImage in any colours and etiher horizontal and vertical.
 */
class BumpBuffer {
    static Frame frame;
     ...
     * drawn or simply a texture using lines
     */
