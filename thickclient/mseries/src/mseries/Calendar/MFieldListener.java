 ...
 * to an MSeries field such as MDateEntryField.
 * <P>
 * Focus listeners can't be used as some components artificially lose and gain
 * the focus but the component is not strictly exited. This interface should be
 * used to detect the user entering and exiting the field
 */
