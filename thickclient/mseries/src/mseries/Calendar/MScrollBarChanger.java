 ...
 * java.util.Date. The mimimum and maximum values are therefore Dates, the unit
 * increment a month and the block increment a year
 */
class MScrollBarChanger extends JScrollBar implements MDateChanger, AdjustmentListener {
    ...
    //
    /**
     * Inner class to manage the push of the PAGE UP and PAGE DOWN keys which
     * move the scrollbar and hence the calendar forward and backwards one month
     * respectively.
     */
     ...
     * blockIncrement = 12 unitIncrement = 1 minimum = 1 January 1900 maximum =
     * 31 December 2037 value = 1 January 1900 extent = 1
     */
     ...
     * JScrollBar) and blockIncrement = 12 unitIncrement = 1 minimum = 1 January
     * 1900 maximum = 31 December 2037 value = 1 January 1900 extent = 1
     */
    ...
    /*
     * installs the PAGE UP and PAGE DOWN buttons with the increment specifed in
     * months. @param advance the number of months to move forward and backwards
     */
    ...
    // registerKeyboardAction(new UpDownAction(DOWN,
    ...
    // }
    private void installKeyboardActions() {
        registerKeyboardAction(new PagingAction(1), KeyStroke.getKeyStroke(KeyEvent.VK_PAGE_UP, 0),
                JComponent.WHEN_IN_FOCUSED_WINDOW);
        registerKeyboardAction(new PagingAction(-1), KeyStroke.getKeyStroke(KeyEvent.VK_PAGE_DOWN, 0),
                JComponent.WHEN_IN_FOCUSED_WINDOW);

        registerKeyboardAction(new PagingAction(12), KeyStroke.getKeyStroke(KeyEvent.VK_PAGE_UP, KeyEvent.SHIFT_MASK),
                JComponent.WHEN_IN_FOCUSED_WINDOW);
        registerKeyboardAction(new PagingAction(-12), KeyStroke
                .getKeyStroke(KeyEvent.VK_PAGE_DOWN, KeyEvent.SHIFT_MASK), JComponent.WHEN_IN_FOCUSED_WINDOW);
    }

    /*
     * Sets the earliest possible value for the scrollbar to the start of the
     * month in date passed in. Also sets the curent value to the same. @param
     * min a date in the earliest month
     */
    public void setMinimum(Date min) {
        ...
        /*
         * The maximum for the scrollbar is the number of months from the
         * minimum
         */
    ...
    /*
     * Sets the latest possible value for the scrollbar to the end of the month
     * in date passed in. @param max a date in the latest month
     */
    public void setMaximum(Date max) {
        ...
        int monthRange = lastMonth - minMonths;
    ...
    /*
     * Sets the value of the scrollbar to the number of months since the the
     * minimum date represented by the date passed @param newVal - the new value
     */
