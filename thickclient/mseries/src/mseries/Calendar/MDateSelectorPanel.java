...
/**
 * A calender component that shows one month at a time with controls to change
 * the month and year. The parameters to the calendar, including the style of
 * the control are given in the MDateSelectorConstraints object that is passed.
 * There is a default call MDefaultPullDownConstraints that can be used or
 * subclassed to provide a set of application wide defaults.
 * 
 * @see mseries.Calendar.MDateSelectorConstraints
 */
public class MDateSelectorPanel extends MImagePanel implements MMonthListener, GridSelectionListener, MChangeListener,
        MouseListener {
    ...
    public MDateSelectorPanel(boolean lazy) {
        ...
        this.dataModel = new MMonth();
        dataModel.addMMonthListener(this);
        /*
         * The FocusChecker is a class that works out if the calendar, year
         * spinner or month spinner have the focus, if non have it calls a
         * method on the dataModel
         */
        fc = new FocusChecker();
    ...
    /**
     * Sets the style of changer for the month & year, implementations include
     * COMBOBOX/SPINNER and a scrollbar
     * 
     * @see mseries.Calendar.MDateChanger
     * @param style
     *            a constant from MDateChanger
     */
    ...
    /**
     * Sets a value in the component and does not change the time elements. This
     * method would be used when a specific date is generated and only the Day,
     * Month, Year are really needed along with the time that the component
     * already had.
     * 
     * @param date
     *            the new date
     ...
     * 
     * @param c
     *            an instance of MDateSelectorConstraints that contains the
     *            desired settings.
     */
    ...
    /**
     * Captures changes in the currently selected cell and sets the current date
     * in the data model from com.java.swing.event.ListSelectionListener
     */
     ...
     * 
     * @param imageFile
     *            the image file, usual Java file types (.jpg, .gif, etc) are
     *            supported.
     */
 ...
 * they all have lost the focus is encapsulated in the MDSAction passed in the
 * setAction method
 */
 ...
 * 1.1 2004/04/02 15:44:00 sz0t7n Adding mseries to the build so we can bug fix
 * it from now on
 * 
 * Revision 1.15 2003/01/10 18:07:41 martin ** empty log message ***
 * 
 * Revision 1.14 2002/08/17 20:40:00 martin Added new cosntructor with lazy
 * attribute
 * 
 * Revision 1.13 2002/07/21 17:30:57 martin no message
 * 
 * Revision 1.12 2002/07/21 17:29:35 martin no message
 * 
 * Revision 1.11 2002/07/21 16:24:40 martin no message
 * 
 * Revision 1.10 2002/06/18 21:32:29 martin no message
 * 
 * Revision 1.9 2002/06/13 19:25:06 martin Added closeOnToday button support
 * 
 * Revision 1.8 2002/06/09 13:48:18 martin Added 'Today' button
 * 
 ...
 * 
 * Revision 1.5 2002/02/16 09:48:47 martin Added selectionClickCount attribute
 * 
