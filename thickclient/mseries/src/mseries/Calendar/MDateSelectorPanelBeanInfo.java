...
public class MDateSelectorPanelBeanInfo extends SimpleBeanInfo {
    ...
    public EventSetDescriptor[] getEventSetDescriptors() {
        ...
        try {
            event = new EventSetDescriptor(mdsClass, "mMonth", mseries.Calendar.MMonthListener.class, "dataChanged");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor date = new PropertyDescriptor("date", mdsClass), foreground = new PropertyDescriptor(
                    ...
                    "border", mdsClass), max = new PropertyDescriptor("maximum", mdsClass), min = new PropertyDescriptor(
                    "minimum", mdsClass), tl = new PropertyDescriptor("textLocalizer", mdsClass), nfc = new PropertyDescriptor(
                    "nextFocusableComponent", mdsClass), fd = new PropertyDescriptor("firstDay", mdsClass), image = new PropertyDescriptor(
                    "imageFile", mdsClass), font = new PropertyDescriptor("font", mdsClass);
            ...
            PropertyDescriptor[] pd = { image, date, foreground, background, font, opaque, autoscrolls, alx, aly, dgo,
                    rfe, db, ps, maxS, minS, b, max, min, tl, nfc, fd };
            return pd;
        } catch (IntrospectionException e) {
