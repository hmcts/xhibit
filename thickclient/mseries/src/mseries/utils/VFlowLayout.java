 ...
 * added. When there is excess space, the components are not assigned it so they
 * all remain to the top of the container. The components stretch horizontally
 * to width of the container
 */
public class VFlowLayout implements LayoutManager2, Serializable {
     ...
     * the dimensions. This method only recalculates them if the cache is null
     * which may happen by the invalidateLayout method.
     */
