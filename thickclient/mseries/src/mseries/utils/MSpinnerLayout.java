...
/**
 * Layout manager for a spinner type display. Divides the space into three, add
 * the textfield first, then the top right component then the bottom right. The
 * image shows buttons on the right hand side which is the most likely usage but
 * <i>any</i> component could be added.
 * 
 * <PRE>
 * 
 ...
 * and they will always occupy the full height of the component as assigned by
...
public class MSpinnerLayout implements LayoutManager {
    ...
    public void layoutContainer(Container parent) {
        synchronized (parent.getTreeLock()) {
            ...
            if (up != null) {
                ...
                up.setBounds(width - (insets.right + buttonWidth), insets.top, buttonWidth, buttonHeight);
            }
            if (down != null) {
                down.setBounds(width - (insets.right + buttonWidth), buttonHeight + insets.top, buttonWidth,
                        buttonHeight);
            }
            if (display != null) {
    ...
    /*
     * public static void main(String[] argv) { javax.swing.JPanel p=new
     * javax.swing.JPanel(); javax.swing.JFrame f = new javax.swing.JFrame();
     * 
