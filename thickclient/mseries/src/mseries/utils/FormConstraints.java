...
/**
 * The <code>FormConstraints</code> class specifies constraints for components
 * that are laid out using the <code>FormLayout</code> class.
 * 
...
public class FormConstraints implements Cloneable, java.io.Serializable {
     ...
     * there is enough remaining space in the container.
     */
     ...
     * leftmost cell has <code>gridx=0</code>. The value
     * <code>RELATIVE</code> specifies that the component be placed just to
     * the right of the component that was added to the container just before
     * this component was added.
     * <p>
     * The default value is <code>RELATIVE</code>. gridx should be a
     * non-negative value.
     * 
     * @serial
     * @see #clone()
     ...
     * <p>
     * The default value is <code>RELATIVE</code>. gridy should be a
     * non-negative value.
     * 
     * @serial
     * @see #clone()
     ...
     * Possible values are <code>CENTER</code>, <code>NORTH</code>,
     * <code>NORTHEAST</code>, <code>EAST</code>, <code>SOUTHEAST</code>,
     * <code>SOUTH</code>, <code>SOUTHWEST</code>, <code>WEST</code>,
     * and <code>NORTHWEST</code>. The default value is <code>CENTER</code>.
     * 
     * @serial
     * @see #clone()
     */
     ...
     * calculations, it will fill the column which is wht widht of the widest
     * component in the column
     */
    public boolean fill;

    /**
     * Creates a <code>FormConstraint</code> object with all of its fields set
