...
public class MComboBoxLayout implements LayoutManager {
    ...
    public void layoutContainer(Container parent) {
        ...
        if (pushButton != null) {
            ...
            pushButton.setBounds(width - (insets.right + buttonSize), insets.top, buttonSize, buttonSize);
        }
        if (display != null) {
    ...
    protected Rectangle rectangleForCurrentValue() {
        ...
        Rectangle r = new Rectangle(insets.left, insets.top, width - (insets.left + insets.right + buttonSize), height
