...
public class MetalNationalityEntryUI extends mseries.plaf.basic.BasicNationalityEntryUI {
    ...
    public static ComponentUI createUI(JComponent x) {
        return new MetalNationalityEntryUI();
    }
    ...
    protected void configureBorder(JComponent c) {
        c.setBorder(BorderFactory.createEtchedBorder(MetalLookAndFeel.getControlHighlight(), MetalLookAndFeel
    ...
    protected JButton createArrowButton() {
        ...
        b.setBorder(BorderFactory.createEtchedBorder(MetalLookAndFeel.getControlHighlight(), MetalLookAndFeel
                .getControlDarkShadow()));
        return b;
    }
}
