...
public class WindowsNationalityEntryUI extends mseries.plaf.basic.BasicNationalityEntryUI {
    ...
    public static ComponentUI createUI(JComponent x) {
        return new WindowsNationalityEntryUI();
    }
    ...
    protected JButton createArrowButton() {
        JButton x = super.createArrowButton();
        x.setBackground(UIManager.getColor("control"));
