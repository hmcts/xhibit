              ...
              Skeleton Schedule
				...
				<fo:block>
                    <fo:table table-layout="fixed"  width="100%" space-after="2mm">
                       ...
                       <fo:table-body>
                            <fo:table-row>
                                <fo:table-cell border-style="solid" border-width=".01mm">
                                ...
                                <fo:table-cell border-style="solid" border-width=".01mm">
                                    <fo:block text-align="center" font-size="10pt" font-family="Verdana, Helvetica, Times" font-weight="bold" start-indent="1mm" end-indent="1mm" space-before="1mm" hyphenate="true" language="en">
                            ...
                            <fo:table-row>
                                ...
                                <fo:table-cell border-style="solid" border-width=".01mm">
                                    <fo:block font-size="10pt" font-family="Verdana, Helvetica, Times" start-indent="1mm" end-indent="1mm" space-before="1mm" hyphenate="true" language="en_GB">
                                            ...
                                            <fo:table-body>
                                                ...
                                                <xsl:choose>
                                                    <xsl:when test="morningnotes">
                                                        <fo:table-row>
                                                            <fo:table-cell  number-columns-spanned="5" border-style="solid" border-width=".01mm">
                                                                <fo:block font-size="10pt" font-family="Verdana, Helvetica, Times" start-indent="1mm" end-indent="1mm" space-before="1mm" hyphenate="true" language="en_GB">
