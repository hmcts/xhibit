...
public class EditWitnessAction extends XAction {
    ...
    public EditWitnessAction() {
        ...
        populateFromBundle("EditWitness");
    }
    ...
    public void xActionPerformed(ActionEvent e) throws CSRecoverableException {
        ...
        WitnessDialog witnessDialog = new WitnessDialog(xac, WitnessDialog.EDIT);
