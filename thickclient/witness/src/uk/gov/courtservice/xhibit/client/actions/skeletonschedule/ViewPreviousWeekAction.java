...
public class ViewPreviousWeekAction extends XAction {
    private static final Logger log = CSServices.getLogger(ViewPreviousWeekAction.class);

    public ViewPreviousWeekAction() {
        log.debug("ViewPreviousWeekAction()");

        populateFromBundle("ViewPreviousWeek");
    }
    ...
    public void xActionPerformed(ActionEvent e) throws CSRecoverableException {
        ...
        if (currentWeek > 1) {
            skeletonSchedulePanel.setCurrentWeek(skeletonSchedulePanel.getPrevPopulatedWeek(currentWeek));
        }
    }
}