...
<xsl:stylesheet version="1.0" xmlns:bs7666="http://www.govtalk.gov.uk/people/bs7666" xmlns:cs="http://www.courtservice.gov.uk/schemas/courtservice" xmlns:nar="http://www.courtservice.gov.uk/schemas/courtservice/xhibit/orders/narrative" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ord="http://www.courtservice.gov.uk/schemas/courtservice/xhibit/orders" xmlns:apd="http://www.govtalk.gov.uk/people/AddressAndPersonalDetails" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:set="http://xml.apache.org/xslt">
	...
	<!-- ***************************************************************************************************************** -->
	<!-- convicted of crime -->
	<xsl:template match="nar:COMYIMP_ConvictedOfCrime">
		<fo:inline>
			<xsl:text>was convicted of crime on </xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Template to display the Conviction Date -->
	<xsl:template match="nar:COMYIMP_ConvictionDate">
		<xsl:call-template name="FormatDate">
			<xsl:with-param name="date" select="$baseAll/ord:ConvictionDate"/>
		</xsl:call-template>
	</xsl:template>
	<!-- Court ordered -->
	<xsl:template match="nar:COMYIMP_CourtOrdered">
		<fo:inline>
			<xsl:text>The Court ordered</xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Custodial Sentence -->
	<xsl:template match="nar:COMYIMP_CustodialSentences">
		<fo:inline>
			<xsl:choose>
	...
	<xsl:template match="nar:COMYIMP_ChapterIII_Title1">
		<fo:inline>
			<xsl:text>Required custodial</xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Chapter III title Text2-->
	<xsl:template match="nar:COMYIMP_ChapterIII_Title2">
		<fo:inline>
			<xsl:text>sentences for certain</xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Chapter III title Text3-->
	<xsl:template match="nar:COMYIMP_ChapterIII_Title3">
		<fo:inline>
			<xsl:text>offences</xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Chapter III text -->
	<xsl:template match="nar:COMYIMP_ChapterIII_Text">
		<fo:inline>
	...
	<xsl:template match="nar:COMYIMP_DrugTraffickingTitle">
		<fo:inline>
			<xsl:text>Third Class A Drug Trafficking Offence</xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Display Serious Offence Text -->
	<xsl:template match="nar:COMYIMP_DrugTrafficking">
	...
	<xsl:template match="nar:COMYIMP_DomesticBurglaryTitle">
		<fo:inline>
			<xsl:text>Third Domestic Burglary</xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Display Minimum Sentence Text -->
	<xsl:template match="nar:COMYIMP_DomesticBurglary">
	...
	<xsl:template match="nar:COMYIMP_ExtendedSentence_Title1">
		<fo:inline>
			<xsl:text>Extended Sentence</xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Extended Sentence Title text2 -->
	<xsl:template match="nar:COMYIMP_ExtendedSentence_Title2">
		<fo:inline>
			<xsl:text>(for sexual or violent</xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Extended Sentence Title text3 -->
	<xsl:template match="nar:COMYIMP_ExtendedSentence_Title3">
		<fo:inline>
			<xsl:text>offences)</xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Extended Sentence Text1 -->
	<xsl:template match="nar:COMYIMP_ES_Text1">
		<fo:inline>
	...
	<xsl:template match="nar:COMYIMP_Days">
		<!-- years value -->
	...
	<xsl:template match="nar:COMYIMP_Section44">
	...
	<xsl:template match="nar:COMYIMP_ReturnDefendant_Line1">
		<fo:inline>
	...
	<xsl:template match="nar:COMYIMP_ReturnDefendant_Line2">
		<fo:inline>
	...
	<xsl:template match="nar:COMYIMP_ReturnDefendant_Line3">
		<fo:inline>
	...
	<xsl:template match="nar:COMYIMP_ReturnPeriod">
	...
	<xsl:template match="nar:COMYIMP_TotalPeriod">
	...
	<xsl:template match="nar:COMYIMP_ReleasePrisoners_Title1">
		<fo:inline>
			<xsl:text>Release of discretionary</xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Release Prisoners Title 2 -->
	<xsl:template match="nar:COMYIMP_ReleasePrisoners_Title2">
		<fo:inline>
			<xsl:text>life prisoners</xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Release Prisoners text 1 -->
	<xsl:template match="nar:COMYIMP_ReleasePrisoners_Text1">
		<fo:inline>
	...
	<xsl:template match="nar:COMYIMP_ReleasePrisoners_Text2">
		<fo:inline>
	...
	<!-- Section 86 title 1 -->
	<xsl:template match="nar:COMYIMP_Section86_Title1">
		<fo:inline>
			<xsl:text>Release of prisoners</xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Section 86 title 2 -->
	<xsl:template match="nar:COMYIMP_Section86_Title2">
		<fo:inline>
			<xsl:text>who have committed</xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Section 86 title 3 -->
	<xsl:template match="nar:COMYIMP_Section86_Title3">
		<fo:inline>
			<xsl:text>sexual offences before</xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Section 86 title 4 -->
	<xsl:template match="nar:COMYIMP_Section86_Title4">
		<fo:inline>
			<xsl:text>30th September 1998</xsl:text>
		</fo:inline>
	</xsl:template>
	<!-- Section 86 text -->
	<xsl:template match="nar:COMYIMP_Section86_Text">
		<fo:inline>
	...
	<xsl:template match="nar:COMYIMP_CreditForBail_title1">
		<fo:inline>
			<xsl:text>Credit for time spent on bail</xsl:text>
		</fo:inline>
	</xsl:template>
	<xsl:template match="nar:COMYIMP_CreditForBail_title2">
		<fo:inline>
			<xsl:text>with an electronically</xsl:text>
		</fo:inline>
	</xsl:template>
	<xsl:template match="nar:COMYIMP_CreditForBail_title3">
		<fo:inline>
	...
	<xsl:template match="nar:COMYIMP_IndeterminateSentence_title1">
		<fo:inline>
			<xsl:text>Indeterminate sentence</xsl:text>
		</fo:inline>
	</xsl:template>
	<xsl:template match="nar:COMYIMP_IndeterminateSentence_title2">
		<fo:inline>
			<xsl:text>for public protection</xsl:text>
		</fo:inline>
	</xsl:template>
	<xsl:template match="nar:COMYIMP_AutomaticDeportation_title">
		<fo:inline>
			<xsl:text>Automatic deportation</xsl:text>
		</fo:inline>
	</xsl:template>
	<xsl:template match="nar:COMYIMP_RecommendedDeportation_title">
		<fo:inline>
			<xsl:text>Recommendation for deportation</xsl:text>
		</fo:inline>
	</xsl:template>
	<xsl:template match="nar:COMYIMP_AutomaticDeportation_text">
		<fo:inline>
	...
	<xsl:template match="nar:COMYIMP_RecommendedDeportation_text">
		<fo:inline>
	...
	<xsl:template match="nar:COMYIMP_RecommendedDeportation">
		<fo:inline>
			<xsl:text>Recommendation for deportation</xsl:text>
		</fo:inline>
	</xsl:template>
