...
public class OrderViewController extends OrderController {

    private static final Logger log = CSServices.getLogger(OrderViewController.class);
     ...
     */
    public OrderViewController(XhibitApplicationController xac) throws CSRecoverableException {
        super();
        setController(xac);
