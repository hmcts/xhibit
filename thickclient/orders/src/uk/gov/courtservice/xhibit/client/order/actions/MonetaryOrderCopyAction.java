...
import uk.gov.courtservice.xhibit.client.order.screens.controllers.MonetaryOrderCopyController;
...
public class MonetaryOrderCopyAction extends OrderAction {
     ...
     */
    public MonetaryOrderCopyAction(XhibitApplicationController xac) throws CSRecoverableException {
        super(xac);
        populateFromBundle(ResourceHelper.getResourceString(MONETARY_ORDER_ACTION_COPY));
        log.debug("MonetaryOrderCopyAction***: constructor with XhibitApplicationController");
    }

    public MonetaryOrderCopyAction() throws CSRecoverableException {
        super();
        populateFromBundle(ResourceHelper.getResourceString(MONETARY_ORDER_ACTION_COPY));
        this.setLongDescription(ResourceHelper.getResourceString(MONETARY_ORDER_ACTION_COPY_LDESC));
        this.setShortDescription(ResourceHelper.getResourceString(MONETARY_ORDER_ACTION_COPY_SDESC));
        log.debug("MonetaryOrderCopyAction***: default constructor");
    }
    ...
    public void xActionPerformed(ActionEvent parm1) throws java.lang.Exception {
        ...
        MonetaryOrderCopyController copyController = new MonetaryOrderCopyController((XhibitApplicationController) getController());
