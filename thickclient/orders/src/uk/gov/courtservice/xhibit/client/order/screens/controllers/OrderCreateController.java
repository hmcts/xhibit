...
public class OrderCreateController extends OrderController {

    private static final Logger log = CSServices.getLogger(OrderCreateController.class);
     ...
     */
    public OrderCreateController(XhibitApplicationController xac) throws CSRecoverableException {
        super();
        setController(xac);
     ...
     * @throws CSRecoverableException
     */
    public OrderCreateController() throws CSRecoverableException {
        super();
    ...
    private XhbOrderValue generateOrderTemplates(boolean force) throws ReplaceableOrderAlreadyCreatedException,
        ...
        Integer xhibitCaseId = new Integer(getModel().getXhibitCaseId());
        
        boolean isBCase = getModel().isBCase();

        log.debug("\nORDERS***: CaseID = " + getModel().getCaseID());
        log.debug("\nORDERS***: XHIBITCaseID = " + getModel().getXhibitCaseId());
        ...
        try {
            ...
            XhbOrderValue order = createOrder(defOnCaseID, caseId, xhibitCaseId, caseTitle, courtId, orderTypeID, force, isBCase);
    ...
    private XhbOrderValue generateOrderTemplates(Integer originalOrderId) throws // ReplaceableOrderAlreadyCreatedException,
        ...
        log.debug("\nORDERS***: CaseID = " + getModel().getCaseID());
        log.debug("\nORDERS***: DefendantID = " + defOnCaseID);
        log.debug("\nORDERS***: Defendant = " + getModel().getDefendantName());
        log.debug("\nORDERS***: OrderTypeID = " + orderTypeID);
        log.debug("\nORDERS***: OrderType = " + getModel().getOrderType());
     ...
     */
    private XhbOrderValue createOrder(Integer defOnCaseID, Integer caseId, Integer xhibitCaseId, String caseTitle, Integer courtId, Integer orderID, boolean force, boolean isBCase)
        ...
        XhbOrderValue order = XhibitDelegateHelper.getOrdersDelegate().createOrder(defOnCaseID, caseId, xhibitCaseId, caseTitle, courtId, orderID, null, force, isBCase, null, null);
        return order;
    }
