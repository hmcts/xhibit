...
/**
 * <p>
 * Title: Xhibit2 MonetaryOrderCopyController
 * </p>
 * <p>
...
public class MonetaryOrderCopyController extends OrderController {

    private static final Logger log = CSServices.getLogger(MonetaryOrderCopyController.class);
     ...
     */
    public MonetaryOrderCopyController(XhibitApplicationController xac) throws CSRecoverableException {
        super();
        setController(xac);
