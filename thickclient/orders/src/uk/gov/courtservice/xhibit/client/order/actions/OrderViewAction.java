...
public class OrderViewAction extends OrderAction {
     ...
     */
    public OrderViewAction(XhibitApplicationController xac) throws CSRecoverableException {
        super(xac);
        populateFromBundle(ResourceHelper.getResourceString(ORDER_ACTION_VIEW));
        log.debug("OrderViewAction***: constructor with XhibitApplicationController");
    }

    public OrderViewAction() throws CSRecoverableException {
        super();
        populateFromBundle(ResourceHelper.getResourceString(ORDER_ACTION_VIEW));
        this.setLongDescription(ResourceHelper.getResourceString(ORDER_ACTION_VIEW_LDESC));
        this.setShortDescription(ResourceHelper.getResourceString(ORDER_ACTION_VIEW_SDESC));
        log.debug("OrderViewAction***: default constructor");
    }
    ...
    public void xActionPerformed(ActionEvent parm1) throws java.lang.Exception {
        ...
        OrderViewController viewController = new OrderViewController((XhibitApplicationController) getController());
