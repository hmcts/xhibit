 ...
 * </p>
 * 
 * @version $Id: V1DataComponent.java,v 1.20 2009/03/24 17:09:29 hewittm Exp $
 */

public class V1DataComponent extends ComboBoxDataComponent {
     ...
     * The options
     */
    private static final String[] SINGLE_OPTIONS = new String[] { " ", "hour", "day", "week", "month", "year" };

    private static final String[] PLURAL_OPTIONS = new String[] { " ", "hours", "days", "weeks", "months", "years" };


    /**
     * Construct a new instance
     */
    public V1DataComponent() {
        super();
    ...
    public String createToolTipTextImpl() {
        return DisposalUtil.getToolTipText("v1DataComponentToolTip");
    }
