...
public class RunRRECReportDialog extends XDialog {
    ...
    public RunRRECReportDialog(XhibitApplicationController xac) throws CSRecoverableException{
        super(xac,ResourceBundleHelper.getResource(RAGE_REPORT,"RRECReport.dialog_title"),
            true,XDialog.OKCANCEL,XDialog.DEFAULTCANCEL);
    
        //Create new panel
        panel = new RRECReportPanel(this);
        prepareButtons();
        addBodyPanel(panel);
        makeFocusable();
	...
	private void makeFocusable(){
		this.addMouseListener(new MouseAdapter(){
			...
			{
				RunRRECReportDialog.this.requestFocusInWindow();
			}
		});
	}
    ...
    private void prepareButtons() throws CSValidationException, CSRecoverableException{
        ...
        //OK Button 
        buttonPanel.okButton.setAction(new DisplayRRECReportAction(panel,getParentFrame()));
        //Cancel Button
