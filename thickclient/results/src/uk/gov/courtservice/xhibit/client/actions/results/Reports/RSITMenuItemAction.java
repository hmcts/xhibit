...
import uk.gov.courtservice.xhibit.client.results.RSIT.RunRSITReportDialog;
import uk.gov.courtservice.xhibit.client.util.SynchXAction;
import uk.gov.courtservice.xhibit.client.xhibitapplication.XhibitApplicationController;
/**
 * <p>
 * Title: RSITMenuItemAction
 * </p>
 * <p>
 * Description: The action which is called to run the RSIT report
 * </p>
 * <p>
...
public class RSITMenuItemAction extends SynchXAction {
	private static final long serialVersionUID = 1L;
	
	private RunRSITReportDialog dialog = null;
	
	public RSITMenuItemAction(){
		populateFromBundle("RSITReport");
	}
	
	public void synchActionPerformed(ActionEvent parm1) throws java.lang.Exception {
		 XhibitApplicationController xac = (XhibitApplicationController) getController();        
	     dialog = new RunRSITReportDialog(xac);
    }
