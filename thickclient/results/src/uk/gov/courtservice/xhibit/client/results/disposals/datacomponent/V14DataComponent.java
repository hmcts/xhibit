 ...
 */
public class V14DataComponent extends LabelDataComponent implements DataComponent {
    private final static String SINGLE_OPTION = "week";

    private final static String PLURAL_OPTION = "weeks";

    /**
     * DefaultDataComponent
     */
    public V14DataComponent() {
        super(PLURAL_OPTION);
    }
    ...
    public String createToolTipTextImpl() {
        return DisposalUtil.getToolTipText("v14DataComponentToolTip");
    }
