 ...
 * @version $Id: LabelDataComponent.java,v 1.17 2006/06/05 12:32:18 bzjrnl Exp $
 */
public class LabelDataComponent extends JLabel implements DelegatorDataComponent {
    ...
    /**
     * The text to use if data is null!
     */
     ...
     */
    public LabelDataComponent() {
        this(null);
    }

    public LabelDataComponent(String defaultText) {
        setForeground(DATA_LABEL_COLOR);
    ...
    /**
     * Make the label taller so it is evenly spaced
     */
    ...
    public void setDataImpl(String data) {
        if (!DisposalUtil.equals(data, getData())) {
            if (data == null) {
                setText(defaultText);
            } else {
                setText(data);
