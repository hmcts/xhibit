<%--                                                                              <%--
  ...
  -
  - Revision 1.1.2.1  2005/04/25 13:37:20  bzjrnl
  - Changes to move jspc into the framework.
  -
  - Revision 1.2  2003/04/08 21:00:02  sz0t7n
  - result of merge - 08/04/2003
  -
  - Revision 1.1.2.1  2003/04/04 19:22:48  rz3jq5
  - Added AdHoc Messaging work.
  -
  ...
  <table <c:if test="${requestScope.buttonFill}">width="100%"</c:if> cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        ...
        <td class="buttonMainOW"
                onClick="window.status='<fmt:message key="${requestScope.buttonTextKey}"/>';window.close(); return true"
