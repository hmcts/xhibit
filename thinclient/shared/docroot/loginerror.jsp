 <%--
  ...
  -
  - Revision 1.2  2003/09/16 06:51:07  bzjrnl
  - Fixed title (missing property) error
  -
...
<c:set scope="request" var="loginTextClass" value="psPageErrorTitle"/>
<c:set scope="request" var="loginTextKey" value="logon.error"/>
