<%--
  - Title:       selectcourt.jsp (jsp page fragment)
  -
  ...
  -
  - Revision 1.2  2003/06/27 14:23:04  cawleye
  - Split court and terminal. Similar to what Fred has done, maybe combine the two at some point.
  -
  - Revision 1.1  2003/06/26 11:22:59  cawleye
        ...
        <td>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    ...
                    <td class="psTableMainSpace"><img src="/Static/images/blank.gif"></td>
                    <td class="psTableMain">
                        <form class="psForm" action="<c:url value="/updatecourt"/>" method="post" name="selectform<c:out value="${item.id}"/>">
                          <c:if test="${requestScope.goterminal}">
                            <input type="hidden" value="true" name="goterminal">
                          </c:if>
                            <input type="hidden" value="<c:out value="${item.id}"/>" name="courtid">
