...
<%--
  ...
  <table <c:if test="${requestScope.buttonFill}">width="100%"</c:if> cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        ...
        <td class="buttonMain">
        <a href="<c:url value="${requestScope.buttonRequestURL}"/>" class="buttonLink" onClick="window.status='<fmt:message key="${requestScope.buttonTextKey}"/>'; return true" onMouseover="window.status='<fmt:message key="${requestScope.buttonTextKey}"/>'; return true" onMouseout="window.status=' '; return true"><fmt:message key="${requestScope.buttonTextKey}"/></a>
        </td>
        <td class="buttonSpace"><img src="/Static/images/blank.gif"></td>
        <td class="buttonVerticalBorder"><img src="/Static/images/blank.gif"></td>
    </tr>
