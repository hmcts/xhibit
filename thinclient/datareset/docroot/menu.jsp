<%--
  ...
  - $Revision: 1.1 $
  - $Log: menu.jsp,v $
  - Revision 1.1  2015/10/05 14:39:57  atwells
  - New code to support the NLE data reset tool
  -
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        ...
        <td class="psMenu">
            ...
            <c:set scope="request" var="buttonTextKey" value="menu.button.reset_data"/>
            <c:set scope="request" var="buttonRequestURL" value="/reset_data"/>
            <c:import url="${menuButtonURL}"/>
        </td>
        <td class="psMenuVerticalSpace"><img src="/Static/images/blank.gif"></td>

        <td class="psMenu">
            <c:set scope="request" var="buttonTextKey" value="menu.button.managecases"/>
            <c:set scope="request" var="buttonRequestURL" value="/managecases"/>
            <c:import url="${menuButtonURL}"/>
        </td>
        <td class="psMenuVerticalSpace"><img src="/Static/images/blank.gif"></td>
