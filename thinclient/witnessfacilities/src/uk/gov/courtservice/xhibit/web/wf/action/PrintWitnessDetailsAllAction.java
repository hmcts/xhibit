...
/**
 * <p>
 * Title: Print Witness Details All Action
 * </p>
 * <p>
 ...
 *         PrintWitnessDetailsAllAction.java,v $ Revision 1.3 2005/04/27
 ...
 * cookie access.
 * 
 * Revision 1.6 2004/03/26 13:05:39 tzj8k5 Set up header parameters for printing
 * 
 * Revision 1.5 2003/08/11 16:42:28 bzw8gp Jon Powell
 * 
 * organise imports (remove unused)
 * 
 * Revision 1.4 2003/05/07 16:09:15 fz0n8j Now calls witness summary factory.
 * 
 * Revision 1.3 2003/04/30 17:13:03 fz0n8j Quick fixes.
 * 
 * Revision 1.2 2003/04/30 11:44:03 qzd3k3 Merge from dev branch.
 * 
 * Revision 1.1.2.2 2003/04/23 14:14:32 fz0n8j Added edit case details for cps
 * 
 * Revision 1.1.2.1 2003/04/14 13:25:18 fz0n8j Now possible to view all
 * witnesses.
 * 
 * 
 */
public class PrintWitnessDetailsAllAction extends AbstractAction {

    /**
     * Empty default constructor
     */
    public PrintWitnessDetailsAllAction() {
    }
    ...
    public void internalPerformAction(ActionEnvironment actionEnvironment) throws FrameworkException {
        try {
            ...
            if (caseDetail != null) {
                ...
                data.put("defendantsValue", defendants.toString());
