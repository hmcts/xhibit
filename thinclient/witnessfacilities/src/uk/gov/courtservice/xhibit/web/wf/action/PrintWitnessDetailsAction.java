...
/**
 * <p>
 * Title: Print Witness Details Action
 * </p>
 * <p>
 * Description: The action for printing witness details.
 * 
 * <p>
 ...
 *         PrintWitnessDetailsAction.java,v $ Revision 1.3 2005/04/27 08:26:59
 *         bzjrnl Manual Merge From BRANCH_7_X
 * 
 * Revision 1.1.2.1 2005/04/25 13:37:44 bzjrnl Changes to move jspc into the
 * framework.
 * 
 * Revision 1.4 2005/01/17 13:58:25 tzj8k5 PRE 317 Display and sort trial
 * session info
 * 
 * Revision 1.3 2004/11/04 14:35:17 bzjrnl Changes to correct problems with
 * cookie access.
 * 
 ...
 * 
 * Revision 1.5 2003/05/07 16:09:14 fz0n8j Now calls witness summary factory.
 * 
 * Revision 1.4 2003/04/30 11:44:02 qzd3k3 Merge from dev branch.
 * 
 * Revision 1.3.2.6 2003/04/23 14:14:32 fz0n8j Added edit case details for cps
 * 
 * Revision 1.3.2.5 2003/04/14 13:25:15 fz0n8j Now possible to view all
 * witnesses.
 * 
 * Revision 1.3.2.4 2003/04/14 10:21:12 fz0n8j Modified actions to work with
 * latest middle tier code.
 * 
 * Revision 1.3.2.3 2003/04/11 08:41:23 qzd3k3 Refactoring work.
 * 
 * Revision 1.3.2.2 2003/04/10 13:26:55 fz0n8j Bug fixes.
 * 
 * Revision 1.3.2.1 2003/04/09 16:17:49 fz0n8j Changed print to pdf printing
 * (xsl needs more work).
 * 
 * Revision 1.3 2003/04/04 08:41:36 fz0n8j More pages now use database.
 * 
 * Revision 1.2 2003/04/02 08:34:47 fz0n8j Corrected log comment.
 * 
 * Revision 1.1 2003/04/01 13:59:53 fz0n8j Added actions again and modified
 * jsps/properites.
 * 
 */
public class PrintWitnessDetailsAction extends AbstractAction {

    /**
     * Empty default constructor
     */
    public PrintWitnessDetailsAction() {
    }
    ...
    public void internalPerformAction(ActionEnvironment actionEnvironment) throws FrameworkException {
        try {
            ...
            WitnessSession[] witnesses = WitnessFactory.getInstance().getWitnessSessionSelector().getTodayWitnesses(
                    new Integer(caseid));
            if (caseDetail != null) {
