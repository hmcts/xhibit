...
/**
 * <p>
 * Title: Maintain Witness Details Action Future
 * </p>
 * <p>
 ...
 *         MaintainWitnessDetailsFutureAction.java,v $ Revision 1.3 2005/04/27
 ...
 * cookie access.
 * 
 * Revision 1.8 2003/12/04 17:37:22 xzmw8n Fix to distinguish between duplicate
 * form submission and session timeout
 * 
 * Revision 1.7 2003/10/14 14:04:14 xzmw8n Added tokens and checks to identify
 * and reject duplicate form submissions
 * 
 * Revision 1.6 2003/08/11 16:42:27 bzw8gp Jon Powell
 * 
 * organise imports (remove unused)
 * 
 * Revision 1.5 2003/05/07 16:09:13 fz0n8j Now calls witness summary factory.
 * 
 * Revision 1.4 2003/04/30 17:13:03 fz0n8j Quick fixes.
 * 
 * Revision 1.3 2003/04/30 11:44:02 qzd3k3 Merge from dev branch.
 * 
 * Revision 1.2.2.4 2003/04/23 14:14:31 fz0n8j Added edit case details for cps
 * 
 * Revision 1.2.2.3 2003/04/14 13:25:15 fz0n8j Now possible to view all
 * witnesses.
 * 
 ...
 * 
 * Revision 1.2 2003/04/04 11:13:39 fz0n8j Security Changes and Misc Fixs
 * 
 * Revision 1.1 2003/04/04 08:41:36 fz0n8j More pages now use database.
 * 
 * 
 */
public class MaintainWitnessDetailsFutureAction extends AbstractAction {

    /**
     * The log4j logger
     */

    private static final Logger log = CSServices.getLogger(MaintainWitnessDetailsFutureAction.class);

    /**
     * Empty default constructor
     */
    public MaintainWitnessDetailsFutureAction() {
    }
    ...
    public void internalPerformAction(ActionEnvironment actionEnvironment) throws FrameworkException {
        if (!isTokenInSession()) {
            ...
            try {
                ...
                actionEnvironment.setResponseName("maintainwitnessdetailsfuturecomplete");
            } catch (Exception e) {
