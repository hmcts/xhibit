...
/**
 * <p>
 * Title: Print Skeleton Action
 * </p>
 * <p>
 * Description: Action for printing skeleton
 * 
 * Copyright: Copyright (c) 2003 Company: EDS
 * 
 * Author: David Duncan (2003) $$ $Log: PrintSkeletonAction.java,v $
 ...
 * 
 */
public class PrintSkeletonAction extends AbstractAction {

    /**
     * Empty default constructor
     */
    public PrintSkeletonAction() {
    }
    ...
    public void internalPerformAction(ActionEnvironment actionEnvironment) {
        actionEnvironment.setResponseName("printskeletoncomplete");
    }
}
