<%--
  - Title:       viewissuedrequestsummaries.jsp (jsp page fragment)
  -
  - Description: This file displays the summary of issued requests.
  ...
  - $Revision: 1.4 $
  - $Log: viewissuedpsrrequestsummaries.jsp,v $
  ...
  -
  - Revision 1.5  2003/03/26 16:54:49  fz0n8j
  - Bug fixes.
  -
    ...
    <tr>
        ...
        <td>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr>
                                ...
                                <td class="psPageTitle">
                                    <fmt:message key="viewissuedpsrrequestsummaries.title"/>
                                </td>
                                <td class="psPageTitleVerticalSpace"><img src="/Static/images/blank.gif"></td>
                            </tr>
                            <tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td colspan="23" class="psTableHorizontalBorder"><img src="/Static/images/blank.gif"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="psTableVerticalBorder"><img src="/Static/images/blank.gif"></td>
                    <td class="psTableMainSpace"><img src="/Static/images/blank.gif"></td>
                    <td width="12" class="psTableMain"><a href="javascript:void window.open('<c:url value="/printpsrrequestdetails"/>?id=<c:out value="${item.id}"/>&objectid=<c:out value="${requestScope.objectid}"/>','Print','WIDTH=800,HEIGHT=600,statusbar=no,menubar=no,toolbar=no,scrollbars=yes')" onClick="window.status='Print'; return true"
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr>
                                ...
                                <td class="psPageAction">
                                    <c:set scope="request" var="buttonTextKey" value="viewunissuedpsrrequestsummaries"/>
