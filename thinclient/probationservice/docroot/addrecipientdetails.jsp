<%--
  - Title:       addrecipientdetails.jsp (jsp page fragment)
  -
  - Description: This file allows a user to add a psr recipient, it will not check
  -              for data as there should not be error messages the first time the
  -              page loads.
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        ...
        <td>
            <form method="post" name="addrecipientdetails" action="<c:url value="/insertrecipientdetails"/>">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    ...
                                    <td class="psPageTitle">
                                        <fmt:message key="addrecipientdetails.title"/>
                                    </td>
                                    <td class="psPageTitleVerticalSpace"><img src="/Static/images/blank.gif"></td>
                                </tr>
                                <tr>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    ...
                                    <td class="psPageAction">
                                        ...
                                        <c:set scope="request" var="buttonRequestURL" value="javascript:psSubmitForm('addrecipientdetails')"/>
                                        <c:import url="${menuButtonURL}"/>
                                    </td>
                                    <td class="psPageActionVerticalSpace"><img src="/Static/images/blank.gif"></td>
                                </tr>
