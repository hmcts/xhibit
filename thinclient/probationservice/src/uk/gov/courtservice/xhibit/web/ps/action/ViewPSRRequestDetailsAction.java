...
/**
 * <p>
 * Title: ViewPSRRequestDetailsAction
 * </p>
 * <p>
 * Description: The the action for displaying the psr details.
 * 
 * <p>
 ...
 * </p>
 * 
 * @author Edward Cawley, Xdevelopment LLP (2003) $Revision: 1.18 $ $Log:
 *         ViewPSRRequestDetailsAction.java,v $ Revision 1.16 2006/04/26
 ...
 * 
 * Revision 1.13 2004/03/11 16:42:23 qzd3k3 Code linting.
 * 
 * Revision 1.11.18.1 2004/03/03 13:26:03 tzj8k5 55563 PSR Performance Fix
 * 
 * Revision 1.12 2004/02/24 08:15:06 tzj8k5 PSR Request update to use FLR
 * 
 * Revision 1.11 2003/12/10 14:35:07 xzmw8n Implemented check token
 * functionality
 * 
 * Revision 1.10 2003/12/09 16:40:11 xzmw8n Implemented check token
 * functionality
 * 
 * Revision 1.9 2003/10/27 10:58:06 tzj8k5 Amended to pick up Full User name
 * from Active Directory
 * 
 * Revision 1.8 2003/09/18 10:40:29 tzj8k5 Refactoring for text validation
 * 
 ...
 * 
 * Revision 1.5 2003/04/02 10:35:29 fz0n8j Seperate response and jsp so now
 * there is no edit option on issued psrs.
 * 
 * Revision 1.4 2003/03/28 15:28:32 fz0n8j Changed terminal lookup back to
 * machine name . . .
 * 
 * Revision 1.3 2003/03/27 16:24:35 fz0n8j Changed to remote address again.
 * 
 * Revision 1.2 2003/03/27 16:21:43 fz0n8j Modified to use get remote address.
 * 
 * Revision 1.1 2003/03/21 17:28:39 fz0n8j *** empty log message ***
 * 
 * 
 */
public class ViewPSRRequestDetailsAction extends TerminalCookieAction {

    /**
     * Empty default constructor
     */
    public ViewPSRRequestDetailsAction() {
    }
    ...
    public void terminalPerformAction(ActionEnvironment actionEnvironment) throws FrameworkException {
        if (!isTokenInSession()) {
            ...
            List requestValues = (List) actionEnvironment.getSessionParameter((String) actionEnvironment
                    .getRequestParameter("objectid"));
            PSRSummaryValue requestValueFromSession = (PSRSummaryValue) requestValues.get(Integer
                    .parseInt((String) actionEnvironment.getRequestParameter("id")));
            PSRRequestValueSet requestValue = delegate.findRequestByPrimaryKey(requestValueFromSession.getId(),
                    getTerminalName(actionEnvironment));
            PSRRequestDetailBean bean = ActionUtil.getRequestDetails(requestValue);
            ...
            if (bean.getStatus().getValue().equalsIgnoreCase("ISSUED")) {
                actionEnvironment.setResponseName("viewissuedpsrrequestdetailscomplete");
            } else {
                actionEnvironment.setResponseName("viewpsrrequestdetailscomplete");
            }
        }
    }
