...
public class RefProsecutorAgencyBasicValue extends CSAbstractValue {
	...
	public RefProsecutorAgencyBasicValue() {
	}

	public RefProsecutorAgencyBasicValue(Integer refProsecutorAgencyId) {
		this.refProsecutorAgencyId = refProsecutorAgencyId;
	}

	public RefProsecutorAgencyBasicValue(String refProsecutorType) {
		this.refProsecutorType = refProsecutorType;
	}

	public RefProsecutorAgencyBasicValue(Integer refProsecutorAgencyId, String refProsecutorType) {
		this.refProsecutorAgencyId = refProsecutorAgencyId;
		this.refProsecutorType = refProsecutorType;
	}
