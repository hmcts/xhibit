...
public class DefOnCaseRefSolFirmBasicValue extends CSAbstractValue {
	...
	public DefOnCaseRefSolFirmBasicValue() {
	}

	public DefOnCaseRefSolFirmBasicValue(Integer defOnCaseRefSolFirmId, Integer version) {
        super(defOnCaseRefSolFirmId, version);
    }
	
	public DefOnCaseRefSolFirmBasicValue(Integer defOnCaseRefSolFirmId, Integer defendantOnCaseId,
		...
		this(defOnCaseRefSolFirmId, version);
