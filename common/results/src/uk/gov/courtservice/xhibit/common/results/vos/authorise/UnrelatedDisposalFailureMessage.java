...
/**
 * <p>
 * Title: Failure message for missing Unrelated Disposal when no Indictment present.
 * </p>
 * <p>
 * Description:
 * </p>
 ...
 *
 * @author GJS
 * @version $Id: UnrelatedDisposalFailureMessage.java,v 1.0 2005/01/28
 *          08:27:57 qz4rwx Exp $
 */

public class UnrelatedDisposalFailureMessage extends FailureMessage {
	
	static final long serialVersionUID = 7253778970715997823L;
     ...
     */
    public UnrelatedDisposalFailureMessage(final String key, final Object[] parameters) {
        super(key);
    ...
    public String getFailureDetailsKey() {
        return "results.authorise.printValue.unrelatedDisposal";
    }
