...
/**
 * <p>
 * Title: Failure message for Seq No.
 * </p>
 * <p>
 * Description:
 * </p>
 ...
 *
 * @author GJS
 * @version $Id: SeqNoFailureMessage.java,v 1.0 2005/01/28
 *          08:27:57 qz4rwx Exp $
 */

public class SeqNoFailureMessage extends FailureMessage {
	
	static final long serialVersionUID = -7644556348462831269L;
     ...
     */
    public SeqNoFailureMessage(final String key, final Object[] parameters) {
        super(key);
    ...
    public String getFailureDetailsKey() {
        return "results.authorise.printValue.seqNo";
    }
