 ...
 *
 * @author GJS
 * @version $Id: AsnFailureMessage.java,v 1.0 2005/01/28
 *          08:27:57 qz4rwx Exp $
 */

public class AsnFailureMessage extends FailureMessage {
	
	static final long serialVersionUID = -7434319375894862439L;
     ...
     */
    public AsnFailureMessage(final String key, final Object[] parameters) {
        super(key);
    ...
    public String getFailureDetailsKey() {
        return "results.authorise.printValue.asn";
    }
