...
'http://www.courtservice.gov.uk/transforms/courtservice/ImprisonmentOrder-v2-5.xsl'
 where DOCUMENT_TYPE_ID =12;

Update CJI_DOCUMENT_TYPE set stylesheet_name = 
 	'http://www.courtservice.gov.uk/transforms/courtservice/YoungOffenderOrder5044C-v1-2.xsl'
