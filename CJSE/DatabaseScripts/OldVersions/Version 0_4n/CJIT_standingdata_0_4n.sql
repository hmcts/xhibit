...
Insert into CJI_DOCUMENT_TYPE values
 (1,'DL','Daily List',
'DAILYLIST','http://www.courtservice.gov.uk/transforms/courtservice/DailyList-v1.xsl','NPM',
'BITS.DailyListHandler', 'BITS.XMLTransformHandler','Y', 'N', 'Y', 'N');
Insert into CJI_DOCUMENT_TYPE values 
 (2,'RL','Running List','RUNNINGLIST','http://www.courtservice.gov.uk/transforms/courtservice/RunningList-v1.xsl',
'NPM','BITS.RunningListHandler', 'BITS.XMLTransformHandler','Y', 'N','Y', 'N');
Insert into CJI_DOCUMENT_TYPE values
 (3,'WL','Warned List',
'WARNEDLIST','http://www.courtservice.gov.uk/transforms/courtservice/WarnedList-v1.xsl','NPM','BITS.WarnedListHandler', 'BITS.XMLTransformHandler','Y', 'N','Y', 'N');
Insert into CJI_DOCUMENT_TYPE values 
 (4,'FL','Firm List',
'FIRMLIST','http://www.courtservice.gov.uk/transforms/courtservice/FirmList-v1.xsl','NPM','BITS.FirmListHandler', 'BITS.XMLTransformHandler','Y', 'N','Y', 'N');
Insert into CJI_DOCUMENT_TYPE values
 (5,'IN','Indictment','INDICTMENT','http://www.courtservice.gov.uk/transforms/courtservice/Indictment-v1.xsl', 'NPM','BITS.IndictmentOrderHandler', 'BITS.XMLTransformHandler','Y', 'N','Y', 'N');
Insert into CJI_DOCUMENT_TYPE values
 (6,'SS','Skeleton Schedule',
'SKELETONSCHEDULE','http://www.courtservice.gov.uk/transforms/courtservice/Skeleton-v1.xsl',
'NPM','BITS.SkeletonScheduleHandler', 'BITS.XMLTransformHandler','Y', 'N','Y', 'N');
Insert into CJI_DOCUMENT_TYPE values 
 (7,'CRO','Community Rehabilitation Order',
'REHABORDER','http://www.courtservice.gov.uk/transforms/courtservice/CommunityRehabOrder-v1.xsl', 'NPM','BITS.CommunityRehabOrderHandler', 'BITS.XMLTransformHandler','Y', 'N','Y', 'N');
Insert into CJI_DOCUMENT_TYPE values 
 (8,'CPO','Community Punishment Order',
'COMMPUNISHMENTORDER','http://www.courtservice.gov.uk/transforms/courtservice/CommunityPunishmentOrder-v1.xsl', 'NPM','BITS.CommunityPunishmentOrderHandler', 'BITS.XMLTransformHandler','Y', 'N','Y', 'N');
Insert into CJI_DOCUMENT_TYPE values 
 (9,'CPR','Community Punishment and Rehabilitation Order',
'COMMPUNISHMENTANDREHABORDER','http://www.courtservice.gov.uk/transforms/courtservice/CommunityPunishmentRehabOrder-v1.xsl', 'NPM','BITS.CommunityPunishmentRehabOrderHandler', 'BITS.XMLTransformHandler', 'Y', 'N','Y', 'N');
Insert into CJI_DOCUMENT_TYPE values
 (10,'RO','Remand Order','REMANDORDER','http://www.courtservice.gov.uk/transforms/courtservice/RemandOrder-v1.xsl', 'NPM','BITS.RemandOrderHandler', 'BITS.XMLTransformHandler','Y', 'N','N', 'Y');
Insert into CJI_DOCUMENT_TYPE values 
 (11,'BO','Bail Order','BAILORDER','http://www.courtservice.gov.uk/transforms/courtservice/BailOrder-v1.xsl', 'NPM','BITS.BailOrderHandler', 'BITS.XMLTransformHandler','Y', 'N','N', 'Y');
Insert into CJI_DOCUMENT_TYPE values 
 (12,'IO','Imprisonment Order',
'IMPRISONMENTORDER','http://www.courtservice.gov.uk/transforms/courtservice/ImprisonmentOrder-v1.xsl', 'NPM','BITS.ImprisonmentOrderHandler', 'BITS.XMLTransformHandler','Y', 'N','N', 'Y');
Insert into CJI_DOCUMENT_TYPE values 
 (13,'YOI','YOI Order','YOUNGOFFENDERORDER',
'http://www.courtservice.gov.uk/transforms/courtservice/YoungOffenderOrder-v1.xsl', 'Restricted','BITS.YoungOffenderOrderHandler', 'BITS.XMLTransformHandler','Y', 'N','Y', 'N');
Insert into CJI_DOCUMENT_TYPE values 
 (14,'SR','Committal for Sentence Record Sheet',
'COMMFORSENTRECORDSHEET','http://www.courtservice.gov.uk/transforms/courtservice/CommittalRecordSheet-v1.xsl', 'NPM',
'BITS.CommitalRecordSheetHandler', 'BITS.XMLTransformHandler','Y', 'N','Y', 'N');
Insert into CJI_DOCUMENT_TYPE values 
 (15,'AR','Appeal Record Sheet',
'APPEALRECORDSHEET','http://www.courtservice.gov.uk/transforms/courtservice/AppealRecordSheet-v1.xsl'
, 'NPM','BITS.AppealRecordSheetHandler', 'BITS.XMLTransformHandler','Y', 'N','Y', 'N');
Insert into CJI_DOCUMENT_TYPE values 
 (16,'TR','Trial Record Sheet','TRIALRECORDSHEET',
'http://www.courtservice.gov.uk/transforms/courtservice/TrialRecordSheet-v1.xsl', 'NPM','BITS.TrialRecordSheetHandler', 'BITS.XMLTransformHandler','Y', 'N','Y', 'N');
Insert into CJI_DOCUMENT_TYPE values 
 (17,'WW','Witness Warrant Order',
'Unknown','Unknown', 'NPM','Unknown', 'Unknown','N', 'N','N', 'N');
Insert into CJI_DOCUMENT_TYPE values 
 (18,'MC','Memorandum Of Conviction','Unknown','Unknown','NPM ','Unknown','Unknown','N', 'N','N', 'N');
Insert into CJI_DOCUMENT_TYPE values 
 (19,'NA','Notice Of Appeal','Unknown','Unknown','NPM ','Unknown','Unknown','N', 'N','N', 'N');
Insert into CJI_DOCUMENT_TYPE values 
 (20,'BW','Bench Warrant','BENCHWARRANT','http://www.courtservice.gov.uk/transforms/courtservice/BenchWarrant-v1.xsl', 'NPM','BITS.BenchWarrantHandler', 'BITS.XMLTransformHandler','Y', 'N','N', 'Y');
Insert into CJI_DOCUMENT_TYPE values 
 (21,'DLP','Prison Daily List','DAILYLIST','http://www.courtservice.gov.uk/transforms/courtservice/DailyList-v1.xsl', 'Restricted','BITS.DailyListHandler', 'BITS.XMLTransformHandler','Y', 'N','Y', 'N');
Insert into CJI_DOCUMENT_TYPE values 
 (22,'WLL','Warned List Letters','Unknown','Unknown','NPM','Unknown','Unknown','N', 'N','N', 'N');
...
Insert into CJI_Parameter_value values ('AggPollIntervalStatus','60');
Insert into CJI_Parameter_value values ('AggPollIntervalReply','60');
...
Insert into CJI_Parameter_value values ('DocumentExpiryTimeOut','126000');
...
Insert into CJI_Parameter_value values ('MobileSysReplyMessage', 'An Incorrect reply code was received - this is an automated response - please resent your message with the correct code');
