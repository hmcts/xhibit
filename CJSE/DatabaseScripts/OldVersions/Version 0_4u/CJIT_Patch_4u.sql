/* This script will be used to update Production from 0_4t to the latest level - 0_4u */
/* This update is specifically for CR49 - the addition of URN information to the HTML */

update cji_document_type set STYLESHEET_NAME  = 'http://www.courtservice.gov.uk/transforms/courtservice/Indictment-v2-2.xsl'
where document_type_id = 5;

update cji_document_type set STYLESHEET_NAME  = 'http://www.courtservice.gov.uk/transforms/courtservice/CommunityRehabOrder-v2-2.xsl'
where document_type_id = 7;

update cji_document_type set STYLESHEET_NAME  = 'http://www.courtservice.gov.uk/transforms/courtservice/CommunityPunishmentOrder-v2-2.xsl'
where document_type_id = 8;

update cji_document_type set STYLESHEET_NAME  = 'http://www.courtservice.gov.uk/transforms/courtservice/CommunityPunishmentRehabOrder-v2-2.xsl'
where document_type_id = 9;

update cji_document_type set STYLESHEET_NAME  = 'http://www.courtservice.gov.uk/transforms/courtservice/RemandOrder-v2-2.xsl'
where document_type_id = 10;

update cji_document_type set STYLESHEET_NAME  = 'http://www.courtservice.gov.uk/transforms/courtservice/BailOrder-v2-2.xsl'
where document_type_id = 11;

update cji_document_type set STYLESHEET_NAME  = 'http://www.courtservice.gov.uk/transforms/courtservice/CommittalRecordSheet-v2-2.xsl'
where document_type_id = 14;

update cji_document_type set STYLESHEET_NAME  = 'http://www.courtservice.gov.uk/transforms/courtservice/AppealRecordSheet-v2-2.xsl'
