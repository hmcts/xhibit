/*****************************************/
/* CJIT Insert Standing Data - v0.04y    */
/*****************************************/


/* Insert Version number */
INSERT INTO CJI_VERSION VALUES('CJSE','0_4y',sysdate,'RELEASE','CJSE Database Schema 0_4y',1);
...
'http://www.courtservice.gov.uk/transforms/courtservice DailyList-v2-1.xsd','NPM',
...
'http://www.courtservice.gov.uk/transforms/courtservice RunningList-v2-1.xsd','NPM',
...
'http://www.courtservice.gov.uk/transforms/courtservice WarnedList-v2-1.xsd','NPM',
...
'http://www.courtservice.gov.uk/transforms/courtservice FirmList-v2-1.xsd','NPM',
...
'http://www.courtservice.gov.uk/transforms/courtservice Indictment-v2-1.xsd','NPM',
...
'http://www.courtservice.gov.uk/transforms/courtservice Skeleton-v2-1.xsd','NPM',
...
'http://www.courtservice.gov.uk/transforms/courtservice CommunityPunishmentOrder-v2-1.xsd','NPM',
...
'http://www.courtservice.gov.uk/transforms/courtservice CommunityPunishmentRehabOrder-v2-1.xsd', 'NPM',
...
'http://www.courtservice.gov.uk/transforms/courtservice RemandOrder-v2-1.xsd', 'NPM',
...
'http://www.courtservice.gov.uk/transforms/courtservice BailOrder-v2-1.xsd' , 'NPM',
...
'http://www.courtservice.gov.uk/schemas/courtservice ImprisonmentOrder-v2-1.xsd','NPM',
...
'http://www.courtservice.gov.uk/schemas/courtservice YoungOffenderOrder-v2-1.xsd', 'Restricted',
'BITS.YoungOffenderOrderHandler', 'BITS.XMLTransformHandler','Y', 'N','Y', 'N');

Insert into CJI_DOCUMENT_TYPE values 
 (14,'SR','Committal for Sentence Record Sheet',
'COMMFORSENTRECORDSHEET','http://www.courtservice.gov.uk/transforms/courtservice/CommittalRecordSheet-v2-3.xsl',
'http://www.courtservice.gov.uk/schemas/courtservice CommittalRecordSheet-v2-1.xsd', 'NPM',
...
'http://www.courtservice.gov.uk/schemas/courtservice AppealRecordSheet-v2-1.xsd', 'NPM',
...
'http://www.courtservice.gov.uk/schemas/courtservice TrialRecordSheet-v2-1.xsd','NPM',
...
'http://www.courtservice.gov.uk/schemas/courtservice BenchWarrant-v2-1.xsd', 'NPM',
...
'http://www.courtservice.gov.uk/schemas/courtservice DailyList-v2-1.xsd', 'Restricted',
'BITS.DailyListHandler', 'BITS.XMLTransformHandler','Y', 'N','Y', 'N');
