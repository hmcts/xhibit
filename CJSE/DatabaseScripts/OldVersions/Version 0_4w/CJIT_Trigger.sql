/***************************************/
/* Create CJIT Sequence Triggers v0.4w */
/***************************************/
...
create or replace trigger CJI_BITS_MESSAGE_TR
  BEFORE INSERT
  on CJI_BITS_MESSAGE
...
IF :NEW.MESSAGE_CORRELATION_ID   IS NULL THEN
  SELECT CJI_BITS_MESSAGE_SEQ.NEXTVAL INTO                 :NEW.REQUEST_ID   FROM DUAL;
END IF;
