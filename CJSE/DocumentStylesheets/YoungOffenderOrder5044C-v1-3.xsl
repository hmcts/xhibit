...
<doc:reference xmlns="">
	...
	<para>File name : YoungOffenderOrder5044C-v1-2.xsl</para>
	<partintro>
		<section>
...
<xsl:variable name="stylesheet" select="'YoungOffenderOrder5044C-v1-2.xsl'" />
<xsl:variable name="last-modified-date" select="'2010-05-23'" />
