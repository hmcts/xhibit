...
<doc:reference xmlns="">
	...
	<para>File name : ReleaseFromPrisonOrder-v1.4xsl</para>
	<partintro>
		<section>
...
<xsl:variable name="stylesheet" select="'ReleaseFromPrisonOrder-v1-4.xsl'" />
<xsl:variable name="last-modified-date" select="'2023-04-26'" />
