...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cs="http://www.courtservice.gov.uk/schemas/courtservice" xmlns:apd="http://www.govtalk.gov.uk/people/AddressAndPersonalDetails" xmlns:n1="http://www.govtalk.gov.uk/people/bs7666" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:util="http://www.courtservice.gov.uk/transforms/courtservice/gcsUtility" xmlns:date="http://xsltsl.org/date-time" xmlns:str="http://xsltsl.org/string" xmlns:doc="http://xsltsl.org/xsl/documentation/1.0" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xso="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="fo" extension-element-prefixes="util date str doc xsd n1 apd cs">
	...
	<doc:reference xmlns="">
		...
		<para>File name : DVLAD20-v1-0.xsl</para>
		<partintro>
			<section>
	...
	<xsl:variable name="stylesheet" select="'DVLAD20-v1-0.xsl'"/>
	<xsl:variable name="last-modified-date" select="'2015-07-13'"/>
	...
	<xsl:template name="header">
		...
		<table WIDTH="100%">
			...
			<tr>
				...
				<td>
					<span class="emphasis">
						<xsl:text>Licence Counterpart Issue No </xsl:text>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<xsl:choose>
						...
						<xsl:when test="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Driver/cs:LicenceRecordType = '3'">
							<xsl:text>3 - Foreign; NI Licence; IOM Licence</xsl:text>
						</xsl:when>
						<xsl:when test="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Driver/cs:LicenceRecordType = '4'">
							<xsl:text>4 - No Licence produced in court</xsl:text>
						</xsl:when>
						<xsl:when test="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Driver/cs:LicenceRecordType = '5'">
							<xsl:text>5 - Has never been or is a DVLA Licence holder</xsl:text>
						</xsl:when>
					</xsl:choose>
				</td>
				<td>
					<xsl:value-of select="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Driver/cs:DriverLicenceIssue"/>
					<xsl:value-of select="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Driver/cs:CounterpartIssue"/>
				</td>
			</tr>
		</table>
		<hr/>
	...
	<xsl:template name="offences">
		...
		<table WIDTH="100%">
			...
			<tr>
				...
				<xsl:for-each select="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Endorsement">
					<td>
						<xsl:value-of select="cs:BasicEndorsementDetails/cs:OffenceDate"/>
					</td>
				</xsl:for-each>
			</tr>
			<tr/>
			...
			<tr>
				<td>
					<span class="emphasis">
						<xsl:text>Alcohol Level</xsl:text>
					</span>
				</td>
				<xsl:for-each select="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Endorsement">
					<td>
			...
			<tr>
				...
				<xsl:for-each select="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Endorsement">
					<td>
						<xsl:value-of select="cs:BasicEndorsementDetails/cs:DisqualificationPendingSentence"/>
					</td>
				</xsl:for-each>
			</tr>
			<tr/>
			...
			<tr>
				...
				<xsl:for-each select="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Endorsement">
					<td>
						<xsl:value-of select="cs:BasicEndorsementDetails/cs:DateOfSentence"/>
					</td>
				</xsl:for-each>
			</tr>
			<tr/>
			<tr>
				...
				<xsl:for-each select="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Endorsement">
					<td>
						<xsl:value-of select="cs:BasicEndorsementDetails/cs:DateDisqualificationRemoved"/>
					</td>
				</xsl:for-each>
			</tr>
			<tr/>
			<tr>
				...
				<xsl:for-each select="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Endorsement">
					<td>
						<xsl:value-of select="cs:BasicEndorsementDetails/cs:DateDisqualificationSuspended"/>
					</td>
				</xsl:for-each>
			</tr>
			<tr/>
			<tr>
				...
				<xsl:for-each select="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Endorsement">
					<td>
						<xsl:value-of select="cs:BasicEndorsementDetails/cs:DateDisqualificationReimposed"/>
					</td>
				</xsl:for-each>
			</tr>
			<tr/>
	...
	<xsl:template name="footer">
		...
		<table WIDTH="100%">
			<tr>
				<td WIDTH="50%">
					<span class="emphasis">
						<xsl:text>Paper Licence enclosed </xsl:text>
					</span>
				</td>
				<td WIDTH="50%">
					<xsl:value-of select="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Driver/cs:PaperLicenceEnclosed"/>
				</td>
			</tr>
			<tr/>
			<tr>
				<td>
					<span class="emphasis">
						<xsl:text>Photocard/Counterpart enclosed </xsl:text>
					</span>
				</td>
				<td>
					<xsl:value-of select="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Driver/cs:PhotocardEnclosed"/>
				</td>
			</tr>
			<tr/>
			<tr>
				<td>
					<span class="emphasis">
						<xsl:text>Paper Licence endorsed and returned to holder </xsl:text>
					</span>
				</td>
				<td>
					<xsl:value-of select="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Driver/cs:PaperLicenceEndorsed"/>
				</td>
			</tr>
			<tr/>
			<tr>
				<td>
					<span class="emphasis">
						<xsl:text>Counterpart Licence endorsed and returned to holder </xsl:text>
					</span>
				</td>
				<td>
					<xsl:value-of select="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Driver/cs:CounterpartLicenceEndorsed"/>
				</td>
			</tr>
			<tr/>
			<tr>
				<td>
					<span class="emphasis">
						<xsl:text>Foreign Licence enclosed </xsl:text>
					</span>
				</td>
				<td>
					<xsl:value-of select="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Driver/cs:ForeignLicenceEnclosed"/>
				</td>
			</tr>
			<tr/>
			<tr>
				<td>
					<span class="emphasis">
						<xsl:text>Extreme Hardship </xsl:text>
					</span>
				</td>
				<td>
					<xsl:value-of select="//cs:D20NotificationMessage/cs:DriversWithEndorsements/cs:Driver/cs:HardshipMarker"/>
				</td>
			</tr>
			<tr/>
			<tr>
