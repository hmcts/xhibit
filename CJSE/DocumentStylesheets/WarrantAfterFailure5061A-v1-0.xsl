...
<doc:reference xmlns="">
	...
	<para>File name : WarrantAfterFailure5061A-v1-0.xsl</para>
	<partintro>
		<section>
...
<xsl:variable name="stylesheet" select="'WarrantAfterFailure5061A-v1-0.xsl'" />
<xsl:variable name="last-modified-date" select="'2010-03-02'" />
