...
<doc:reference xmlns="">
	<referenceinfo>
		<releaseinfo role="meta">Version 1-9</releaseinfo>
		<author>
	...
	<para>File name : YoungOffenderOrder5044D-v1-9.xsl</para>
	<partintro>
		<section>
...
<xsl:variable name="stylesheet" select="'YoungoffenderOrder5044D-v1-9.xsl'" />
<xsl:variable name="last-modified-date" select="'2022-03-10'" />
