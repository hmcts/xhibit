...
<doc:reference xmlns="">
	...
	<para>File name : YoungOffenderOrder5044C-v1-1.xsl</para>
	<partintro>
		<section>
...
<!-- Version Information -->
<xsl:variable name="majorVersion" select="''" />
<xsl:variable name="minorVersion" select="'1'" />
<xsl:variable name="stylesheet" select="'YoungOffenderOrder5044C-v1-1.xsl'" />
...
<xsl:template match="cs:CustodialTerm" mode="block">
    <xsl:choose>
               <xsl:when test="./@Section91 = 'yes'">		
				...
				<xsl:otherwise>
   				  <xsl:call-template name="cs:PeriodOfImprisonment"/>	
				</xsl:otherwise>				
			</xsl:choose>	
	</xsl:template>	
		...
		<table width="100%" >
			...
			<xsl:choose>
				...
				<xsl:when test="@Section91 = 'yes'">			
					...
					<!-- Section 91 + Life -->		
					<xsl:if test="./cs:LifeSentence/@MandatoryLife = 'yes'">
						<tr>									
							<td/>
							<td width="80%">			
				...
				<!-- Life -->
				<xsl:when test="./cs:LifeSentence/@MandatoryLife = 'yes'">
					<tr>									
							<td/>
							<td width="80%">	
							<xsl:text>for life or for public protection for serious offences under section 226 of the Criminal Justice Act 2003</xsl:text>
			...
			<tr>
				...
				<td width="80%">
					<xsl:text>The court ordered that the defendant be sentenced 
					          under section 228 of the Criminal Justice Act 2003 to </xsl:text>
					...
					The provisions of Chapter 6 of the Criminal Justice Act 2003 apply in this case.
				</td>
			</tr>					
		</table>
	</xsl:template>
			...
			<table width="100%">
				<tr>
					...
					<td width="80%">
						...
						<xsl:text> days spent in custody on remand will count towards the sentence.</xsl:text>
					</td>
				</tr>
			</table>	
	</xsl:template>
