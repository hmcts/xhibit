...
<doc:reference xmlns="">
	...
	<para>File name : WarrantAfterFailureOrder5061B-v1-1.xsl</para>
	<partintro>
		<section>
...
<xsl:variable name="stylesheet" select="'WarrantAfterFailureOrder5061B-v1-1.xsl'" />
