...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<doc:reference xmlns="">
		...
		<para>File name : CommittalRecordSheet-v2-4.xsl</para>
		<partintro>
			<section>
...
<xsl:variable name="stylesheet" select="'CommittalRecordSheet-v2-4.xsl'" />
			...
			<tr>
				<td WIDTH="70%">
					...
					<xsl:if test="$personal/cs:Sex">
						<xsl:text>(</xsl:text>
							<!-- KN 2005-01-25 - Missing Capitals -->
