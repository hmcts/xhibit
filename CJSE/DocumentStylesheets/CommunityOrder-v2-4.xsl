...
<xsl:stylesheet version="1.0"
  ...
  exclude-result-prefixes="fo" extension-element-prefixes="util date str doc xsd n1 apd cs">
	...
	<doc:reference xmlns="">
		...
		<para>File name : CommunitytOrder-v2-4.xsl</para>
		<partintro>
			<section>
	...
	<xsl:variable name="stylesheet" select="'CommunityOrder-v2-4.xsl'"/>
	...
	<xsl:template match="/">
		<html>
			...
			<body>
				...
				<xsl:call-template name="CO_AdditionalNotes"/>
	...
	<!-- Template to display CO Additonal Notes text -->
	<xsl:template name="CO_AdditionalNotes">
		<xsl:if test="//cs:CommunityOrder/cs:AdditionalNotes">
			<h2>Additional Notes</h2>

			<xsl:value-of select="//cs:CommunityOrder/cs:AdditionalNotes"/>
