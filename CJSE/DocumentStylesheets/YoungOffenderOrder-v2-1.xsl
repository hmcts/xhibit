...
<doc:reference xmlns="">
	...
	<para>File name : YoungOffenderOrder-v2-1.xsl</para>
	<partintro>
		<section>
			...
			<para>Cr29 - always detension </para>
			<para>Added Pr57241 Fix</para>
			<para>Pr57296 Fix - Alignment and full stop</para>
			<para>Pr57318 Fix - 3 issues</para>
			<para>Pr57269 Fix</para>
		</section>
	</partintro>
</doc:reference>
...
<xsl:variable name="minorVersion" select="'1c'" />
<xsl:variable name="stylesheet" select="'YoungOffenderOrder-v2-1.xsl'" />
		...
		<html>
			...
			<xsl:call-template name="util:showLogo" />
				...
				<xsl:call-template name="util:UniversalOrderHeader"> 
					...
					<xsl:with-param name="OrderHeaderRoot" select="/cs:YoungOffenderOrder/cs:OrderHeader"/>
				</xsl:call-template>
				
				<!-- +++++++++ following template produces Personal Details            +++++++++ -->
				<xsl:apply-templates select="/cs:YoungOffenderOrder/cs:OrderHeader/cs:Defendant/cs:PersonalDetails" />
	...
	<!-- details of the defendant -->
		...
		<table width="100%" >
			...
			<tr>
				<td />
				<td>
					<!-- KN CR29 - Always be detension so always display text -->
	...
	<xsl:template match="cs:CustodialTerm" mode="custodial">
		...
		<table width="100%" >
			...
			<xsl:choose>
				...
				<xsl:otherwise>
					<xsl:if test="not (./cs:LifeSentence/@MandatoryLife or ./cs:LifeSentence/@Section9394 or ./cs:LifeSentence/@HMPleasure) " >
						<tr>
							<td />
							<td>
			...
			<tr>
				...
				<td>
					<xsl:choose>
						...
						<xsl:when test="./cs:LifeSentence/@Section9394">
				...
				<tr>
					...
					<td>				
						<xsl:text>The court ordered that a minimum three years sentence for a third domestic burglary, pursuant to 
								section 111(1)(2)(5)(6) of the Powers of the Criminal Courts (Sentencing) Act 2000, should apply to the defendant.
						</xsl:text>
					</td>
				</tr>
			</table>
