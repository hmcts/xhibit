...
<xsl:stylesheet version="1.0"
  ...
  exclude-result-prefixes="fo" extension-element-prefixes="util date str doc xsd n1 apd cs">
	...
	<doc:reference xmlns="">
		...
		<para>File name : YouthRehabilitationOrder-v1-1.xsl</para>
		<partintro>
			<section>
	...
	<xsl:variable name="stylesheet" select="'YouthRehabilitationOrder-v1-1.xsl'"/>
	<xsl:variable name="last-modified-date" select="'2016-09-15'"/>
