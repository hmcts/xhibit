...
<doc:reference xmlns="">
	...
	<para>File name : YoungOffenderOrder5044D-v1-0.xsl</para>
	<partintro>
		<section>
...
<xsl:variable name="stylesheet" select="'YoungoffenderOrder5044D-v1-0.xsl'" />
			...
			<xsl:choose>
				...
				<xsl:when test="./cs:LifeSentence/@MandatoryLife = 'yes'">
					<tr>									
						<td/>
						<td width="80%">	
							<xsl:text>detention for life</xsl:text>
						</td>
					</tr>
				</xsl:when>																								
			</xsl:choose>
			...
			<tr>
				...
				<td width="80%">
					<xsl:text>The court ordered that the defendant be sentenced 
					          under section 227 of the Criminal Justice Act 2003 to </xsl:text>
				</td>
			</tr>
			<tr>				
				<td/>
