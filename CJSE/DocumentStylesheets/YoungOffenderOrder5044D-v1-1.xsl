...
<xsl:output method="html" indent="yes"/>
	...
	<xsl:template match="cs:CustodialTerm" mode="custodial">
	   <xsl:choose>
					...
					<xsl:when test="//cs:CustodialTerm/cs:LifeSentence/@MandatoryLife = 'yes'">
						          <xsl:apply-templates select="//cs:CustodialTerm/cs:LifeSentence" /> 
					</xsl:when>
					 <xsl:otherwise>
					     <xsl:apply-templates select="//cs:CustodialTerm" mode="detention"/>
					  </xsl:otherwise>
	   </xsl:choose>
	</xsl:template>
	
<xsl:template match="cs:CustodialTerm" mode="detention">
		<hr/>
		<table width="100%" >
			<tr>				
				<td width="20%" valign="top">
	...
	<xsl:template match="cs:CustodialTerm/cs:LifeSentence">
		<hr/>
		<table width="100%" >
			<tr>				
				<td width="20%" valign="top">
		...
		<table width="100%" >		
			<xsl:choose>
				...
				<!-- Life -->
				<xsl:when test="./@MandatoryLife = 'yes'">
					<tr>									
						<td/>
						<td width="80%">	
...
<!-- **************************************** -->
	...
	<xsl:template match="cs:CustodialTerm" mode="indeterminate">		
		<hr />
		<table width="100%" >
			<tr>
				<td width="20%" valign="top">
