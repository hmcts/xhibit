...
<doc:reference xmlns="">
		...
		<para>File name : TrialRecordSheet-v2-1.xsl</para>
		<partintro>
			<section>
...
<xsl:variable name="stylesheet" select="'trialrecordsheet-v2-1.xsl'" />
<xsl:variable name="last-modified-date" select="'2004-06-30'" />
