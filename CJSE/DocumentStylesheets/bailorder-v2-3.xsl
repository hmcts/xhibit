...
<doc:reference xmlns="">
		...
		<para>File name : bailorder-v2-3.xsl</para>
		<partintro>
			<section>
...
<xsl:variable name="minorVersion" select="'3a'" />
<xsl:variable name="stylesheet" select="'bailorder-v2-3.xsl'" />
<xsl:variable name="last-modified-date" select="'2005-06-29'" />
