...
<doc:reference xmlns="">
	...
	<para>File name : YoungOffenderOrder5044C-v1-4.xsl</para>
	<partintro>
		<section>
...
<xsl:variable name="stylesheet" select="'YoungOffenderOrder5044C-v1-4.xsl'" />
<xsl:variable name="last-modified-date" select="'2013-06-18'" />
