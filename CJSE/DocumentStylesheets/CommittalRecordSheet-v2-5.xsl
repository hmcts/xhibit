...
<xsl:include href="gcsUtility.xsl" />                 
    ...
    <doc:reference xmlns="">
        ...
        <para>File name : CommittalRecordSheet-v2-5.xsl</para>
        <partintro>
            <section>
...
<xsl:variable name="stylesheet" select="'CommittalRecordSheet-v2-5.xsl'" />
<xsl:variable name="last-modified-date" select="'2009-01-23'" />
