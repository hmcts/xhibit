...
<doc:reference xmlns="">
	...
	<para>File name : CustodialOrder5044C-v1-0.xsl</para>
	<partintro>
		<section>
...
<xsl:variable name="stylesheet" select="'YoungOffenderOrder5044C-v1-0.xsl'" />
<xsl:variable name="last-modified-date" select="'2010-03-03'" />
...
<xsl:output method="html" indent="yes"/>
					...
					<xsl:if test="./cs:Term">
						...
						<tr>									
							...
							<td width="80%">				
								...
								<xsl:if test="./cs:LifeSentence and ./cs:ExtendedPeriod">
			...
			<tr>
				...
				<td width="80%">
					<xsl:text>The court applied its powers under section 116 of the Powers of Criminal Courts
					          (Sentencing) Act 2000 and ordered that the defendant be returned to prison for </xsl:text>
					<xsl:choose>
	...
	<xsl:template match="cs:IndeterminateSentence">		
		<hr />
		<table width="100%" >
			<tr>
				<td width="20%" valign="top">
				...
				<td width="80%">
					...
					<xsl:call-template name="util:decodeDuration">
						<xsl:with-param name="duration" select="cs:MinimumSentence"/>
					</xsl:call-template>
					<xsl:text>.</xsl:text>
				</td>
			</tr>
	...
	<xsl:template name="Footer">
		...
		<table width="100%">
			...
			<br/>
			<tr>
				<td width="100%" valign="top" colspan="100%">An officer of the Crown Court</td>
			</tr>
		</table>
