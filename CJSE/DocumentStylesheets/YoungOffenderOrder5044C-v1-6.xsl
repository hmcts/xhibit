...
<doc:reference xmlns="">
	...
	<para>File name : YoungOffenderOrder5044C-v1-6.xsl</para>
	<partintro>
		<section>
...
<xsl:variable name="stylesheet" select="'YoungOffenderOrder5044C-v1-6.xsl'" />
<xsl:variable name="last-modified-date" select="'2022-03-17'" />
				...
				<xsl:when test="./cs:LifeSentence/@HMPleasure = 'yes'">		
					<tr>									
						...
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:text>during Her Majesty's pleasure.</xsl:text>	
							</xsl:otherwise>
						</xsl:choose>						
						</td>
					</tr>
