...
<doc:reference xmlns="">
	...
	<para>File name : NoticeOfAcquittalOrder-v1.0xsl</para>
	<partintro>
		<section>
...
<xsl:variable name="stylesheet" select="'NoticeOfAcquittalOrder-v1-0.xsl'" />
...
<xsl:output method="html" indent="yes"/>
	...
	<xsl:template name="acquittalDetails" >
		...
		<xsl:call-template name="util:ukdate_mon">
			<xsl:with-param name="inDate" select="/cs:ReleaseFromPrisonOrder/cs:SentFromCourt/cs:Date"/>
		</xsl:call-template>
		<br/>
