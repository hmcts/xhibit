...
<xsl:if test="event/Directions_By_Case_Options/E40710_P_And_D!=''"><xsl:text>P and D: </xsl:text><xsl:value-of select="event/Directions_By_Case_Options/E40710_P_And_D"/>
