...
<xsl:for-each select="event/E40702_Directions_By_Case_Options/E40702_Defendants_To_Attend"><xsl:value-of select="./E40702_Defendant_Details/E40702_Defendant_Name"/>
