...
<xsl:if test="event/E40701_Direction_By_Defendant_Options/E40701_Form_B/E40701_Form_B_Options!=''">
Form B: <xsl:value-of select="event/E40701_Direction_By_Defendant_Options/E40701_Form_B/E40701_Form_B_Options"/>
</xsl:if>
<xsl:if test="event/E40701_Direction_By_Defendant_Options/E40701_Form_B/E40701_To_Be_Filed_Date!=''">
To be filed by:<xsl:value-of select="event/E40701_Direction_By_Defendant_Options/E40701_Form_B/E40701_To_Be_Filed_Date"/></xsl:if>
