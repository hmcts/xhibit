...
<xsl:stylesheet version="1.0" 
    ...
    <doc:reference xmlns="">
            <referenceinfo>
            <releaseinfo role="meta">Version 2-13</releaseinfo>
            <author>
        ...
        <para>File name : CommittalRecordSheet-v2-13.xsl</para>
        <partintro>
            <section>
	...
	<xsl:variable name="minorVersion" select="'13'"/>
	<xsl:variable name="stylesheet" select="'CommittalRecordSheet-v2-13.xsl'" />
	<xsl:variable name="last-modified-date" select="'2022-11-22'" />
