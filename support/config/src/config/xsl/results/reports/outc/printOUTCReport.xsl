...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
	<xsl:import href="/config/xsl/results/reports/outc/printOUTCReportValue.xsl"/>
	<xsl:import href="/config/xsl/results/reports/common/HeaderFooter.xsl"/>
	<xsl:template match="OUTCReport">
			...
			<fo:page-sequence master-reference="simple">
				<fo:static-content flow-name="xsl-region-before">
					...
					<fo:block space-before="5pt" font-size="11pt" font-family="sans-serif" font-weight="bold" text-align="center">
					    <xsl:text>OUTSTANDING CASES, CRIMINAL (ORDERED BY </xsl:text>
				...
				<fo:flow flow-name="xsl-region-body">
					<xsl:call-template name="OUTCReportValues"/>
					<fo:block id="theEnd"/>
				</fo:flow>
			</fo:page-sequence>
		</fo:root>
