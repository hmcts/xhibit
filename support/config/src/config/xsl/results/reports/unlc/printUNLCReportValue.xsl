...
<xsl:template name="UNLCReportValues">
	<fo:table table-layout="fixed">
		...
		<fo:table-column column-number="11" column-width="10px"/>
		<fo:table-column column-number="12" column-width="10px"/>
		<fo:table-header>	
		...
		<fo:table-body>
			<xsl:for-each select="./unlisted-cases-values">
				...
				<xsl:for-each select="./unlistedcasenotes">
