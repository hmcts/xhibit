...
IF DEFINED CLASSPATH (
    SET CLASSPATH=%CLASSPATH%;%XHIBIT_HOME%\midtier\formatting\build\classes
) ELSE (
    SET CLASSPATH=%XHIBIT_HOME%\midtier\formatting\build\classes
)
...
SET FORMAT_COMMAND=%JAVA_HOME%\bin\java %JVMARGS% uk.gov.courtservice.xhibit.business.services.formatting.FormattingServices %*
