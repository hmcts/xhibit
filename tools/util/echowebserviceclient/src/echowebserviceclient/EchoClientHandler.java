 ...
 */
public class EchoClientHandler extends GenericHandler
{
    ...
    {
        out("******************************************************");
        out("EchoClientHandler handleRequest START:");
        out("******************************************************");
        ...
        try
        {
            ...
            SoapHandlerHelper.createSoapFile(soapMessage,"Echo_Client_Submit_Request");

            out("******************************************************");
            out("EchoClientHandler handleRequest END:");
            out("******************************************************");
        }
    ...
    public boolean handleResponse(MessageContext context)
    {
        ...
        SoapHandlerHelper.createSoapFile(soapMessage,"Echo_Client_Submit_Response");
    ...
    public boolean handleFault(MessageContext context)
    {
        ...
        SoapHandlerHelper.createSoapFile(soapMessage,"Echo_Client_Submit_Error");
