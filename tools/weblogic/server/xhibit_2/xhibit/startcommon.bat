...
PUSHD %DOMAIN_HOME%\..\xhibit-@xhibit.version@ 1>NUL 2>&1
IF %ERRORLEVEL% EQU 0 GOTO PUSHD_APPLICATION_HOME_OK

ECHO An error occured finding the application home "%DOMAIN_HOME%\..\xhibit-@xhibit.version@", please correct and rerun.
POPD
EXIT /B 16
