...
public class RandomValues {
    ...
    private final static char[] TEXT_CHARS = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^*()_-+={[}]:;@'~#,>.?/|\\"
            .toCharArray();
    ...
    public double randomDouble(int digits, int places, boolean positive) {
        ...
        double bigger = randomLong(positive ? 0 : -p10 + 1, p10 - 1);
        return bigger / powersOfTen[places];
    }
